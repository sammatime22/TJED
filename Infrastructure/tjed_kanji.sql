INSERT INTO API_kanji (kanji_character, meaning, on_yomi, kun_yomi) VALUES ("亜", "ア", "つ.ぐ", "Asia, rank next, come after, -ous"),
("唖", "ア, アク", "おし", "mute, dumb"),
("娃", "ア, アイ, ワ", "うつく.しい", "beautiful"),
("阿", "ア, オ", "おもね.る, くま", "Africa, flatter, fawn upon, corner, nook, recess"),
("哀", "アイ", "あわ.れ, あわ.れむ, かな.しい", "pathetic, grief, sorrow, pathos, pity, sympathize"),
("愛", "アイ", "いと.しい, かな.しい, め.でる, お.しむ, まな", "love, affection, favourite"),
("挨", "アイ", "ひら.く", "approach, draw near, push open"),
("姶", "オウ, アイ", "あい", "good-looking, quiet"),
("逢", "ホウ", "あ.う, むか.える", "meeting, tryst, date, rendezvous"),
("葵", "キ", "あおい", "hollyhock"),
("茜", "セン", "あかね", "madder, red dye, Turkey red"),
("穐", "シュウ", "あき, とき", "autumn"),
("悪", "アク, オ", "わる.い, わる-, あ.し, にく.い, -にく.い, ああ, いずくに, いずくんぞ, にく.む", "bad, vice, rascal, false, evil, wrong"),
("握", "アク", "にぎ.る", "grip, hold, mould sushi, bribe"),
("渥", "アク", "あつ.い, うるお.う", "kindness, moisten"),
("旭", "キョク", "あさひ", "rising sun, morning sun"),
("葦", "イ", "あし, よし, しお.れる, しな.びる, しぼ.む, な.える", "reed, bullrush"),
("芦", "ロ", "あし, よし", "reed, bullrush"),
("鯵", "ソウ", "あじ", "horse mackerel"),
("梓", "シ", "あずさ", "catalpa tree, woodblock printing"),
("圧", "アツ, エン, オウ", "お.す, へ.す, おさ.える, お.さえる", "pressure, push, overwhelm, oppress, dominate"),
("斡", "アツ, カン, ワツ", "めぐ.る, めぐ.らす", "go around, rule, administer"),
("扱", "ソウ, キュウ", "あつか.い, あつか.う, あつか.る, こ.く", "handle, entertain, thresh, strip"),
("宛", "エン", "あ.てる, -あて, -づつ, あたか.も", "address, just like, fortunately"),
("姐", "ソ, シャ", "あね, ねえさん", "elder sister, maidservant"),
("虻", "ボウ", "あぶ", "gadfly, horsefly"),
("飴", "イ, シ", "あめ, やしな.う", "rice jelly, candy"),
("絢", "ケン", "", "brilliant fabric design"),
("綾", "リン", "あや", "design, figured cloth, twill"),
("鮎", "デン, ネン", "あゆ, なまず", "freshwater trout, smelt"),
("或", "ワク, コク, イキ", "あ.る, あるい, あるいは", "some, one, or, possibly, a certain"),
("粟", "ゾク, ショク, ソク", "あわ, もみ", "millet"),
("袷", "コウ, キョウ", "あわせ", "lined (kimono)"),
("安", "アン", "やす.い, やす.まる, やす, やす.らか", "relax, cheap, low, quiet, rested, contented, peaceful"),
("庵", "アン", "いおり, いお", "hermitage, retreat"),
("按", "アン", "おさ.える, しら.べる", "hold, consider, investigate"),
("暗", "アン", "くら.い, くら.む, くれ.る", "darkness, disappear, shade, informal, grow dark, be blinded"),
("案", "アン", "つくえ", "plan, suggestion, draft, ponder, fear, proposition, idea, expectation, worry, table, bench"),
("闇", "アン, オン", "やみ, くら.い", "get dark, gloom, disorder"),
("鞍", "アン", "くら", "saddle"),
("杏", "キョウ, アン, コウ", "あんず", "apricot"),
("以", "イ", "もっ.て", "by means of, because, in view of, compared with"),
("伊", "イ", "かれ", "Italy, that one"),
("位", "イ", "くらい, ぐらい", "rank, grade, throne, crown, about, some"),
...
("夷", "イ", "えびす, えみし, ころ.す, たい.らげる", "barbarian, savage, Ainu"),
("委", "イ", "ゆだ.ねる", "committee, entrust to, leave to, devote, discard"),
("威", "イ", "おど.す, おど.し, おど.かす", "intimidate, dignity, majesty, menace, threaten"),
("尉", "イ, ジョウ", "", "military officer, jailer, old man, rank"),
("惟", "イ, ユイ", "おも.んみる, これ, おも.うに", "consider, reflect, think"),
...
("易", "エキ, イ", "やさ.しい, やす.い", "easy, ready to, simple, fortune-telling, divination"),
("椅", "イ", "", "chair"),
("為", "イ", "ため, な.る, な.す, す.る, たり, つく.る, なり", "do, change, make, benefit, welfare, be of use, reach to, try, practice, cost, serve as, good, advantage, as a result of"),
("畏", "イ", "おそ.れる, かしこま.る, かしこ, かしこ.し", "fear, majestic, graciously, be apprehensive"),
("異", "イ", "こと, こと.なる, け", "uncommon, different, queerness, strangeness, wonderful, curious, unusual"),
("移", "イ", "うつ.る, うつ.す", "shift, move, change, drift, catch (cold, fire), pass into"),
("維", "イ", "", "fiber, tie, rope"),
("緯", "イ", "よこいと, ぬき", "horizontal, woof, left & right, (parallels of) latitude, prediction"),
("胃", "イ", "", "stomach, paunch, crop, craw"),
("萎", "イ", "な, しお.れる, しな.びる, しぼ.む, な.える", "wither, droop, lame"),
("衣", "イ, エ", "ころも, きぬ, -ぎ", "garment, clothes, dressing"),
("謂", "イ", "い.う, いい, おも.う, いわゆる", "reason, origin, history, oral tradition"),
("違", "イ", "ちが.う, ちが.い, ちが.える, -ちが.える, たが.う, たが.える", "difference, differ"),
("遺", "イ, ユイ", "のこ.す", "bequeath, leave behind, reserve"),
("医", "イ", "い.やす, い.する, くすし", "doctor, medicine"),
("井", "セイ, ショウ", "い", "well, well crib, town, community"),
("亥", "ガイ, カイ", "い", "sign of the hog, 9-11PM, twelfth sign of the Chinese zodiac"),
("域", "イキ", "", "range, region, limits, stage, level"),
("育", "イク", "そだ.つ, そだ.ち, そだ.てる, はぐく.む", "bring up, grow up, raise, rear"),
("郁", "イク", "", "cultural progress, perfume"),
("磯", "キ", "いそ", "seashore, beach"),
("一", "イチ, イツ", "ひと-, ひと.つ", "one, one radical (no.1)"),
("壱", "イチ, イツ", "ひとつ", "one (in documents)"),
("溢", "イツ", "こぼ.れる, あふ.れる, み.ちる", "overflow, inundate, spill"),
("逸", "イツ", "そ.れる, そ.らす, はぐ.れる", "deviate, idleness, leisure, miss the mark, evade, elude, parry, diverge"),
("稲", "トウ, テ", "いね, いな-", "rice plant"),
("茨", "シ, ジ", "いばら, かや, くさぶき", "briar, thorn"),
("芋", "ウ", "いも", "potato"),
("鰯", "", "いわし", "sardine, (kokuji)"),
("允", "イン", "じょう, まこと.に, ゆるす", "license, sincerity, permit"),
("印", "イン", "しるし, -じるし, しる.す", "stamp, seal, mark, imprint, symbol, emblem, trademark, evidence, souvenir, India"),
("咽", "イン, エン, エツ", "むせ.ぶ, むせ.る, のど, の.む", "throat, choked, smothered, stuffy"),
("員", "イン", "", "employee, member, number, the one in charge"),
("因", "イン", "よ.る, ちな.む", "cause, factor, be associated with, depend on, be limited to"),
("姻", "イン", "", "matrimony, marry"),
("引", "イン", "ひ.く, ひ.ける", "pull, tug, jerk, admit, install, quote, refer to"),
("飲", "イン, オン", "の.む, -の.み", "drink, smoke, take"),
("淫", "イン", "ひた.す, ほしいまま, みだ.ら, みだ.れる, みだり", "lewdness, licentiousness"),
("胤", "イン", "たね", "descendent, issue, offspring"),
("蔭", "イン, オン", "かげ", "shade, shadow, backing assistance"),
("院", "イン", "", "Inst., institution, temple, mansion, school"),
("陰", "イン", "かげ, かげ.る", "shade, yin, negative, sex organs, secret, shadow"),
("隠", "イン, オン", "かく.す, かく.し, かく.れる, よ.る", "conceal, hide, cover"),
("韻", "イン", "", "rhyme, elegance, tone"),
("吋", "トウ, ドウ, スン", "インチ", "inch"),
("右", "ウ, ユウ", "みぎ", "right"),
("宇", "ウ", "", "eaves, roof, house, heaven"),
("烏", "ウ, オ", "からす, いずくんぞ, なんぞ", "crow, raven"),
("羽", "ウ", "は, わ, はね", "feathers, counter for birds, rabbits"),
("迂", "ウ", "", "roundabout way"),
("雨", "ウ", "あめ, あま-, -さめ", "rain"),
("卯", "ボウ, モウ", "う", "sign of the hare or rabbit, fourth sign of Chinese zodiac, 5-7AM, east"),
("鵜", "テイ, ダイ", "う", "cormorant"),
("窺", "キ", "うかが.う, のぞく", "lie in wait, spy on, reconnoiter"),
("丑", "チュウ", "うし", "sign of the ox or cow, 1-3AM, second sign of Chinese zodiac"),
("碓", "カク, タイ", "たし.か, かく.たる", "pestle"),
("臼", "キュウ, グ", "うす, うすづ.く", "mortar"),
("渦", "カ", "うず", "whirlpool, eddy, vortex"),
("嘘", "キョ, コ", "うそ, ふ.く", "lie, falsehood"),
("唄", "バイ", "うた, うた.う", "song, ballad"),
("欝", "ウツ, ウン", "うっ.する, ふさ.ぐ, しげ.る", "gloom, depression, melancholy"),
("蔚", "ウツ, イ", "うち, おとこよもぎ", "dense growth"),
("鰻", "マン, バン", "うなぎ", "eel"),
("姥", "ボ, モ", "うば", "old woman"),
...
("疫", "エキ, ヤク", "", "epidemic"),
("益", "エキ, ヤク", "ま.す", "benefit, gain, profit, advantage"),
("駅", "エキ", "", "station"),
("悦", "エツ", "よろこ.ぶ, よろこ.ばす", "ecstasy, joy, rapture"),
("謁", "エツ", "", "audience, audience (with king)"),
("越", "エツ, オツ", "こ.す, -こ.す, -ご.し, こ.える, -ご.え", "surpass, cross over, move to, exceed, Vietnam"),
("閲", "エツ", "けみ.する", "review, inspection, revision"),
("榎", "カ", "えのき", "lotus tree, nettle tree, hackberry"),
("厭", "エン, オン, アン, オウ, ユウ, ヨウ", "いや, あ.きる, いと.う, おさ.える", "get tired of, satiate, bore, dislike, disagreeable, unwelcome"),
("円", "エン", "まる.い, まる, まど, まど.か, まろ.やか", "circle, yen, round"),
("園", "エン", "その", "park, garden, yard, farm"),
("堰", "エン", "せき, せ.く", "dam, prevent, stop up"),
("奄", "エン", "おお.う, たちまち", "cover, suffocate, obstruct"),
("宴", "エン", "うたげ", "banquet, feast, party"),
("延", "エン", "の.びる, の.べる, の.べ, の.ばす", "prolong, stretching"),
("怨", "エン, オン, ウン", "うら.む, うらみ, うら.めしい", "grudge, show resentment, be jealous"),
("掩", "エン", "おお.う", "cover, conceal"),
("援", "エン", "", "abet, help, save"),
("沿", "エン", "そ.う, -ぞ.い", "run alongside, follow along, run along, lie along"),
("演", "エン", "", "performance, act, play, render, stage"),
("炎", "エン", "ほのお", "inflammation, flame, blaze"),
("焔", "エン", "ほのお", "flame, blaze"),
("煙", "エン", "けむ.る, けむり, けむ.い", "smoke"),
("燕", "エン", "つばめ, つばくら, つばくろ", "swallow (bird)"),
("猿", "エン", "さる", "monkey"),
("縁", "エン, -ネン", "ふち, ふち.どる, ゆかり, よすが, へり, えにし", "affinity, relation, connection, edge, border, verge, brink"),
("艶", "エン", "つや, なま.めかしい, あで.やか, つや.めく, なま.めく", "glossy, luster, glaze, polish, charm, colorful, captivating"),
("苑", "エン, オン", "その, う.つ", "garden, farm, park"),
("薗", "エン, オン", "", "garden, yard, farm"),
("遠", "エン, オン", "とお.い", "distant, far"),
("鉛", "エン", "なまり", "lead"),
("鴛", "エン, オン", "おし, おしどり", "male mandarin duck"),
("塩", "エン", "しお", "salt"),
("於", "オ, ヨ", "おい.て, お.ける, ああ, より", "at, in, on, as for"),
("汚", "オ", "けが.す, けが.れる, けが.らわしい, よご.す, よご.れる, きたな.い", "dirty, pollute, disgrace, rape, defile"),
("甥", "セイ, ソウ, ショウ", "おい, むこ", "nephew"),
("凹", "オウ", "くぼ.む, へこ.む, ぼこ", "concave, hollow, sunken"),
("央", "オウ", "", "center, middle"),
("奥", "オウ", "おく, おく.まる, くま", "heart, interior"),
("往", "オウ", "い.く, いにしえ, さき.に, ゆ.く", "journey, travel, chase away, let go, going, before, formerly"),
("応", "オウ, ヨウ, -ノウ", "あた.る, まさに, こた.える", "apply, answer, yes, OK, reply, accept"),
("押", "オウ", "お.す, お.し-, お.っ-, お.さえる, おさ.える", "push, stop, check, subdue, attach, seize, weight, shove, press, seal, do in spite of"),
("旺", "オウ, キョウ, ゴウ", "かがや.き, うつくし.い, さかん", "flourishing, successful, beautiful, vigorous"),
("横", "オウ", "よこ", "sideways, side, horizontal, width, woof, unreasonable, perverse"),
("欧", "オウ", "うた.う, は.く", "Europe"),
("殴", "オウ", "なぐ.る", "assault, hit, beat, thrash"),
("王", "オウ, -ノウ", "", "king, rule, magnate"),
("翁", "オウ", "おきな", "venerable old man"),
("襖", "オウ", "ふすま, あお", "opaque sliding door"),
("鴬", "オウ", "うぐいす", "nightingale, bush warbler"),
("鴎", "オウ", "かもめ", "seagull"),
("黄", "コウ, オウ", "き, こ-", "yellow"),
("岡", "コウ", "おか", "mount, hill, knoll"),
("沖", "チュウ", "おき, おきつ, ちゅう.する, わく", "open sea, offing, rise high into sky"),
("荻", "テキ", "おぎ", "reed, rush"),
("億", "オク", "", "hundred million, 10**8"),
("屋", "オク", "や", "roof, house, shop, dealer, seller"),
("憶", "オク", "", "recollection, think, remember"),
("臆", "オク, ヨク", "むね, おくする", "timidity, heart, mind, fear, cowardly"),
("桶", "ヨウ, トウ", "おけ", "tub, bucket"),
("牡", "ボ, ボウ", "おす, お-, おん-", "male"),
("乙", "オツ, イツ", "おと-, きのと", "the latter, duplicate, strange, witty, fishhook radical (no. 5)"),
("俺", "エン", "おれ, われ", "I, myself"),
("卸", "シャ", "おろ.す, おろし, おろ.し", "wholesale"),
("恩", "オン", "", "grace, kindness, goodness, favor, mercy, blessing, benefit"),
...
("何", "カ", "なに, なん, なに-, なん-", "what"),
("伽", "カ, ガ, キャ, ギャ", "とぎ", "nursing, attending, entertainer"),
("価", "カ, ケ", "あたい", "value, price"),
("佳", "カ", "", "excellent, beautiful, good, pleasing, skilled"),
("加", "カ", "くわ.える, くわ.わる", "add, addition, increase, join, include, Canada"),
("可", "カ, コク", "-べ.き, -べ.し", "can, passable, mustn't, should not, do not"),
("嘉", "カ", "よみ.する, よい", "applaud, praise, esteem, happy, auspicious"),
("夏", "カ, ガ, ゲ", "なつ", "summer"),
("嫁", "カ", "よめ, とつ.ぐ, い.く, ゆ.く", "marry into, bride"),
...
("果", "カ", "は.たす, はた.す, -は.たす, は.てる, -は.てる, は.て", "fruit, reward, carry out, achieve, complete, end, finish, succeed"),
("架", "カ", "か.ける, か.かる", "erect, frame, mount, support, shelf, construct"),
("歌", "カ", "うた, うた.う", "song, sing"),
("河", "カ", "かわ", "river"),
("火", "カ", "ひ, -び, ほ-", "fire"),
("珂", "カ", "", "jewel"),
("禍", "カ", "わざわい", "calamity, misfortune, evil, curse"),
("禾", "カ", "いね", "two-branch tree radical (no. 115)"),
("稼", "カ", "かせ.ぐ", "earnings, work, earn money"),
("箇", "カ, コ", "", "counter for articles"),
("花", "カ, ケ", "はな", "flower"),
("苛", "カ", "いじ.める, さいな.む, いらだ.つ, からい, こまかい", "torment, scold, chastise"),
("茄", "カ", "", "eggplant"),
("荷", "カ", "に", "baggage, shoulder-pole load, bear (a burden), shoulder (a gun), load, cargo, freight"),
("華", "カ, ケ", "はな", "splendor, flower, petal, shine, luster, ostentatious, showy, gay, gorgeous"),
("菓", "カ", "", "candy, cakes, fruit"),
("蝦", "カ, ゲ", "えび", "shrimp, prawn, lobster"),
("課", "カ", "", "chapter, lesson, section, department, division, counter for chapters (of a book)"),
("嘩", "カ, ケ", "かまびす.しい", "noisy"),
("貨", "カ", "たから", "freight, goods, property"),
("迦", "カ, ケ", "", "(used phonetically)"),
("過", "カ", "す.ぎる, す.ごす, あやま.ち, あやま.つ, よぎ.る, よ.ぎる", "overdo, exceed, go beyond, error"),
("霞", "カ, ゲ", "かすみ, かす.む", "be hazy, grow dim, blurred"),
("蚊", "ブン", "か", "mosquito"),
("俄", "ガ", "にわか", "sudden, abrupt, improvised"),
("峨", "ガ", "けわ.しい", "high mountain"),
("我", "ガ", "われ, わ, わ.が-, わが-", "ego, I, selfish, our, oneself"),
("牙", "ガ, ゲ", "きば, は", "tusk, fang, tusk radical (no. 92)"),
("画", "ガ, カク, エ, カイ", "えが.く, かく.する, かぎ.る, はかりごと, はか.る", "brush-stroke, picture"),
("臥", "ガ", "ふせ.る, ふ.せる, ふ.す", "bend down, bow, lie prostrate"),
("芽", "ガ", "め", "bud, sprout, spear, germ"),
("蛾", "ギ, ガ", "ひむし", "moth"),
("賀", "ガ", "", "congratulations, joy"),
("雅", "ガ", "みや.び", "gracious, elegant, graceful, refined"),
("餓", "ガ", "う.える", "starve, hungry, thirst"),
("駕", "カ, ガ", "かご, が.する, しのぐ, のる", "vehicle, palanquin, litter, hitch up an animal"),
("介", "カイ", "", "jammed in, shellfish, mediate, concern oneself with"),
("会", "カイ, エ", "あ.う, あ.わせる, あつ.まる", "meeting, meet, party, association, interview, join"),
("解", "カイ, ゲ", "と.く, と.かす, と.ける, ほど.く, ほど.ける, わか.る, さと.る", "unravel, notes, key, explanation, understanding, untie, undo, solve, answer, cancel, absolve, explain, minute"),
("回", "カイ, エ", "まわ.る, -まわ.る, -まわ.り, まわ.す, -まわ.す, まわ.し-, -まわ.し, もとお.る, か.える", "-times, round, game, revolve, counter for occurrences"),
("塊", "カイ, ケ", "かたまり, つちくれ", "clod, lump, chunk, clot, mass"),
("壊", "カイ, エ", "こわ.す, こわ.れる, やぶ.る", "demolition, break, destroy"),
("廻", "カイ, エ", "まわ.る, まわ.す, もとお.る, めぐ.る, めぐ.らす", "round, game, revolve, go around, circumference"),
("快", "カイ", "こころよ.い", "cheerful, pleasant, agreeable, comfortable"),
("怪", "カイ, ケ", "あや.しい, あや.しむ", "suspicious, mystery, apparition"),
("悔", "カイ", "く.いる, く.やむ, くや.しい", "repent, regret"),
("恢", "カイ, ケ", "ひろ.い", "wide, large, enlarge"),
("懐", "カイ, エ", "ふところ, なつ.かしい, なつ.かしむ, なつ.く, なつ.ける, なず.ける, いだ.く, おも.う", "feelings, heart, yearn, miss someone, become attached to, bosom, breast, pocket"),
("戒", "カイ", "いまし.める", "commandment"),
("拐", "カイ", "", "kidnap, falsify"),
("改", "カイ", "あらた.める, あらた.まる", "reformation, change, modify, mend, renew, examine, inspect, search"),
("魁", "カイ", "さきがけ, かしら", "charging ahead of others"),
("晦", "カイ", "つごもり, くら.い, みそか, くら.む", "dark, disappear"),
("械", "カイ", "かせ", "contraption, fetter, machine, instrument"),
("海", "カイ", "うみ", "sea, ocean"),
("灰", "カイ", "はい", "ashes, puckery juice, cremate"),
("界", "カイ", "", "world, boundary"),
("皆", "カイ", "みな, みんな", "all, everything"),
("絵", "カイ, エ", "", "picture, drawing, painting, sketch"),
("芥", "カイ, ケ", "からし, ごみ, あくた", "mustard, rape, dust, trash, rubbish"),
("蟹", "カイ", "かに", "crab"),
("開", "カイ", "ひら.く, ひら.き, -びら.き, ひら.ける, あ.く, あ.ける", "open, unfold, unseal"),
("階", "カイ", "きざはし", "storey, stair, counter for storeys of a building"),
("貝", "バイ", "かい", "shellfish"),
("凱", "ガイ, カイ", "かちどき, やわらぐ", "victory song"),
("劾", "ガイ", "", "censure, criminal investigation"),
("外", "ガイ, ゲ", "そと, ほか, はず.す, はず.れる, と-", "outside"),
("咳", "カイ, ガイ", "せ.く, しわぶ.く, せき, しわぶき", "cough, clear throat"),
("害", "ガイ", "", "harm, injury"),
("崖", "ガイ, ゲ, ギ", "がけ, きし, はて", "cliff, bluff, precipice"),
("慨", "ガイ", "なげ.く", "rue, be sad, sigh, lament"),
("概", "ガイ", "おおむ.ね", "outline, condition, approximation, generally"),
("涯", "ガイ", "はて", "horizon, shore, limit, bound"),
("碍", "ガイ, ゲ", "さまた.げる", "obstacle"),
("蓋", "ガイ, カイ, コウ", "ふた, けだ.し, おお.う, かさ, かこう", "cover, lid, flap"),
("街", "ガイ, カイ", "まち", "boulevard, street, town"),
("該", "ガイ", "", "above-stated, the said, that specific"),
("鎧", "カイ, ガイ", "よろ.う, よろい", "put on armor, arm oneself"),
("骸", "ガイ, カイ", "むくろ", "bone, body, corpse"),
("浬", "リ", "かいり, のっと", "knot, nautical mile"),
("馨", "ケイ, キョウ", "かお.る, かおり", "fragrant, balmy, favourable"),
("蛙", "ア, ワ", "かえる, かわず", "frog"),
("垣", "エン", "かき", "hedge, fence, wall"),
("柿", "シ", "かき", "persimmon"),
("蛎", "レイ", "かき", "oyster"),
("鈎", "コウ, ク", "かぎ", "hook, barb, gaff, brackets"),
("劃", "カク", "わ.かつ, かぎ.る", "divide"),
("嚇", "カク", "おど.す", "menacing, dignity, majesty, threaten"),
("各", "カク", "おのおの", "each, every, either"),
("廓", "カク", "くるわ, とりで", "enclosure, quarter, red-light district"),
("拡", "カク, コウ", "ひろ.がる, ひろ.げる, ひろ.める", "broaden, extend, expand, enlarge"),
("撹", "カク, コウ", "みだ.す", "disturb, throw into confusion"),
("格", "カク, コウ, キャク, ゴウ", "", "status, rank, capacity, character, case (law, grammar)"),
("核", "カク", "", "nucleus, core, kernel"),
("殻", "カク, コク, バイ", "から, がら", "husk, nut shell"),
("獲", "カク", "え.る", "seize, get, find, earn, acquire, can, may, able to"),
("確", "カク, コウ", "たし.か, たし.かめる", "assurance, firm, tight, hard, solid, confirm, clear, evident"),
("穫", "カク", "", "harvest, reap"),
("覚", "カク", "おぼ.える, さ.ます, さ.める, さと.る", "memorize, learn, remember, awake, sober up"),
("角", "カク", "かど, つの", "angle, corner, square, horn, antlers"),
("赫", "カク", "あかい, あか, かがや.く", "suddenly, brighten, illuminate, light up"),
("較", "カク, コウ", "くら.べる", "contrast, compare"),
("郭", "カク", "くるわ", "enclosure, quarters, fortification, red-light district"),
("閣", "カク", "", "tower, tall building, palace"),
("隔", "カク", "へだ.てる, へだ.たる", "isolate, alternate, distance, separate, gulf"),
("革", "カク", "かわ", "leather, skin, reform, become serious"),
("学", "ガク", "まな.ぶ", "study, learning, science"),
("岳", "ガク", "たけ", "point, peak, mountain"),
("楽", "ガク, ラク, ゴウ", "たの.しい, たの.しむ, この.む", "music, comfort, ease"),
("額", "ガク", "ひたい", "forehead, tablet, plaque, framed picture, sum, amount, volume"),
("顎", "ガク", "あご, あぎと", "jaw, chin, gill"),
("掛", "カイ, ケイ", "か.ける, -か.ける, か.け, -か.け, -が.け, か.かる, -か.かる, -が.かる, か.かり, -が.かり, かかり, -がかり", "hang, suspend, depend, arrive at, tax, pour"),
("笠", "リュウ", "かさ", "bamboo hat, one's influence"),
("樫", "", "かし", "evergreen oak, (kokuji)"),
("橿", "キョウ", "かし, もちのき", "oak"),
("梶", "ビ", "かじ, こずえ", "sculling oar"),
("鰍", "シュウ, シュ", "かじか, いなだ, どじょう", "bullhead"),
("潟", "セキ", "かた, -がた", "lagoon"),
("割", "カツ", "わ.る, わり, わ.り, わ.れる, さ.く", "proportion, comparatively, divide, cut, separate, split"),
("喝", "カツ", "", "hoarse, scold"),
("恰", "コウ, カッ, チョウ, キョウ", "あたか.も", "just as, as though, fortunately"),
("括", "カツ", "くく.る", "fasten, tie up, arrest, constrict"),
("活", "カツ", "い.きる, い.かす, い.ける", "lively, resuscitation, being helped, living"),
("渇", "カツ", "かわ.く", "thirst, dry up, parch"),
("滑", "カツ, コツ", "すべ.る, なめ.らか", "slippery, slide, slip, fail exam"),
("葛", "カツ, カチ", "つづら, くず", "arrowroot, kudzu"),
("褐", "カツ", "", "brown, woollen kimono"),
("轄", "カツ", "くさび", "control, wedge"),
("且", "ショ, ソ, ショウ", "か.つ", "moreover, also, furthermore"),
("鰹", "ケン", "かつお", "bonito"),
("叶", "キョウ", "かな.える, かな.う", "grant, answer"),
("椛", "", "かば, もみじ", "autumn foliage, birch, maple, (kokuji)"),
("樺", "カ", "かば, かんば", "birch, dark red"),
("鞄", "ハク, ホウ, ビョウ", "かばん", "suitcase, bag, briefcase"),
("株", "シュ", "かぶ", "stocks, stump, shares, stock, counter for small plants"),
("兜", "トウ, ト", "かぶと", "helmet, head piece"),
("竃", "ソウ", "かまど, かま, へっつい", "kitchen stove, furnace, oven, hearth"),
("蒲", "ホ, ボ, フ, ブ", "がま, かば, かま", "bullrush, flag, cattail"),
("釜", "フ", "かま", "kettle, cauldron, iron pot"),
("鎌", "レン, ケン", "かま", "sickle, scythe, trick"),
("噛", "コウ, ゴウ", "か.む, か.じる", "chew, bite, gnaw"),
("鴨", "オウ", "かも, あひる", "wild duck, easy mark"),
("栢", "ハク, ヒャク", "かしわ", "oak"),
("茅", "ボウ, ミョウ", "かや, ちがや", "miscanthus reed"),
("萱", "ケン", "かや, かんぞう", "miscanthus reed"),
("粥", "イク, シュク, ジュク", "かゆ, かい, ひさ.ぐ", "rice gruel"),
("刈", "ガイ, カイ", "か.る", "reap, cut, clip, trim, prune"),
("苅", "ガイ, カイ", "か.る", "cutting (grass)"),
("瓦", "ガ", "かわら, ぐらむ", "tile, gram"),
("乾", "カン, ケン", "かわ.く, かわ.かす, ほ.す, ひ.る, いぬい", "drought, dry, dessicate, drink up, heaven, emperor"),
("侃", "カン", "つよ.い", "strong, just, righteous, peace-loving"),
("冠", "カン", "かんむり", "crown, best, peerless"),
("寒", "カン", "さむ.い", "cold"),
("刊", "カン", "", "publish, carve, engrave"),
("勘", "カン", "", "intuition, perception, check, compare, sixth sense"),
...
("喚", "カン", "わめ.く", "yell, cry, call, scream, summon"),
("堪", "カン, タン", "た.える, たま.る, こら.える, こた.える", "withstand, endure, support, resist"),
("姦", "カン, ケン", "かん.する, かしま.しい, みだら", "wicked, mischief, seduce, rape, noisy"),
("完", "カン", "", "perfect, completion, end"),
("官", "カン", "", "bureaucrat, the government, organ"),
("寛", "カン", "くつろ.ぐ, ひろ.い, ゆる.やか", "tolerant, leniency, generosity, relax, feel at home, be at ease, broadminded"),
("干", "カン", "ほ.す, ほ.し-, -ぼ.し, ひ.る", "dry, parch, ebb, recede, interfere, intercede"),
("幹", "カン", "みき", "tree trunk, main part, talent, capability"),
("患", "カン", "わずら.う", "afflicted, disease, suffer from, be ill"),
("感", "カン", "", "emotion, feeling, sensation"),
("慣", "カン", "な.れる, な.らす", "accustomed, get used to, become experienced"),
("憾", "カン", "うら.む", "remorse, regret, be sorry"),
("換", "カン", "か.える, -か.える, か.わる", "interchange, period, change, convert, replace, renew"),
("敢", "カン", "あ.えて, あ.えない, あ.えず", "daring, brave, bold, sad, tragic, pitiful"),
("柑", "コン, カン", "", "citrus, orange"),
("桓", "カン", "", "marking post"),
("棺", "カン", "", "coffin, casket"),
("款", "カン", "", "goodwill, article, section, friendship, collusion"),
("歓", "カン", "よろこ.ぶ", "delight, joy"),
("汗", "カン", "あせ", "sweat, perspire"),
("漢", "カン", "", "Sino-, China"),
("澗", "カン, ケン", "たに, たにみず", "valley river, 10**36"),
("潅", "カン", "そそ.ぐ", "pour into, irrigate, shed (tears), flow into, concentrate on"),
("環", "カン", "わ", "ring, circle, link, wheel"),
("甘", "カン", "あま.い, あま.える, あま.やかす, うま.い", "sweet, coax, pamper, be content, sugary"),
("監", "カン", "", "oversee, official, govt office, rule, administer"),
("看", "カン", "み.る", "watch over, see"),
("竿", "カン", "さお", "pole, rod, scale beam, violin neck"),
("管", "カン", "くだ", "pipe, tube, wind instrument, drunken talk, control, jurisdiction"),
("簡", "カン, ケン", "えら.ぶ, ふだ", "simplicity, brevity"),
("緩", "カン", "ゆる.い, ゆる.やか, ゆる.む, ゆる.める", "slacken, loosen, relax, lessen, be moderate, ease"),
("缶", "カン", "かま", "tin can, container, jar radical (no. 121)"),
("翰", "カン", "はね, ふで, やまどり, ふみ", "letter, writing brush"),
("肝", "カン", "きも", "liver, pluck, nerve, chutzpah"),
("艦", "カン", "", "warship"),
("莞", "カン", "い", "smiling, reed used to cover tatami"),
("観", "カン", "み.る, しめ.す", "outlook, look, appearance, condition, view"),
("諌", "カン", "いさ.め, いさ.める", "admonish, dissuade"),
("貫", "カン", "つらぬ.く, ぬ.く, ぬき", "pierce, 8 1/3lbs, penetrate, brace"),
("還", "カン", "かえ.る", "send back, return"),
("鑑", "カン", "かんが.みる, かがみ", "specimen, take warning from, learn from"),
("間", "カン, ケン", "あいだ, ま, あい", "interval, space"),
("閑", "カン", "", "leisure"),
("関", "カン", "せき, -ぜき, かか.わる, からくり, かんぬき", "connection, barrier, gateway, involve, concerning"),
("陥", "カン", "おちい.る, おとしい.れる", "collapse, fall into, cave in, fall (castle), slide into"),
("韓", "カン", "から, いげた", "Korea"),
("館", "カン", "やかた, たて", "building, mansion, large building, palace"),
("舘", "カン", "やかた, たて", "mansion, large building, palace"),
("丸", "ガン", "まる, まる.める, まる.い", "round, full (month), perfection, -ship, pills, make round, roll up, curl up, seduce, explain away"),
("含", "ガン", "ふく.む, ふく.める", "contain, include, hold in the mouth, bear in mind, understand, cherish"),
("岸", "ガン", "きし", "beach"),
("巌", "ガン", "いわ, いわお, けわ.しい", "rock, crag, boulder"),
("玩", "ガン", "もちあそ.ぶ, もてあそ.ぶ", "play, take pleasure in, trifle with, make sport of"),
("癌", "ガン", "", "cancer, cancerous evil"),
("眼", "ガン, ゲン", "まなこ, め", "eyeball"),
("岩", "ガン", "いわ", "boulder, rock, cliff"),
("翫", "ガン", "もてあそ.ぶ", "take pleasure in, play instrument"),
("贋", "ガン", "にせ", "counterfeit, forgery"),
("雁", "ガン", "かり, かりがね", "wild goose"),
("頑", "ガン", "かたく.な", "stubborn, foolish, firmly"),
("顔", "ガン", "かお", "face, expression"),
("願", "ガン", "ねが.う, -ねがい", "petition, request, vow, wish, hope"),
("企", "キ", "くわだ.てる, たくら.む", "undertake, scheme, design, attempt, plan"),
("伎", "ギ, キ", "わざ, わざおぎ", "deed, skill"),
("危", "キ", "あぶ.ない, あや.うい, あや.ぶむ", "dangerous, fear, uneasy"),
("喜", "キ", "よろこ.ぶ, よろこ.ばす", "rejoice, take pleasure in"),
("器", "キ", "うつわ", "utensil, vessel, receptacle, implement, instrument, ability, container, tool, set"),
("基", "キ", "もと, もとい", "fundamentals, radical (chem), counter for machines, foundation"),
("奇", "キ", "く.しき, あや.しい, くし, めずら.しい", "strange, strangeness, curiosity"),
("嬉", "キ", "うれ.しい, たの.しむ", "glad, pleased, rejoice"),
("寄", "キ", "よ.る, -よ.り, よ.せる", "draw near, stop in, bring near, gather, collect, send, forward"),
("岐", "キ, ギ", "", "branch off, fork in road, scene, arena, theater"),
("希", "キ, ケ", "まれ, こいねが.う", "hope, beg, request, pray, beseech, Greece, dilute (acid), rare, few, phenomenal"),
("幾", "キ", "いく-, いく.つ, いく.ら", "how many, how much, how far, how long, some, several"),
("忌", "キ", "い.む, い.み, い.まわしい", "mourning, abhor, detestable, death anniversary"),
...
("機", "キ", "はた", "loom, mechanism, machine, airplane, opportunity, potency, efficacy, occasion"),
("帰", "キ", "かえ.る, かえ.す, おく.る, とつ.ぐ", "homecoming, arrive at, lead to, result in"),
("毅", "キ, ギ", "つよ.い", "strong"),
("気", "キ, ケ", "き", "spirit, mind, air, atmosphere, mood"),
("汽", "キ", "", "vapor, steam"),
("畿", "キ", "みやこ", "capital, suburbs of capital"),
("祈", "キ", "いの.る", "pray, wish"),
("季", "キ", "", "seasons"),
("稀", "キ, ケ", "まれ, まばら", "rare, phenomenal, dilute (acid)"),
("紀", "キ", "", "chronicle, account, narrative, history, annals, geologic period"),
("徽", "キ", "しるし", "good, beautiful, badge"),
("規", "キ", "", "standard, measure"),
("記", "キ", "しる.す", "scribe, account, narrative"),
("貴", "キ", "たっと.い, とうと.い, たっと.ぶ, とうと.ぶ", "precious, value, prize, esteem, honor"),
("起", "キ", "お.きる, お.こる, お.こす, おこ.す, た.つ", "rouse, wake up, get up"),
("軌", "キ", "", "rut, wheel, track, model, way of doing"),
("輝", "キ", "かがや.く", "radiance, shine, sparkle, gleam, twinkle"),
("飢", "キ", "う.える", "hungry, starve"),
("騎", "キ", "", "equestrian, riding on horses, counter for equestrians"),
("鬼", "キ", "おに, おに-", "ghost, devil"),
("亀", "キ, キュウ, キン", "かめ", "tortoise, turtle"),
("偽", "ギ, カ", "いつわ.る, にせ, いつわ.り", "falsehood, lie, deceive, pretend, counterfeit, forgery"),
("儀", "ギ", "", "ceremony, rule, affair, case, a matter"),
("妓", "ギ, キ", "わざおぎ, うたいめ", "stretch, singing girl, geisha, prostitute"),
("宜", "ギ", "よろ.しい, よろ.しく", "best regards, good"),
("戯", "ギ, ゲ", "たわむ.れる, ざ.れる, じゃ.れる", "frolic, play, sport"),
("技", "ギ", "わざ", "skill, art, craft, ability, feat, performance, vocation, arts"),
("擬", "ギ", "まが.い, もど.き", "mimic, aim (a gun) at, nominate, imitate"),
("欺", "ギ", "あざむ.く", "deceit, cheat, delude"),
("犠", "ギ, キ", "いけにえ", "sacrifice"),
("疑", "ギ", "うたが.う", "doubt, distrust, be suspicious, question"),
("祇", "ギ, キ, シ", "くにつかみ, ただ, まさに", "national or local god, peaceful, great"),
("義", "ギ", "", "righteousness, justice, morality, honor, loyalty, meaning"),
("蟻", "ギ", "あり", "ant"),
...
("菊", "キク", "", "chrysanthemum"),
("鞠", "キク, キュウ", "まり", "ball"),
("吉", "キチ, キツ", "よし", "good luck, joy, congratulations"),
("吃", "キツ", "ども.る", "stammer"),
("喫", "キツ", "の.む", "consume, eat, drink, smoke, receive (a blow)"),
("桔", "キツ, ケツ", "", "used in plant names"),
("橘", "キツ", "たちばな", "mandarin orange"),
("詰", "キツ, キチ", "つ.める, つ.め, -づ.め, つ.まる, つ.む", "packed, close, pressed, reprove, rebuke, blame"),
("砧", "チン", "きぬた", "fulling block"),
("杵", "ショ, ソ", "きね", "wooden pestle"),
("黍", "ショ", "きび", "millet"),
("却", "キャク", "かえ.って, しりぞ.く, しりぞ.ける", "instead, on the contrary, rather, step back, withdraw, retreat"),
("客", "キャク, カク", "", "guest, visitor, customer, client"),
("脚", "キャク, キャ, カク", "あし", "skids, leg, undercarriage, lower part, base"),
("虐", "ギャク", "しいた.げる", "tyrannize, oppress"),
("逆", "ギャク, ゲキ", "さか, さか.さ, さか.らう", "inverted, reverse, opposite, wicked"),
("丘", "キュウ", "おか", "hill, knoll"),
("久", "キュウ, ク", "ひさ.しい", "long time, old story"),
("仇", "キュウ, グ", "あだ, あた, かたき, つれあい", "foe, enemy, revenge, grudge, feud"),
("休", "キュウ", "やす.む, やす.まる, やす.める", "rest, day off, retire, sleep"),
("及", "キュウ", "およ.ぶ, およ.び, および, およ.ぼす", "reach out, exert, exercise, cause"),
("吸", "キュウ", "す.う", "suck, imbibe, inhale, sip"),
("宮", "キュウ, グウ, ク, クウ", "みや", "Shinto shrine, constellations, palace, princess"),
("弓", "キュウ", "ゆみ", "bow, bow (archery, violin)"),
("急", "キュウ", "いそ.ぐ, いそ.ぎ, せ.く", "hurry, emergency, sudden, steep"),
("救", "キュウ", "すく.う", "salvation, save, help, rescue, reclaim"),
("朽", "キュウ", "く.ちる", "decay, rot, remain in seclusion"),
("求", "キュウ, グ", "もと.める", "request, want, wish for, require, demand"),
("汲", "キュウ", "く.む", "draw (water), ladle, scoop, pump"),
("泣", "キュウ", "な.く", "cry, weep, moan"),
("灸", "キュウ, ク", "やいと", "moxa cautery, chastisement"),
("球", "キュウ", "たま", "ball, sphere"),
("究", "キュウ, ク", "きわ.める", "research, study"),
("窮", "キュウ, キョウ", "きわ.める, きわ.まる, きわ.まり, きわ.み", "hard up, destitute, suffer, perplexed, cornered"),
("笈", "キュウ", "", "backpack bookcase"),
("級", "キュウ", "", "class, rank, grade"),
("糾", "キュウ", "ただ.す", "twist, ask, investigate, verify"),
("給", "キュウ", "たま.う, たも.う, -たま.え", "salary, wage, gift, allow, grant, bestow on"),
...
("挙", "キョ", "あ.げる, あ.がる, こぞ.る", "raise, plan, project, behavior, actions"),
("渠", "キョ", "かれ, なんぞ, なに, みぞ, いずくんぞ", "ditch, canal, lock"),
("虚", "キョ, コ", "むな.しい, うつ.ろ", "void, emptiness, unpreparedness, crack, fissure, untruth"),
("許", "キョ", "ゆる.す, もと", "permit, approve"),
("距", "キョ", "へだ.たる, けづめ", "long-distance, spur, fetlock"),
("鋸", "キョ, コ", "のこ, のこぎり", "saw (cuts wood)"),
("漁", "ギョ, リョウ", "あさ.る", "fishing, fishery"),
("禦", "ギョ, ゴ", "ふせ.ぐ", "defend, protect, resist, ward off"),
("魚", "ギョ", "うお, さかな, -ざかな", "fish"),
("亨", "コウ, キョウ, ホウ", "とお.る", "pass through, go smoothly"),
("享", "キョウ, コウ", "う.ける", "enjoy, receive, undergo, answer (phone), take, get, catch"),
("京", "キョウ, ケイ, キン", "みやこ", "capital, 10**16"),
("供", "キョウ, ク, クウ, グ", "そな.える, とも, -ども", "submit, offer, present, serve (meal), accompany"),
("侠", "キョウ", "きゃん, おとこだて", "tomboy, chivalry"),
("僑", "キョウ", "", "expatriate, person living abroad, temporary home"),
("兇", "キョウ", "おそ.れる, わる.い", "wickedness"),
("競", "キョウ, ケイ", "きそ.う, せ.る, くら.べる", "emulate, compete with, bid, sell at auction, bout, contest, race"),
("共", "キョウ", "とも, とも.に, -ども", "together, both, neither, all, and, alike, with"),
("凶", "キョウ", "", "villain, evil, bad luck, disaster"),
("協", "キョウ", "", "co-, cooperation"),
("匡", "キョウ, オウ", "すく.う, ただ.す", "correct, save, assist"),
("卿", "ケイ, キョウ", "きみ", "you, lord, secretary, state minister"),
("叫", "キョウ", "さけ.ぶ", "shout, exclaim, yell"),
("喬", "キョウ", "たか.い", "high, boasting"),
("境", "キョウ, ケイ", "さかい", "boundary, border, region"),
("峡", "キョウ, コウ", "はざま", "gorge, ravine"),
("強", "キョウ, ゴウ", "つよ.い, つよ.まる, つよ.める, し.いる, こわ.い", "strong"),
("彊", "キョウ, ゴウ", "つよ.い", "strong"),
("怯", "キョウ, コウ", "ひる.む, おびえ.る, おじる, おび.える, おそ.れる", "cowardice, wince, flinch, hesitate, waver"),
("恐", "キョウ", "おそ.れる, おそ.る, おそ.ろしい, こわ.い, こわ.がる", "fear, dread, awe"),
("恭", "キョウ", "うやうや.しい", "respect, reverent"),
...
("狭", "キョウ, コウ", "せま.い, せば.める, せば.まる, さ", "cramped, narrow, contract, tight"),
("矯", "キョウ", "た.める", "rectify, straighten, correct, reform, cure, control, pretend, falsify"),
...
("蕎", "キョウ", "そば", "buckwheat"),
("郷", "キョウ, ゴウ", "さと", "home town, village, native place, district"),
("鏡", "キョウ, ケイ", "かがみ", "mirror, speculum, barrel-head, round rice-cake offering"),
("響", "キョウ", "ひび.く", "echo, sound, resound, ring, vibrate"),
("饗", "キョウ", "う.ける, もてな.す", "banquet"),
("驚", "キョウ", "おどろ.く, おどろ.かす", "wonder, be surprised, frightened, amazed"),
("仰", "ギョウ, コウ", "あお.ぐ, おお.せ, お.っしゃる, おっしゃ.る", "face-up, look up, depend, seek, respect, revere, drink, take"),
("凝", "ギョウ", "こ.る, こ.らす, こご.らす, こご.らせる, こご.る", "congeal, freeze, stiff, be absorbed in"),
("尭", "ギョウ", "たか.い", "high, far"),
("暁", "ギョウ, キョウ", "あかつき, さと.る", "daybreak, dawn, in the event"),
("業", "ギョウ, ゴウ", "わざ", "business, vocation, arts, performance"),
("局", "キョク", "つぼね", "bureau, board, office, affair, conclusion, court lady, lady-in-waiting, her apartment"),
("曲", "キョク", "ま.がる, ま.げる, くま", "bend, music, melody, composition, pleasure, injustice, fault, curve, crooked, perverse, lean"),
("極", "キョク, ゴク", "きわ.める, きわ.まる, きわ.まり, きわ.み, き.める, -ぎ.め, き.まる", "poles, settlement, conclusion, end, highest rank, electric poles, very, extremely, most, highly, 10**48"),
("玉", "ギョク", "たま, たま-, -だま", "jewel, ball"),
("桐", "トウ, ドウ", "きり", "paulownia"),
("粁", "", "キロメートル", "kilometer, (kokuji)"),
("僅", "キン, ゴン", "わず.か", "a wee bit"),
("勤", "キン, ゴン", "つと.める, -づと.め, つと.まる, いそ.しむ", "diligence, become employed, serve"),
("均", "キン", "なら.す", "level, average"),
("巾", "キン, フク", "おお.い, ちきり, きれ", "towel, hanging scroll, width, cloth radical (no. 50)"),
("錦", "キン", "にしき", "brocade, fine dress, honors"),
("斤", "キン", "", "axe, 1.32 lb, catty, counter for loaves of bread, axe radical (no. 69)"),
("欣", "キン, ゴン, コン", "よろこ.ぶ, よろこ.び", "take pleasure in, rejoice"),
("欽", "キン, コン", "つつし.む", "respect, revere, long for"),
("琴", "キン, ゴン", "こと", "harp, koto"),
("禁", "キン", "", "prohibition, ban, forbid"),
("禽", "キン", "とり, とりこ", "bird, captive, capture"),
("筋", "キン", "すじ", "muscle, sinew, tendon, fiber, plot, plan, descent"),
("緊", "キン", "し.める, し.まる", "tense, solid, hard, reliable, tight"),
("芹", "キン", "せり", "parsley"),
("菌", "キン", "", "germ, fungus, bacteria"),
("衿", "キン, コン", "えり", "neck, collar, lapel"),
("襟", "キン", "えり", "collar, neck, lapel, one's inner feelings"),
...
("銀", "ギン", "しろがね", "silver"),
("九", "キュウ, ク", "ここの, ここの.つ", "nine"),
("倶", "グ, ク", "とも.に", "both, together, alike"),
("句", "ク", "", "phrase, clause, sentence, passage, paragraph, counter for haiku"),
("区", "ク, オウ, コウ", "", "ward, district"),
("狗", "ク, コウ", "いぬ", "puppy, dog"),
("玖", "キュウ, ク", "", "beautiful black jewel, nine"),
("矩", "ク", "かね, かねざし, さしがね", "ruler, carpenter's square"),
("苦", "ク", "くる.しい, -ぐる.しい, くる.しむ, くる.しめる, にが.い, にが.る", "suffering, trial, worry, hardship, feel bitter, scowl"),
("躯", "ク", "むくろ, からだ", "body, corpse, tree with rotten core"),
("駆", "ク", "か.ける, か.る", "drive, run, gallop, advance, inspire, impel"),
("駈", "ク", "か.ける, か.る", "run, gallop, advance"),
("駒", "ク", "こま", "pony, horse, colt"),
("具", "グ", "そな.える, つぶさ.に", "tool, utensil, means, possess, ingredients, counter for armor, suits, sets of furniture"),
("愚", "グ", "おろ.か", "foolish, folly, absurdity, stupid"),
("虞", "グ", "おそれ, おもんぱか.る, はか.る, うれ.える, あざむ.く, あやま.る, のぞ.む, たの.しむ", "fear, uneasiness, anxiety, concern, expectation, consideration"),
("喰", "", "く.う, く.らう", "eat, drink, receive (a blow), (kokuji)"),
("空", "クウ", "そら, あ.く, あ.き, あ.ける, から, す.く, す.かす, むな.しい", "empty, sky, void, vacant, vacuum"),
("偶", "グウ", "たま", "accidentally, even number, couple, man & wife, same kind"),
("寓", "グウ, グ, ドウ", "ぐう.する, かこつ.ける, よ.せる, よ.る, かりずまい", "temporary abode, imply, suggest"),
("遇", "グウ", "あ.う", "meet, encounter, interview, treat, entertain, receive, deal with"),
("隅", "グウ", "すみ", "corner, nook"),
("串", "カン, ケン, セン", "くし, つらぬ.く", "spit, skewer"),
("櫛", "シツ", "くし, くしけず.る", "comb"),
("釧", "セン", "くしろ, うでわ", "bracelet"),
("屑", "セツ", "くず, いさぎよ.い", "rubbish, junk, trash, waste, scraps"),
("屈", "クツ", "かが.む, かが.める", "yield, bend, flinch, submit"),
("掘", "クツ", "ほ.る", "dig, delve, excavate"),
("窟", "クツ, コツ", "いわや, いはや, あな", "cavern"),
("沓", "トウ", "くつ", "shoes, boots"),
("靴", "カ", "くつ", "shoes"),
("轡", "ヒ", "くつわ, たづな", "bit (horse)"),
("窪", "ワ, ア", "くぼ.む, くぼ.み, くぼ.まる, くぼ", "depression, cave in, sink, become hollow"),
("熊", "ユウ", "くま", "bear"),
("隈", "ワイ, エ", "くま, すみ", "corner, nook, recess"),
("粂", "", "くめ", "used in proper names, (kokuji)"),
("栗", "リツ, リ", "くり, おののく", "chestnut"),
("繰", "ソウ", "く.る", "winding, reel, spin, turn (pages), look up, refer to"),
("桑", "ソウ", "くわ", "mulberry"),
("鍬", "ショウ, シュウ", "くわ, すき", "hoe with long blade at acute angle"),
("勲", "クン", "いさお", "meritorious deed, merit"),
("君", "クン", "きみ, -ぎみ", "mister, you, ruler, male name suffix"),
("薫", "クン", "かお.る", "send forth fragrance, fragrant, be scented, smoke (tobacco)"),
...
("軍", "グン", "いくさ", "army, force, troops, war, battle"),
("郡", "グン", "こおり", "county, district"),
("卦", "カ, カイ, ケ", "うらかた", "a divination sign"),
("袈", "ケ, カ", "", "a coarse camlet"),
("祁", "キ, ケ", "", "intense, large"),
("係", "ケイ", "かか.る, かかり, -がかり, かか.わる", "person in charge, connection, duty, concern oneself"),
("傾", "ケイ", "かたむ.く, かたむ.ける, かたぶ.く, かた.げる, かし.げる", "lean, incline, tilt, trend, wane, sink, ruin, bias"),
("刑", "ケイ", "", "punish, penalty, sentence, punishment"),
("兄", "ケイ, キョウ", "あに", "elder brother, big brother"),
("啓", "ケイ", "ひら.く, さと.す", "disclose, open, say"),
("圭", "ケイ, ケ", "", "square jewel, corner, angle, edge"),
("珪", "ケイ", "たま", "jade scepter or tablet (authority symbol)"),
("型", "ケイ", "かた, -がた", "mould, type, model"),
("契", "ケイ", "ちぎ.る", "pledge, promise, vow"),
("形", "ケイ, ギョウ", "かた, -がた, かたち, なり", "shape, form, style"),
("径", "ケイ", "みち, こみち, さしわたし, ただちに", "diameter, path, method"),
("恵", "ケイ, エ", "めぐ.む, めぐ.み", "favor, blessing, grace, kindness"),
("慶", "ケイ", "よろこ.び", "jubilation, congratulate, rejoice, be happy"),
("慧", "ケイ, エ", "さとい", "wise"),
("憩", "ケイ", "いこ.い, いこ.う", "recess, rest, relax, repose"),
...
("景", "ケイ", "", "scenery, view"),
("桂", "ケイ", "かつら", "Japanese Judas-tree, cinnamon tree"),
("渓", "ケイ", "たに, たにがわ", "mountain stream, valley"),
("畦", "ケイ", "あぜ, うね", "rice paddy ridge, furrow, rib"),
("稽", "ケイ", "かんが.える, とど.める", "think, consider"),
("系", "ケイ", "", "lineage, system"),
("経", "ケイ, キョウ, キン", "へ.る, た.つ, たていと, はか.る, のり", "sutra, longitude, pass thru, expire, warp"),
("継", "ケイ", "つ.ぐ, まま-", "inherit, succeed, continue, patch, graft (tree)"),
("繋", "ケイ", "つな.ぐ, かか.る, か.ける", "tie, fasten, chain, tether, connect"),
("罫", "ケイ, カイ, ケ", "", "ruled line"),
("茎", "ケイ, キョウ", "くき", "stalk, stem"),
("荊", "ケイ", "いばら", "thorn, brier, whip"),
("蛍", "ケイ", "ほたる", "lightning-bug, firefly"),
("計", "ケイ", "はか.る, はか.らう", "plot, plan, scheme, measure"),
("詣", "ケイ, ゲイ", "けい.する, まい.る, いた.る, もう.でる", "visit a temple, arrive, attain"),
("警", "ケイ", "いまし.める", "admonish, commandment"),
("軽", "ケイ, キョウ, キン", "かる.い, かろ.やか, かろ.んじる", "lightly, trifling, unimportant"),
("頚", "ケイ", "くび", "neck, head"),
("鶏", "ケイ", "にわとり, とり", "chicken"),
("芸", "ゲイ, ウン", "う.える, のり, わざ", "technique, art, craft, performance, acting, trick, stunt"),
...
("隙", "ゲキ, キャク, ケキ", "すき, す.く, す.かす, ひま", "crevice, fissure, discord, opportunity, leisure"),
("桁", "コウ", "けた", "beam, girder, spar, unit or column (accounting)"),
("傑", "ケツ", "すぐ.れる", "greatness, excellence"),
("欠", "ケツ, ケン", "か.ける, か.く", "lack, gap, fail, yawning radical (no. 76)"),
("決", "ケツ", "き.める, -ぎ.め, き.まる, さ.く", "decide, fix, agree upon, appoint"),
("潔", "ケツ", "いさぎよ.い", "undefiled, pure, clean, righteous, gallant"),
("穴", "ケツ", "あな", "hole, aperture, slit, cave, den"),
("結", "ケツ, ケチ", "むす.ぶ, ゆ.う, ゆ.わえる", "tie, bind, contract, join, organize, do up hair, fasten"),
("血", "ケツ", "ち", "blood"),
("訣", "ケツ", "わかれ, わかれ.る", "separation, part, secret"),
("月", "ゲツ, ガツ", "つき", "month, moon"),
("件", "ケン", "くだん", "affair, case, matter, item"),
("倹", "ケン", "つま.しい, つづまやか", "frugal, economy, thrifty"),
("倦", "ケン", "あき.る, あぐ.む, あぐ.ねる, う.む, つか.れる", "lose interest in, tire of"),
("健", "ケン", "すこ.やか", "healthy, health, strength, persistence"),
("兼", "ケン", "か.ねる, -か.ねる", "concurrently, and, beforehand, in advance"),
("券", "ケン", "", "ticket"),
("剣", "ケン", "つるぎ", "sabre, sword, blade, clock hand"),
("喧", "ケン", "やかま.しい, かまびす.しい", "noisy, boisterous"),
("圏", "ケン", "かこ.い", "sphere, circle, radius, range"),
("堅", "ケン", "かた.い, -がた.い", "strict, hard, solid, tough, tight, reliable"),
("嫌", "ケン, ゲン", "きら.う, きら.い, いや", "dislike, detest, hate"),
("建", "ケン, コン", "た.てる, た.て, -だ.て, た.つ", "build"),
("憲", "ケン", "", "constitution, law"),
("懸", "ケン, ケ", "か.ける, か.かる", "state of suspension, hang, depend, consult, distant, far apart"),
("拳", "ケン, ゲン", "こぶし", "fist"),
...
("権", "ケン, ゴン", "おもり, かり, はか.る", "authority, power, rights"),
("牽", "ケン", "ひ.く", "pull, tug, drag, lead by hand"),
("犬", "ケン", "いぬ, いぬ-", "dog"),
("献", "ケン, コン", "たてまつ.る", "offering, counter for drinks, present, offer"),
("研", "ケン", "と.ぐ", "polish, study of, sharpen"),
("硯", "ケン, ゲン", "すずり", "inkstone"),
("絹", "ケン", "きぬ", "silk"),
("県", "ケン", "か.ける", "prefecture"),
("肩", "ケン", "かた", "shoulder"),
("見", "ケン", "み.る, み.える, み.せる", "see, hopes, chances, idea, opinion, look at, visible"),
("謙", "ケン", "へりくだ.る", "self-effacing, humble oneself, condescend, be modest"),
("賢", "ケン", "かしこ.い", "intelligent, wise, wisdom, cleverness"),
("軒", "ケン", "のき", "flats, counter for houses, eaves"),
("遣", "ケン", "つか.う, -つか.い, -づか.い, つか.わす, や.る", "dispatch, despatch, send, give, donate, do, undertake"),
("鍵", "ケン", "かぎ", "key"),
("険", "ケン", "けわ.しい", "precipitous, inaccessible place, impregnable position, steep place, sharp eyes"),
("顕", "ケン", "あきらか, あらわ.れる", "appear, existing"),
("験", "ケン, ゲン", "あかし, しるし, ため.す, ためし", "verification, effect, testing"),
("鹸", "ケン, カン, セン", "あ.く", "saltiness"),
("元", "ゲン, ガン", "もと", "beginning, former time, origin"),
("原", "ゲン", "はら", "meadow, original, primitive, field, plain, prairie, tundra, wilderness"),
("厳", "ゲン, ゴン", "おごそ.か, きび.しい, いか.めしい, いつくし", "stern, strictness, severity, rigidity"),
...
("源", "ゲン", "みなもと", "source, origin"),
("玄", "ゲン", "くろ, くろ.い", "mysterious, occultness, black, deep, profound"),
("現", "ゲン", "あらわ.れる, あらわ.す, うつつ, うつ.つ", "present, existing, actual"),
("絃", "ゲン", "いと", "string, cord, samisen music"),
("舷", "ゲン", "ふなばた, ふなべり", "gunwale"),
("言", "ゲン, ゴン", "い.う, こと", "say, word"),
("諺", "ゲン", "ことわざ", "proverb"),
("限", "ゲン", "かぎ.る, かぎ.り, -かぎ.り", "limit, restrict, to best of ability"),
("乎", "コ, オ", "か, ああ, かな, や, よ, を", "question mark, ?"),
("個", "コ, カ", "", "individual, counter for articles"),
("古", "コ", "ふる.い, ふる-, -ふる.す", "old"),
("呼", "コ", "よ.ぶ", "call, call out to, invite"),
("固", "コ", "かた.める, かた.まる, かた.まり, かた.い", "harden, set, clot, curdle"),
("姑", "コ", "しゅうとめ, しゅうと, おば, しばらく", "mother-in-law"),
("孤", "コ", "", "orphan, alone"),
("己", "コ, キ", "おのれ, つちのと, な", "self"),
("庫", "コ, ク", "くら", "warehouse, storehouse"),
("弧", "コ", "", "arc, arch, bow"),
("戸", "コ", "と", "door, counter for houses, door radical (no. 63)"),
("故", "コ", "ゆえ, ふる.い, もと", "happenstance, especially, intentionally, reason, cause, circumstances, the late, therefore, consequently"),
("枯", "コ", "か.れる, か.らす", "wither, die, dry up, be seasoned"),
("湖", "コ", "みずうみ", "lake"),
("狐", "コ", "きつね", "fox"),
("糊", "コ, ゴ, コツ", "のり", "paste, glue, sizing"),
("袴", "コ, ク", "はかま, ずぼん", "men's formal divided skirt"),
("股", "コ", "また, もも", "thigh, crotch"),
("胡", "ウ, コ, ゴ", "なんぞ", "barbarian, foreign"),
("菰", "コ", "こも, まこも", "reed used for matting"),
("虎", "コ", "とら", "tiger, drunkard"),
("誇", "コ", "ほこ.る", "boast, be proud, pride, triumphantly"),
("跨", "コ, カ", "また.がる, またが.る, また.ぐ", "be, sit or stand astride, extend over, straddle"),
("鈷", "コ", "", "cobalt"),
("雇", "コ", "やと.う", "employ, hire"),
("顧", "コ", "かえり.みる", "look back, review, examine oneself, turn around"),
("鼓", "コ", "つづみ", "drum, beat, rouse, muster"),
("五", "ゴ", "いつ, いつ.つ", "five"),
("互", "ゴ", "たが.い, かたみ.に", "mutually, reciprocally, together"),
("伍", "ゴ", "いつつ", "five, five-man squad, file, line"),
("午", "ゴ", "うま", "noon, sign of the horse, 11AM-1PM, seventh sign of Chinese zodiac"),
("呉", "ゴ", "く.れる, くれ", "give, do something for, kingdom of Wu"),
("吾", "ゴ", "われ, わが-, あ-", "I, my, our, one's own"),
("娯", "ゴ", "", "recreation, pleasure"),
("後", "ゴ, コウ", "のち, うし.ろ, うしろ, あと, おく.れる", "behind, back, later"),
("御", "ギョ, ゴ", "おん-, お-, み-", "honorable, manipulate, govern"),
("悟", "ゴ", "さと.る", "enlightenment, perceive, discern, realize, understand"),
("梧", "ゴ", "あおぎり", "Chinese parasol tree, phoenix tree"),
("檎", "キン, ゴン, ゴ", "", "apple"),
("瑚", "コ, ゴ", "", "ancestral offering receptacle, coral"),
("碁", "ゴ", "", "Go"),
("語", "ゴ", "かた.る, かた.らう", "word, speech, language"),
("誤", "ゴ", "あやま.る, -あやま.る", "mistake, err, do wrong, mislead"),
("護", "ゴ", "まも.る", "safeguard, protect"),
("醐", "ゴ, コ", "", "boiled butter"),
("乞", "コツ, キツ, キ, キケ, コチ", "こ.う", "beg, invite, ask"),
("鯉", "リ", "こい", "carp"),
("交", "コウ", "まじ.わる, まじ.える, ま.じる, まじ.る, ま.ざる, ま.ぜる, -か.う, か.わす, かわ.す, こもごも", "mingle, mixing, association, coming & going"),
("佼", "キョウ, コウ", "こう.す, うつく.しい", "beautiful, clever, deceive, sly"),
("侯", "コウ", "", "marquis, lord, daimyo"),
("候", "コウ", "そうろう", "climate, season, weather, wait for, expect"),
("倖", "コウ", "しあわ.せ, さいわ.い", "happiness, luck"),
("光", "コウ", "ひか.る, ひかり", "ray, light"),
("公", "コウ, ク", "おおやけ", "public, prince, official, governmental"),
("功", "コウ, ク", "いさお", "achievement, merits, success, honor, credit"),
("効", "コウ", "き.く, ききめ, なら.う", "merit, efficacy, efficiency, benefit"),
("勾", "コウ, ク", "かぎ, ま.がる", "be bent, slope, capture"),
("厚", "コウ", "あつ.い, あか", "thick, heavy, rich, kind, cordial, brazen, shameless"),
("口", "コウ, ク", "くち", "mouth"),
...
("坑", "コウ", "", "pit, hole"),
("垢", "コウ, ク", "あか, はじ", "dirt, grime, earwax"),
("好", "コウ", "この.む, す.く, よ.い, い.い", "fond, pleasing, like something"),
("孔", "コウ, ク", "あな", "cavity, hole, slit, very, great, exceedingly"),
("孝", "コウ, キョウ", "", "filial piety, child's respect"),
("宏", "コウ", "ひろ.い", "wide, large"),
("工", "コウ, ク, グ", "", "craft, construction, katakana e radical (no. 48)"),
("巧", "コウ", "たく.み, たく.む, うま.い", "adroit, skilled, ingenuity"),
("巷", "コウ", "ちまた", "fork in road, scene, arena, theater"),
("幸", "コウ", "さいわ.い, さち, しあわ.せ", "happiness, blessing, fortune"),
("広", "コウ", "ひろ.い, ひろ.まる, ひろ.める, ひろ.がる, ひろ.げる", "wide, broad, spacious"),
("庚", "コウ", "かのえ", "7th, 7th calendar sign"),
("康", "コウ", "", "ease, peace"),
("弘", "コウ, グ", "ひろ.い", "vast, broad, wide"),
("恒", "コウ", "つね, つねに", "constancy, always"),
("慌", "コウ", "あわ.てる, あわ.ただしい", "disconcerted, be confused, lose one's head"),
("抗", "コウ", "あらが.う", "confront, resist, defy, oppose"),
("拘", "コウ", "かか.わる", "arrest, seize, concerned, adhere to, despite"),
("控", "コウ", "ひか.える, ひか.え", "withdraw, draw in, hold back, refrain from, be moderate"),
("攻", "コウ", "せ.める", "aggression, attack, criticize, polish"),
("昂", "コウ, ゴウ", "あ.がる, たか.い, たか.ぶる", "rise"),
("晃", "コウ", "あきらか", "clear"),
("更", "コウ", "さら, さら.に, ふ.ける, ふ.かす", "grow late, night watch, sit up late, of course, renew, renovate, again, more and more, further"),
("杭", "コウ", "くい", "stake, post, picket"),
("校", "コウ, キョウ", "", "exam, school, printing, proof, correction"),
("梗", "コウ, キョウ", "ふさぐ, やまにれ, おおむね", "for the most part, close up, flower stem"),
("構", "コウ", "かま.える, かま.う", "posture, build, pretend"),
("江", "コウ", "え", "creek, inlet, bay"),
("洪", "コウ", "", "deluge, flood, vast"),
("浩", "コウ", "おおき.い, ひろ.い", "wide expanse, abundance, vigorous"),
("港", "コウ", "みなと", "harbor"),
("溝", "コウ", "みぞ", "gutter, ditch, sewer, drain, 10**32"),
("甲", "コウ, カン", "きのえ", "armor, high (voice), A grade, first class, former, instep, carapace"),
("皇", "コウ, オウ", "", "emperor"),
("硬", "コウ", "かた.い", "stiff, hard"),
("稿", "コウ", "わら, したがき", "draft, copy, manuscript, straw"),
("糠", "コウ", "ぬか", "rice bran"),
("紅", "コウ, ク", "べに, くれない, あか.い", "crimson, deep red"),
("紘", "コウ", "おおづな, つな, つなぐ", "large"),
...
("肱", "コウ", "かいな, ひじ, まるい", "ability, talent, elbow, arm"),
("腔", "コウ", "", "body cavity"),
("膏", "コウ", "あぶら", "fat, grease, lard, paste, ointment, plaster"),
("航", "コウ", "", "navigate, sail, cruise, fly"),
("荒", "コウ", "あ.らす, あ.れる, あら.い, すさ.ぶ, すさ.む, あ.らし", "laid waste, rough, rude, wild"),
("行", "コウ, ギョウ, アン", "い.く, ゆ.く, -ゆ.き, -ゆき, -い.き, -いき, おこな.う, おこ.なう", "going, journey, carry out, conduct, act, line, row, bank"),
("衡", "コウ", "", "equilibrium, measuring rod, scale"),
...
("砿", "コウ", "あらがね", "ore"),
("鋼", "コウ", "はがね", "steel"),
("閤", "コウ", "くぐりど", "small side gate"),
("降", "コウ, ゴ", "お.りる, お.ろす, ふ.る, ふ.り, くだ.る, くだ.す", "descend, precipitate, fall, surrender"),
...
("鴻", "コウ, ゴウ", "おおとり, ひしくい, おおがり", "large bird, wild goose, large, great, powerful, prosperous"),
("剛", "ゴウ", "", "sturdy, strength"),
("劫", "コウ, ゴウ, キョウ", "おびや.かす", "threat, long ages"),
("号", "ゴウ", "さけ.ぶ, よびな", "nickname, number, item, title, pseudonym, name, call"),
("合", "ゴウ, ガッ, カッ", "あ.う, -あ.う, あ.い, あい-, -あ.い, -あい, あ.わす, あ.わせる, -あ.わせる", "fit, suit, join, 0.1"),
("壕", "コウ, ゴウ", "ほり", "trench, dugout, air raid shelter"),
("拷", "ゴウ", "", "torture, beat"),
("濠", "ゴウ, コウ", "ほり", "moat, ditch, canal, Australia"),
("豪", "ゴウ", "えら.い", "overpowering, great, powerful, excelling, Australia"),
("轟", "ゴウ, コウ", "とどろ.かす, とどろ.く", "roar, thunder, boom resound"),
("麹", "キク", "こうじ", "malt, yeast"),
("克", "コク", "か.つ", "overcome, kindly, skillfully"),
("刻", "コク", "きざ.む, きざ.み", "engrave, cut fine, chop, hash, mince, time, carving"),
("告", "コク", "つ.げる", "revelation, tell, inform, announce"),
("国", "コク", "くに", "country"),
("穀", "コク", "", "cereals, grain"),
...
("獄", "ゴク", "", "prison, jail"),
("漉", "ロク", "こ.し, こ.す, す.く", "manufacture paper, spread out thin, strain, percolate"),
("腰", "ヨウ", "こし", "loins, hips, waist, low wainscoting"),
("甑", "ソウ, ショウ", "こしき", "rice-steaming pot"),
("忽", "コツ", "たちま.ち, ゆるが.せ", "in a moment, instantly, all of a sudden, neglect, disregard"),
("惚", "コツ", "ほけ.る, ぼ.ける, ほ.れる", "fall in love with, admire, grow senile"),
("骨", "コツ", "ほね", "skeleton, bone, remains, frame"),
("狛", "ハク", "こま", "archaic part of Korea, lion-dog shrine guards"),
("込", "", "-こ.む, こ.む, こ.み, -こ.み, こ.める", "crowded, mixture, in bulk, included, (kokuji)"),
("此", "シ", "これ, この, ここ", "this, current, next, coming, last, past"),
("頃", "ケイ, キョウ", "ころ, ごろ, しばら.く", "time, about, toward"),
("今", "コン, キン", "いま", "now"),
("困", "コン", "こま.る", "quandary, become distressed, annoyed"),
("坤", "コン", "つち, ひつじさる", "divination sign, land, earth"),
("墾", "コン", "は.る, ひら.く", "ground-breaking, open up farmland"),
("婚", "コン", "", "marriage"),
("恨", "コン", "うら.む, うら.めしい", "regret, bear a grudge, resentment, malice, hatred"),
("懇", "コン", "ねんご.ろ", "sociable, kind, courteous, hospitable, cordial"),
("昏", "コン", "くら.い, くれ", "dark, evening, dusk"),
("昆", "コン", "", "descendants, elder brother, insect"),
("根", "コン", "ね, -ね", "root, radical, head (pimple)"),
("梱", "コン", "こう.る, こうり, こり, しきみ", "pack, tie up, bale"),
("混", "コン", "ま.じる, -ま.じり, ま.ざる, ま.ぜる, こ.む", "mix, blend, confuse"),
("痕", "コン", "あと", "mark, foot print"),
("紺", "コン", "", "dark blue, navy"),
("艮", "コン, ゴン", "うしとら", "northeast (Oriental zodiac), stopping, good radical (no. 138)"),
("魂", "コン", "たましい, たま", "soul, spirit"),
("些", "サ, シャ", "ち.と, ち.っと, いささか", "a little bit, sometimes"),
("佐", "サ", "", "assistant, help"),
("叉", "サ, シャ, サイ", "また", "fork in road, crotch"),
("唆", "サ", "そそ.る, そそのか.す", "tempt, seduce, instigate, promote"),
("嵯", "サ, シ", "", "steep, craggy, rugged"),
("左", "サ, シャ", "ひだり", "left"),
("差", "サ", "さ.す, さ.し", "distinction, difference, variation, discrepancy, margin, balance"),
("査", "サ", "", "investigate"),
("沙", "サ, シャ", "すな, よなげる", "sand"),
("瑳", "サ", "みが.く", "polish, brilliant white luster of a gem, artful smile"),
("砂", "サ, シャ", "すな", "sand"),
("詐", "サ", "いつわ.る", "lie, falsehood, deceive, pretend"),
("鎖", "サ", "くさり, とざ.す", "chain, irons, connection"),
("裟", "サ, シャ", "", "Buddhist surplice"),
("坐", "ザ, サ", "すわ.る, おわす, そぞろに, まします", "sit"),
("座", "ザ", "すわ.る", "squat, seat, cushion, gathering, sit"),
("挫", "ザ, サ", "くじ.く, くじ.ける", "crush, break, sprain, discourage"),
("債", "サイ", "", "bond, loan, debt"),
...
("哉", "サイ", "かな, や", "how, what, alas, question mark, exclamation mark"),
("塞", "ソク, サイ", "ふさ.ぐ, とりで, み.ちる", "close, shut, cover, block, obstruct"),
("妻", "サイ", "つま", "wife, spouse"),
("宰", "サイ", "", "superintend, manager, rule"),
("彩", "サイ", "いろど.る", "coloring, paint, makeup"),
("才", "サイ", "", "genius, years old, cubic shaku"),
("採", "サイ", "と.る", "pick, take, fetch, take up"),
("栽", "サイ", "", "plantation, planting"),
("歳", "サイ, セイ", "とし, とせ, よわい", "year-end, age, occasion, opportunity"),
("済", "サイ, セイ", "す.む, -ず.み, -ずみ, す.まない, す.ます, -す.ます, すく.う, な.す, わたし, わた.る", "settle (debt, etc.), relieve (burden), finish, come to an end, excusable, need not"),
("災", "サイ", "わざわ.い", "disaster, calamity, woe, curse, evil"),
("采", "サイ", "と.る, いろどり", "dice, form, appearance, take, gather, coloring"),
("犀", "サイ, セイ", "", "rhinocerous"),
("砕", "サイ", "くだ.く, くだ.ける", "smash, break, crush, familiar, popular"),
("砦", "サイ", "とりで", "fort, stronghold, entrenchments"),
("祭", "サイ", "まつ.る, まつ.り, まつり", "ritual, offer prayers, celebrate, deify, enshrine, worship"),
("斎", "サイ", "とき, つつし.む, ものいみ, い.む, いわ.う, いつ.く", "purification, Buddhist food, room, worship, avoid, alike"),
("細", "サイ", "ほそ.い, ほそ.る, こま.か, こま.かい", "dainty, get thin, taper, slender, narrow, detailed, precise"),
("菜", "サイ", "な", "vegetable, side dish, greens"),
("裁", "サイ", "た.つ, さば.く", "tailor, judge, decision, cut out (pattern)"),
("載", "サイ", "の.せる, の.る", "ride, board, get on, place, spread, 10**44, record, publish"),
("際", "サイ", "きわ, -ぎわ", "occasion, side, edge, verge, dangerous, adventurous, indecent, time, when"),
("剤", "ザイ, スイ, セイ", "かる, けず.る", "dose, medicine, drug"),
("在", "ザイ", "あ.る", "exist, outskirts, suburbs, located in"),
("材", "ザイ", "", "lumber, log, timber, wood, materials, ingredients, talent"),
("罪", "ザイ", "つみ", "guilt, sin, crime, fault, blame, offense"),
("財", "ザイ, サイ, ゾク", "たから", "property, money, wealth, assets"),
("冴", "ゴ, コ", "さ.える, こお.る, ひ.える", "be clear, serene, cold, skilful"),
("坂", "ハン", "さか", "slope, incline, hill"),
("阪", "ハン", "さか", "heights, slope"),
("堺", "カイ", "さかい", "world"),
("榊", "", "さかき", "sacred Shinto tree, (kokuji)"),
("肴", "コウ", "さかな", "accompaniment for drinks"),
("咲", "ショウ", "さ.く, -ざき", "blossom, bloom"),
("崎", "キ", "さき, さい, みさき", "promontory, cape, spit"),
("埼", "キ", "さき, さい, みさき", "cape, spit, promontory"),
("碕", "キ", "さき, さい, みさき", "cape, spit, promontory"),
("鷺", "ロ", "さぎ", "heron"),
("作", "サク, サ", "つく.る, つく.り, -づく.り", "make, production, prepare, build"),
("削", "サク", "けず.る, はつ.る, そ.ぐ", "plane, sharpen, whittle, pare, shave"),
("咋", "サク, サ", "か.む, く.う, くら.う", "shout, chew, eat"),
("搾", "サク", "しぼ.る", "squeeze"),
("昨", "サク", "", "yesterday, previous"),
("朔", "サク", "ついたち", "conjunction (astronomy), first day of month, north"),
("柵", "サク, サン", "しがら.む, しがらみ, とりで, やらい", "stockade, fence, weir, entwine around"),
("窄", "サク", "すぼ.める, つぼ.める, せま.い", "narrow, fold, furl, shrug, pucker, shut, close"),
("策", "サク", "", "scheme, plan, policy, step, means"),
("索", "サク", "", "cord, rope, searching, inquiring"),
("錯", "サク, シャク", "", "confused, mix, be in disorder"),
("桜", "オウ, ヨウ", "さくら", "cherry"),
("鮭", "カイ, ケイ", "さけ, しゃけ, ふぐ", "salmon"),
("笹", "", "ささ", "bamboo grass, (kokuji)"),
("匙", "シ", "さじ", "spoon"),
("冊", "サツ, サク", "ふみ", "tome, counter for books, volume"),
("刷", "サツ", "す.る, -ず.り, -ずり, は.く", "printing, print, brush"),
("察", "サツ", "", "guess, presume, surmise, judge, understand"),
("拶", "サツ", "せま.る", "be imminent, draw close"),
...
("殺", "サツ, サイ, セツ", "ころ.す, -ごろ.し, そ.ぐ", "kill, murder, butcher, slice off, split, diminish, reduce, spoil"),
("薩", "サツ, サチ", "", "salvation, Buddha"),
("雑", "ザツ, ゾウ", "まじ.える, まじ.る", "miscellaneous"),
("皐", "コウ", "さつき", "swamp, shore"),
("鯖", "セイ, ショウ", "さば", "mackerel"),
("捌", "ハツ, ハチ, ベツ", "さば.く, さば.ける, は.け", "handle, deal with, dispose of, sell, be in demand, be worldly, be frank, be sensible, be sociable, drainage, sale, demand for, eight"),
("錆", "ショウ, セイ", "さび, くわ.しい", "rust, tarnish"),
("鮫", "コウ", "さめ, みずち", "shark"),
("皿", "ベイ", "さら", "dish, a helping, plate"),
("晒", "サイ, シ", "さら.す, さらし", "bleach, refine, expose, air"),
("三", "サン, ゾウ", "み, み.つ, みっ.つ", "three"),
("傘", "サン", "かさ", "umbrella"),
("参", "サン, シン", "まい.る, まい-, まじわる, みつ", "nonplussed, three (in documents), going, coming, visiting, visit, be defeated, die, be madly in love, participate, take part in"),
("山", "サン, セン", "やま", "mountain"),
("惨", "サン, ザン", "みじ.め, いた.む, むご.い", "wretched, disaster, cruelty, harsh"),
("撒", "サン, サツ", "ま.く", "scatter, sprinkle, give them the slip"),
("散", "サン", "ち.る, ち.らす, -ち.らす, ち.らかす, ち.らかる, ち.らばる, ばら, ばら.ける", "scatter, disperse, spend, squander"),
("桟", "サン, セン", "かけはし", "scaffold, cleat, frame, jetty, bolt (door)"),
("燦", "サン", "さん.たる, あき.らか, きらめ.く, きら.めく", "brilliant"),
("珊", "サン", "センチ, さんち", "coral, centimeter"),
("産", "サン", "う.む, う.まれる, うぶ-, む.す", "products, bear, give birth, yield, childbirth, native, property"),
("算", "サン", "そろ", "calculate, divining, number, abacus, probability"),
("纂", "サン", "あつ.める", "editing, compiling"),
("蚕", "サン, テン", "かいこ, こ", "silkworm"),
("讃", "サン", "ほ.める, たた.える", "praise, title on a picture"),
("賛", "サン", "たす.ける, たた.える", "approve, praise, title or inscription on picture, assist, agree with"),
("酸", "サン", "す.い", "acid, bitterness, sour, tart"),
("餐", "サン, ソン", "の.む, くら.う", "eat, drink, swallow"),
("斬", "ザン, サン, セン, ゼン", "き.る", "beheading, kill, murder"),
...
("仔", "シ", "こ, た.える", "offspring (animal), detailed, fine"),
("伺", "シ", "うかが.う", "pay respects, visit, ask, inquire, question, implore"),
("使", "シ", "つか.う, つか.い, -つか.い, -づか.い", "use, send on a mission, order, messenger, envoy, ambassador, cause"),
("刺", "シ", "さ.す, さ.さる, さ.し, さし, とげ", "thorn, pierce, stab, prick, sting, calling card"),
("司", "シ", "つかさど.る", "director, official, govt office, rule, administer"),
("史", "シ", "", "history, chronicle"),
("嗣", "シ", "", "heir, succeed"),
("四", "シ", "よ, よ.つ, よっ.つ, よん", "four"),
("士", "シ", "さむらい", "gentleman, scholar, samurai, samurai radical (no. 33)"),
("始", "シ", "はじ.める, -はじ.める, はじ.まる", "commence, begin"),
("姉", "シ", "あね, はは", "elder sister"),
("姿", "シ", "すがた", "figure, form, shape"),
("子", "シ, ス, ツ", "こ, -こ, ね", "child, sign of the rat, 11PM-1AM, first sign of Chinese zodiac"),
("屍", "シ", "しかばね", "corpse"),
("市", "シ", "いち", "market, city, town"),
("師", "シ", "いくさ", "expert, teacher, master, model, exemplar, army (incl. counter), war"),
("志", "シ", "シリング, こころざ.す, こころざし", "intention, plan, resolve, aspire, motive, hopes, shilling"),
("思", "シ", "おも.う, おもえら.く, おぼ.す", "think"),
("指", "シ", "ゆび, さ.す, -さ.し", "finger, point to, indicate, put into, play (chess), measure (ruler)"),
("支", "シ", "ささ.える, つか.える, か.う", "branch, support, sustain, branch radical (no. 65)"),
("孜", "シ", "つと.める", "industriousness"),
("斯", "シ", "か, こう, か.く, この, これ, ここに", "this, thus, such, verbal pause"),
("施", "シ, セ", "ほどこ.す", "give, bestow, perform, alms"),
...
("糸", "シ", "いと", "thread"),
("紙", "シ", "かみ", "paper"),
("紫", "シ", "むらさき", "purple, violet"),
("肢", "シ", "", "limb, arms & legs"),
("脂", "シ", "あぶら", "fat, grease, tallow, lard, rosin, gum, tar"),
("至", "シ", "いた.る", "climax, arrive, proceed, reach, attain, result in"),
("視", "シ", "み.る", "inspection, regard as, see, look at"),
...
("資", "シ", "", "assets, resources, capital, funds, data, be conducive to, contribute to"),
("賜", "シ", "たまわ.る, たま.う, たも.う", "grant, gift, boon, results"),
("雌", "シ", "め-, めす, めん", "feminine, female"),
("飼", "シ", "か.う", "domesticate, raise, keep, feed"),
("歯", "シ", "よわい, は, よわ.い, よわい.する", "tooth, cog"),
("事", "ジ, ズ", "こと, つか.う, つか.える", "matter, thing, fact, business, reason, possibly"),
("似", "ジ", "に.る, ひ.る", "becoming, resemble, counterfeit, imitate, suitable"),
("侍", "ジ, シ", "さむらい, はべ.る", "waiter, samurai, wait upon, serve"),
("児", "ジ, ニ, ゲイ", "こ, -こ, -っこ", "newborn babe, child, young of animals"),
("字", "ジ", "あざ, あざな, -な", "character, letter, word, section of village"),
("寺", "ジ", "てら", "Buddhist temple"),
("慈", "ジ", "いつく.しむ", "mercy"),
("持", "ジ", "も.つ, -も.ち, も.てる", "hold, have"),
("時", "ジ", "とき, -どき", "time, hour"),
("次", "ジ, シ", "つ.ぐ, つぎ", "next, order, sequence"),
("滋", "ジ, シ", "", "nourishing, more & more, be luxuriant, planting, turbidity"),
("治", "ジ, チ", "おさ.める, おさ.まる, なお.る, なお.す", "reign, be at peace, calm down, subdue, quell, govt, cure, heal, rule, conserve"),
("爾", "ジ, ニ", "なんじ, しかり, その, のみ, おれ, しか", "you, thou, second person"),
("璽", "ジ", "", "emperor's seal"),
("痔", "ヂ, ジ", "しもがさ", "piles, hemorrhoids"),
("磁", "ジ", "", "magnet, porcelain"),
("示", "ジ, シ", "しめ.す", "show, indicate, point out, express, display"),
("而", "ジ, ニ", "しこ.うして, しか.して, しか.も, しか.れども, すなわち, なんじ, しかるに", "and yet, and then, but, however, nevertheless"),
("耳", "ジ", "みみ", "ear"),
("自", "ジ, シ", "みずか.ら, おの.ずから, おの.ずと", "oneself"),
("蒔", "シ, ジ", "う.える, ま.く", "sow (seeds)"),
("辞", "ジ", "や.める, いな.む", "resign, word, term, expression"),
("汐", "セキ", "しお, うしお, せい", "eventide, tide, salt water, opportunity"),
("鹿", "ロク", "しか, か", "deer"),
("式", "シキ", "", "style, ceremony, rite, function, method, system, form, expression"),
("識", "シキ", "し.る, しる.す", "discriminating, know, write"),
("鴫", "", "しぎ", "snipe, (kokuji)"),
("竺", "ジク, チク, トク", "", "bamboo"),
("軸", "ジク", "", "axis, pivot, stem, stalk, counter for book scrolls"),
("宍", "ニク, ジク", "しし", "muscles, meat"),
("雫", "ダ", "しずく", "drop, trickle, dripping, (kokuji)"),
("七", "シチ", "なな, なな.つ, なの", "seven"),
("叱", "シツ, シチ, カ", "しか.る", "scold, reprove"),
("執", "シツ, シュウ", "と.る", "tenacious, take hold, grasp, take to heart"),
("失", "シツ", "うしな.う, う.せる", "lose, error, fault, disadvantage, loss"),
("嫉", "シツ", "そね.む, ねた.む, にく.む", "jealous, envy"),
("室", "シツ", "むろ", "room, apartment, chamber, greenhouse, cellar"),
("悉", "シツ, シチ", "つ.きる, ことごと, ことごと.く, つ.くす, つぶさ.に", "all, entirely, altogether, completely, use up, run out of, exhaust, befriend, serve"),
("湿", "シツ, シュウ", "しめ.る, しめ.す, うるお.う, うるお.す", "damp, wet, moist"),
("漆", "シツ", "うるし", "lacquer, varnish, seven"),
("疾", "シツ", "はや.い", "rapidly"),
("質", "シツ, シチ, チ", "たち, ただ.す, もと, わりふ", "substance, quality, matter, temperament"),
("実", "ジツ, シツ", "み, みの.る, まこと, みの, みち.る", "reality, truth, seed, fruit, nut"),
("蔀", "ホウ, ダ, ダン, ブ", "しとみ", "latticed shutters"),
("篠", "ゾウ, ショウ", "しの, ささ, すず", "bamboo grass"),
("偲", "サイ, シ", "しの.ぶ", "recollect, remember"),
("柴", "サイ, シ", "しば", "brush, firewood"),
("芝", "シ", "しば", "turf, lawn"),
("屡", "ル", "しばしば", "often, frequently"),
("蕊", "ズイ", "しべ", "pistil, stamen"),
("縞", "コウ", "しま, しろぎぬ", "stripe"),
("舎", "シャ, セキ", "やど.る", "cottage, inn, hut, house, mansion"),
("写", "シャ, ジャ", "うつ.す, うつ.る, うつ-, うつ.し", "copy, be photographed, describe"),
("射", "シャ", "い.る, さ.す, う.つ", "shoot, shine into, onto, archery"),
...
("紗", "サ, シャ", "うすぎぬ", "gauze, gossamer"),
("者", "シャ", "もの", "someone, person"),
("謝", "シャ", "あやま.る", "apologize, thank, refuse"),
("車", "シャ", "くるま", "car"),
("遮", "シャ", "さえぎ.る", "intercept, interrupt, obstruct"),
("蛇", "ジャ, ダ, イ, ヤ", "へび", "snake, serpent, hard drinker"),
("邪", "ジャ", "よこし.ま", "wicked, injustice, wrong"),
("借", "シャク", "か.りる", "borrow, rent"),
("勺", "シャク", "", "ladle, one tenth of a go, dip"),
("尺", "シャク, セキ", "さし", "shaku, Japanese foot, measure, scale, rule"),
("杓", "シャク, チョウ, テキ, ヒョウ", "ひしゃく", "ladle, scoop"),
("灼", "シャク", "あらた, やく", "miraculous"),
("爵", "シャク", "", "baron, peerage, court rank"),
("酌", "シャク", "く.む", "bar-tending, serving sake, the host, draw (water), ladle, scoop, pump"),
("釈", "シャク, セキ", "とく, す.てる, ゆる.す", "explanation"),
("錫", "セキ, シャク", "すず, たま.う", "copper, tin"),
("若", "ジャク, ニャク, ニャ", "わか.い, わか-, も.しくわ, も.し, も.しくは, ごと.し", "young, if, perhaps, possibly, low number, immature"),
("寂", "ジャク, セキ", "さび, さび.しい, さび.れる, さみ.しい", "loneliness, quietly, mellow, mature, death of a priest"),
("弱", "ジャク", "よわ.い, よわ.る, よわ.まる, よわ.める", "weak, frail"),
("惹", "ジャク, ジャ", "ひ.く", "attract, captivate"),
("主", "シュ, ス, シュウ", "ぬし, おも, あるじ", "lord, chief, master, main thing, principal"),
("取", "シュ", "と.る, と.り, と.り-, とり, -ど.り", "take, fetch, take up"),
("守", "シュ, ス", "まも.る, まも.り, もり, -もり, かみ", "guard, protect, defend, obey"),
("手", "シュ, ズ", "て, て-, -て, た-", "hand"),
("朱", "シュ", "あけ", "vermilion, cinnabar, scarlet, red, bloody"),
("殊", "シュ", "こと", "particularly, especially, exceptionally"),
("狩", "シュ", "か.る, か.り, -が.り", "hunt, raid, gather"),
("珠", "シュ", "たま", "pearl, gem, jewel"),
("種", "シュ", "たね, -ぐさ", "species, kind, class, variety, seed"),
("腫", "シュ, ショウ", "は.れる, は.れ, は.らす, はれもの", "tumor, swelling"),
("趣", "シュ", "おもむき, おもむ.く", "purport, gist, elegance, interest, proceed to, tend, become"),
("酒", "シュ", "さけ, さか-", "sake, alcohol"),
("首", "シュ", "くび", "neck, counter for songs and poems"),
("儒", "ジュ", "", "Confucian"),
("受", "ジュ", "う.ける, -う.け, う.かる", "accept, undergo, answer (phone), take, get, catch, receive"),
("呪", "ジュ, シュ, シュウ, ズ", "まじな.う, のろ.い, まじな.い, のろ.う", "spell, curse, charm, malediction"),
("寿", "ジュ, ス, シュウ", "ことぶき, ことぶ.く, ことほ.ぐ", "longevity, congratulations, one's natural life"),
("授", "ジュ", "さず.ける, さず.かる", "impart, instruct, grant, confer"),
("樹", "ジュ", "き", "timber, trees, wood, establish, set up"),
("綬", "ジュ", "ひも", "ribbon"),
("需", "ジュ", "", "demand, request, need"),
("囚", "シュウ", "とら.われる", "captured, criminal, arrest, catch"),
("収", "シュウ", "おさ.める, おさ.まる", "income, obtain, reap, pay, supply, store"),
("周", "シュウ", "まわ.り", "circumference, circuit, lap"),
("宗", "シュウ, ソウ", "むね", "religion, sect, denomination, main point, origin, essence"),
("就", "シュウ, ジュ", "つ.く, つ.ける", "concerning, settle, take position, depart, study, per"),
("州", "シュウ, ス", "す", "state, province"),
("修", "シュウ, シュ", "おさ.める, おさ.まる", "discipline, conduct oneself well, study, master"),
...
("秀", "シュウ", "ひい.でる", "excel, excellence, beauty, surpass"),
("秋", "シュウ", "あき, とき", "autumn"),
("終", "シュウ", "お.わる, -お.わる, おわ.る, お.える, つい, つい.に", "end, finish"),
("繍", "シュウ", "ぬいとり", "sew, figured cloth"),
("習", "シュウ, ジュ", "なら.う, なら.い", "learn"),
("臭", "シュウ", "くさ.い, -くさ.い, にお.う, にお.い", "stinking, ill-smelling, suspicious looking, odor, savor, fragrance, be fragrant, stink, glow, be bright"),
("舟", "シュウ", "ふね, ふな-, -ぶね", "boat, ship"),
("蒐", "シュウ", "あかね, あつ.まる, あつ.める", "gather"),
("衆", "シュウ, シュ", "おお.い", "masses, great numbers, multitude, populace"),
("襲", "シュウ", "おそ.う, かさ.ね", "attack, advance on, succeed to, pile, heap"),
("讐", "シュウ", "あだ, むく.いる, あ.たる", "enemy, revenge"),
("蹴", "シュク, シュウ", "け.る", "kick"),
("輯", "シュウ", "あつ.める, やわ.らぐ", "gather, collect, compile"),
("週", "シュウ", "", "week"),
("酋", "シュウ, ジュ", "おさ, ふるざけ, さけのつかさ", "chieftain"),
("酬", "シュウ, シュ, トウ", "むく.いる", "repay, reward, retribution"),
("集", "シュウ", "あつ.まる, あつ.める, つど.う", "gather, meet, congregate, swarm, flock"),
("醜", "シュウ", "みにく.い, しこ", "ugly, unclean, shame, bad looking"),
("什", "ジュウ, シュウ", "", "utensil, thing, ten"),
("住", "ジュウ, ヂュウ, チュウ", "す.む, す.まう, -ず.まい", "dwell, reside, live, inhabit"),
("充", "ジュウ", "あ.てる, み.たす", "allot, fill"),
("十", "ジュウ, ジッ, ジュッ", "とお, と, そ", "ten"),
...
("汁", "ジュウ", "しる, -しる, つゆ", "soup, juice, broth, sap, gravy, pus"),
("渋", "ジュウ, シュウ", "しぶ, しぶ.い, しぶ.る", "astringent, hesitate, reluctant, have diarrhea"),
("獣", "ジュウ", "けもの, けだもの", "animal, beast"),
("縦", "ジュウ", "たて", "vertical, length, height, self-indulgent, wayward"),
("重", "ジュウ, チョウ", "え, おも.い, おも.り, おも.なう, かさ.ねる, かさ.なる, おも", "heavy, important, esteem, respect, heap up, pile up, nest of boxes, -fold"),
("銃", "ジュウ", "つつ", "gun, arms"),
("叔", "シュク", "", "uncle, youth"),
("夙", "シュク", "つとに, はやい", "bright and early, long ago, early in life"),
("宿", "シュク", "やど, やど.る, やど.す", "inn, lodging, relay station, dwell, lodge, be pregnant, home, dwelling"),
("淑", "シュク", "しと.やか", "graceful, gentle, pure"),
("祝", "シュク, シュウ", "いわ.う", "celebrate, congratulate"),
("縮", "シュク", "ちぢ.む, ちぢ.まる, ちぢ.める, ちぢ.れる, ちぢ.らす", "shrink, contract, shrivel, wrinkle, reduce"),
("粛", "シュク, スク", "つつし.む", "solemn, quietly, softly"),
("塾", "ジュク", "", "cram school, private school"),
("熟", "ジュク", "う.れる", "mellow, ripen, mature, acquire skill"),
("出", "シュツ, スイ", "で.る, -で, だ.す, -だ.す, い.でる, い.だす", "exit, leave, go out, come out, put out, protrude"),
("術", "ジュツ", "すべ", "art, technique, skill, means, trick, resources, magic"),
("述", "ジュツ", "の.べる", "mention, state, speak, relate"),
("俊", "シュン", "", "sagacious, genius, excellence"),
("峻", "シュン", "けわ.しい, たか.い", "high, steep"),
("春", "シュン", "はる", "springtime, spring (season)"),
("瞬", "シュン", "またた.く, まじろ.ぐ", "wink, blink, twinkle"),
("竣", "ドウ, シュン", "わらわ, わらべ, おわ.る", "end, finish"),
("舜", "シュン", "", "type of morning glory, rose of Sharon, althea"),
("駿", "シュン, スン", "すぐ.れる", "a good horse, speed, a fast person"),
("准", "ジュン", "", "quasi-, semi-, associate"),
("循", "ジュン", "", "sequential, follow"),
("旬", "ジュン, シュン", "", "decameron, ten-day period, season (for specific products)"),
("楯", "ジュン", "たて", "shield, buckler, pretext"),
...
("潤", "ジュン", "うるお.う, うるお.す, うる.む", "wet, be watered, profit by, receive benefits, favor, charm, steep"),
...
("醇", "ジュン, シュン", "もっぱら, こい, あつい", "pure sake, purity, affection"),
("順", "ジュン", "", "obey, order, turn, right, docility, occasion"),
("処", "ショ", "ところ, -こ, お.る", "dispose, manage, deal with, sentence, condemn, act, behave, place"),
("初", "ショ", "はじ.め, はじ.めて, はつ, はつ-, うい-, -そ.める, -ぞ.め", "first time, beginning"),
("所", "ショ", "ところ, -ところ, どころ, とこ", "place, extent"),
("暑", "ショ", "あつ.い", "sultry, hot, summer heat"),
("曙", "ショ", "あけぼの", "dawn, daybreak"),
("渚", "ショ", "なぎさ", "strand, beach, shore"),
("庶", "ショ", "", "commoner, all, bastard"),
("緒", "ショ, チョ", "お, いとぐち", "thong, beginning, inception, end, cord, strap, mental or emotional state"),
...
("序", "ジョ", "つい.で, ついで", "preface, beginning, order, precedence, occasion, chance, incidentally"),
("徐", "ジョ", "おもむ.ろに", "gradually, slowly, deliberately, gently"),
("恕", "ジョ, ショ", "ゆる.す", "excuse, tolerate, forgive"),
("鋤", "ジョ, ショ, ソ", "す.く, すき, くわ", "spade up, plow"),
("除", "ジョ, ジ", "のぞ.く, -よ.け", "exclude, division (x/3), remove, abolish, cancel, except"),
...
("勝", "ショウ", "か.つ, -が.ち, まさ.る, すぐ.れる, かつ", "victory, win, prevail, excel"),
("匠", "ショウ", "たくみ", "artisan, workman, carpenter"),
("升", "ショウ", "ます", "measuring box, 1.8 liter"),
("召", "ショウ", "め.す", "seduce, call, send for, wear, put on, ride in, buy, eat, drink, catch (cold)"),
("哨", "ショウ", "みはり", "scout, sentinel"),
("商", "ショウ", "あきな.う", "make a deal, selling, dealing in, merchant"),
("唱", "ショウ", "とな.える", "chant, recite, call upon, yell"),
("嘗", "ショウ, ジョウ", "かつ.て, こころ.みる, な.める", "once, before, formerly, ever, never, ex-, lick, lap up, burn up, taste, undergo, underrate, despise"),
("奨", "ショウ, ソウ", "すす.める", "exhort, urge, encourage"),
("妾", "ショウ", "めかけ, そばめ, わらわ", "concubine"),
("娼", "ショウ", "あそびめ", "prostitute"),
("宵", "ショウ", "よい", "wee hours, evening, early night"),
("将", "ショウ, ソウ", "まさ.に, はた, まさ, ひきい.る, もって", "leader, commander, general, admiral, or, and again, soon, from now on, just about"),
("小", "ショウ", "ちい.さい, こ-, お-, さ-", "little, small"),
("少", "ショウ", "すく.ない, すこ.し", "few, little"),
("尚", "ショウ", "なお", "esteem, furthermore, still, yet"),
("庄", "ショウ, ソ, ソウ, ホウ", "", "level, in the country, manor, village, hamlet"),
("床", "ショウ", "とこ, ゆか", "bed, counter for beds, floor, padding, tatami"),
("廠", "ショウ", "", "workshop"),
("彰", "ショウ", "", "patent, clear"),
("承", "ショウ, ジョウ", "うけたまわ.る, う.ける", "acquiesce, hear, listen to, be informed, receive"),
("抄", "ショウ", "", "extract, selection, summary, copy, spread thin"),
("招", "ショウ", "まね.く", "beckon, invite, summon, engage"),
("掌", "ショウ", "てのひら, たなごころ", "manipulate, rule, administer, conduct, palm of hand"),
("捷", "ショウ, ソウ", "はや.い", "victory, fast"),
("昇", "ショウ", "のぼ.る", "rise up"),
("昌", "ショウ", "さかん", "prosperous, bright, clear"),
("昭", "ショウ", "", "shining, bright"),
("晶", "ショウ", "", "sparkle, clear, crystal"),
("松", "ショウ", "まつ", "pine tree"),
("梢", "ショウ", "こずえ, くすのき", "treetops, twig"),
("樟", "ショウ", "くす", "camphor"),
("樵", "ショウ", "きこ.る, こ.る, きこり", "woodcutting, lumberjack"),
("沼", "ショウ", "ぬま", "marsh, lake, bog, swamp, pond"),
("消", "ショウ", "き.える, け.す", "extinguish, blow out, turn off, neutralize, cancel"),
("渉", "ショウ", "わた.る", "ford, go cross, transit, ferry, import, involve"),
("湘", "ショウ", "", "name of Chinese river, the Sagami river"),
("焼", "ショウ", "や.く, や.き, や.き-, -や.き, や.ける", "bake, burning"),
("焦", "ショウ", "こ.げる, こ.がす, こ.がれる, あせ.る, じ.れる, じ.らす", "char, hurry, impatient, irritate, burn, scorch, singe"),
("照", "ショウ", "て.る, て.らす, て.れる", "illuminate, shine, compare, bashful"),
("症", "ショウ", "", "symptoms, illness"),
("省", "セイ, ショウ", "かえり.みる, はぶ.く", "focus, government ministry, conserve"),
("硝", "ショウ", "", "nitrate, saltpeter"),
("礁", "ショウ", "", "reef, sunken rock"),
("祥", "ショウ", "さいわ.い, きざ.し, よ.い, つまび.らか", "auspicious, happiness, blessedness, good omen, good fortune"),
("称", "ショウ", "たた.える, とな.える, あ.げる, かな.う, はか.り, はか.る, ほめ.る", "appellation, praise, admire, name, title, fame"),
("章", "ショウ", "", "badge, chapter, composition, poem, design"),
("笑", "ショウ", "わら.う, え.む", "laugh"),
("粧", "ショウ", "", "cosmetics, adorn (one's person)"),
("紹", "ショウ", "", "introduce, inherit, help"),
("肖", "ショウ", "あやか.る", "resemblance"),
("菖", "ショウ", "", "iris"),
("蒋", "ショウ, ソウ", "まこも, はげ.ます", "reed"),
("蕉", "ショウ", "", "banana, plantain"),
...
("詳", "ショウ", "くわ.しい, つまび.らか", "detailed, full, minute, accurate, well-informed"),
("象", "ショウ, ゾウ", "かたど.る", "elephant, pattern after, imitate, image, shape, sign (of the times)"),
("賞", "ショウ", "ほ.める", "prize, reward, praise"),
("醤", "ショウ", "ひしお", "a kind of miso"),
("鉦", "セイ, ショウ", "かね", "bell, gong, chimes"),
("鍾", "ショウ, シュ", "あつ.める, さかずき, かね", "spindle, gather, collect"),
("鐘", "ショウ", "かね", "bell, gong, chimes"),
("障", "ショウ", "さわ.る", "hinder, hurt, harm"),
("鞘", "ショウ, ソウ", "さや", "sheath, case, margin, difference, shells (of beans)"),
("上", "ジョウ, ショウ, シャン", "うえ, -うえ, うわ-, かみ, あ.げる, -あ.げる, あ.がる, -あ.がる, あ.がり, -あ.がり, のぼ.る, のぼ.り, のぼ.せる, のぼ.す, たてまつ.る", "above, up"),
("丈", "ジョウ", "たけ, だけ", "length, ten shaku, measure, Mr., Ms., height, stature, all (one has), only, that's all, merely"),
("丞", "ジョウ, ショウ", "すく.う, たす.ける", "help"),
("乗", "ジョウ, ショウ", "の.る, -の.り, の.せる", "ride, power, multiplication, record, counter for vehicles, board, mount, join"),
...
("常", "ジョウ", "つね, とこ-", "usual, ordinary, normal, common, regular, continually, always, long-lasting"),
("情", "ジョウ, セイ", "なさ.け", "feelings, emotion, passion, sympathy, circumstances, facts"),
("擾", "ジョウ", "みだ.れる, みだ.す, わずら.わしい", "disturb, throw into confusion"),
("条", "ジョウ, チョウ, デキ", "えだ, すじ", "article, clause, counter for articles, clauses, paragraphs, etc., twig, item, stripe, streak"),
("杖", "ジョウ", "つえ", "staff, cane"),
("浄", "ジョウ, セイ", "きよ.める, きよ.い", "clean, purify, cleanse, exorcise, Manchu Dynasty"),
("状", "ジョウ", "", "status quo, conditions, circumstances, form, appearance"),
("畳", "ジョウ, チョウ", "たた.む, たたみ, かさ.なる", "tatami mat, counter for tatami mats, fold, shut up, do away with"),
("穣", "ジョウ", "わら, ゆたか", "good crops, prosperity, 10**28"),
("蒸", "ジョウ, セイ", "む.す, む.れる, む.らす", "steam, heat, sultry, foment, get musty"),
("譲", "ジョウ", "ゆず.る", "defer, turnover, transfer, convey"),
("醸", "ジョウ", "かも.す", "brew, cause"),
("錠", "ジョウ", "", "lock, fetters, shackles"),
("嘱", "ショク", "しょく.する, たの.む", "entrust, request, send a message"),
("埴", "ショク", "はに, へな", "clay"),
("飾", "ショク", "かざ.る, かざ.り", "decorate, ornament, adorn, embellish"),
("拭", "ショク, シキ", "ぬぐ.う, ふ.く", "wipe, mop, swab"),
("植", "ショク", "う.える, う.わる", "plant"),
("殖", "ショク", "ふ.える, ふ.やす", "augment, increase, multiply, raise"),
("燭", "ソク, ショク", "ともしび", "light, candlepower"),
("織", "ショク, シキ", "お.る, お.り, おり, -おり, -お.り", "weave, fabric"),
("職", "ショク, ソク", "", "post, employment, work"),
("色", "ショク, シキ", "いろ", "color"),
("触", "ショク", "ふ.れる, さわ.る, さわ", "contact, touch, feel, hit, proclaim, announce, conflict"),
("食", "ショク, ジキ", "く.う, く.らう, た.べる, は.む", "eat, food"),
("蝕", "ショク", "むしば.む", "eclipse, occultation, be defective"),
("辱", "ジョク", "はずかし.める", "embarrass, humiliate, shame"),
("尻", "コウ", "しり", "buttocks, hips, butt, rear"),
("伸", "シン", "の.びる, の.ばす, の.べる, の.す", "expand, stretch, extend, lengthen, increase"),
("信", "シン", "", "faith, truth, fidelity, trust"),
("侵", "シン", "おか.す", "encroach, invade, raid, trespass, violate"),
("唇", "シン", "くちびる", "lips"),
("娠", "シン", "", "with child, pregnancy"),
("寝", "シン", "ね.る, ね.かす, い.ぬ, みたまや, や.める", "lie down, sleep, rest, bed, remain unsold"),
("審", "シン", "つまび.らか, つぶさ.に", "hearing, judge, trial"),
("心", "シン", "こころ, -ごころ", "heart, mind, spirit, heart radical (no. 61)"),
("慎", "シン", "つつし.む, つつ.ましい, つつし, つつし.み", "humility, be careful, discreet, prudent"),
("振", "シン", "ふ.る, ふ.れる, ふ.るう", "shake, wave, wag, swing"),
("新", "シン", "あたら.しい, あら.た, あら-, にい-", "new"),
("晋", "シン", "すす.む", "advance"),
("森", "シン", "もり", "forest, woods"),
("榛", "シン, ハン", "はしばみ, はり", "hazelnut, filbert"),
("浸", "シン", "ひた.す, ひた.る, つ.かる", "immersed, soak, dip, steep, moisten, wet, dunk"),
("深", "シン", "ふか.い, -ぶか.い, ふか.まる, ふか.める, み-", "deep, heighten, intensify, strengthen"),
("申", "シン", "もう.す, もう.し-, さる", "have the honor to, sign of the monkey, 3-5PM, ninth sign of Chinese zodiac"),
("疹", "シン, チン", "はしか", "measles, sickness"),
("真", "シン", "ま, ま-, まこと", "true, reality, Buddhist sect"),
("神", "シン, ジン", "かみ, かん-, こう-", "gods, mind, soul"),
("秦", "シン", "はた", "Manchu dynasty, name given to naturalized foreigners"),
("紳", "シン", "", "sire, good belt, gentleman"),
...
("身", "シン", "み", "somebody, person, one's station in life"),
("辛", "シン", "から.い, つら.い, -づら.い, かのと", "spicy, bitter, hot, acrid"),
("進", "シン", "すす.む, すす.める", "advance, proceed, progress, promote"),
("針", "シン", "はり", "needle, pin, staple, stinger"),
("震", "シン", "ふる.う, ふる.える, ふる.わせる, ふる.わす", "quake, shake, tremble, quiver, shiver"),
("人", "ジン, ニン", "ひと, -り, -と", "person"),
("仁", "ジン, ニ, ニン", "", "humanity, virtue, benevolence, charity, man, kernel"),
("刃", "ジン, ニン", "は, やいば, き.る", "blade, sword, edge"),
("塵", "チン, ジン", "ちり, ごみ", "dust, trash, garbage"),
("壬", "ニン, ジン, イ", "みずのえ", "9th calendar sign"),
("尋", "ジン", "たず.ねる, ひろ", "inquire, fathom, look for"),
("甚", "ジン", "はなは.だ, はなは.だしい", "tremendously, very, great, exceedingly"),
("尽", "ジン, サン", "つ.きる, つ.くす, つ.かす, -づ.く, -ず.く, ことごと.く", "exhaust, use up, run out of, deplete, befriend, serve"),
("腎", "ジン", "", "kidney"),
("訊", "ジン, シュン, シン", "き.く, と.う, たず.ねる", "request, question, investigate"),
("迅", "ジン", "", "swift, fast"),
("陣", "ジン", "", "camp, battle array, ranks, position, sudden, brief time"),
("靭", "ジン, ニン, サ, サイ, サツ", "うつぼ, しな.やか, ゆぎ", "soft, pliable, quiver"),
("笥", "ス, シ", "け, はこ", "lunch box, clothes chest"),
("諏", "シュ, ス", "そう, はか.る", "consult"),
("須", "ス, シュ", "すべから.く, すべし, ひげ, まつ, もち.いる, もと.める", "ought, by all means, necessarily"),
("酢", "サク", "す", "vinegar, sour, acid, tart"),
("図", "ズ, ト", "え, はか.る", "map, drawing, plan, extraordinary, audacious"),
("厨", "シュウ, ズ, チュ, チュウ", "くりや", "kitchen"),
("逗", "トウ, ズ", "とど.まる", "stop"),
("吹", "スイ", "ふ.く", "blow, breathe, puff, emit, smoke"),
("垂", "スイ", "た.れる, た.らす, た.れ, -た.れ, なんなんと.す", "droop, suspend, hang, slouch"),
("帥", "スイ", "", "commander, leading troops, governor"),
("推", "スイ", "お.す", "conjecture, infer, guess, suppose, support, push (for)"),
("水", "スイ", "みず, みず-", "water"),
("炊", "スイ", "た.く, -だ.き", "cook, boil"),
("睡", "スイ", "ねむ.る, ねむ.い", "drowsy, sleep, die"),
("粋", "スイ", "いき", "chic, style, purity, essence, pith, cream, elite, choice"),
("翠", "スイ", "かわせみ, みどり", "green, kingfisher"),
("衰", "スイ", "おとろ.える", "decline, wane, weaken"),
("遂", "スイ", "と.げる, つい.に", "consummate, accomplish, attain, commit (suicide)"),
("酔", "スイ", "よ.う, よ.い, よ", "drunk, feel sick, poisoned, elated, spellbound"),
("錐", "スイ", "きり", "auger, drill, awl, pyramid, cone"),
("錘", "スイ", "つむ, おもり", "weight, plumb bob, sinker, spindle"),
("随", "ズイ", "まにま.に, したが.う", "follow, though, notwithstanding, while, during, both, all, obey, submit to, comply, at the mercy of (the waves)"),
("瑞", "ズイ, スイ", "みず-, しるし", "congratulations"),
("髄", "ズイ", "", "marrow, pith, essence"),
("崇", "スウ", "あが.める", "adore, respect, revere, worship"),
("嵩", "スウ, シュウ", "かさ, かさ.む, たか.い", "be aggravated, grow worse, grow bulky, swell"),
("数", "スウ, ス, サク, ソク, シュ", "かず, かぞ.える, しばしば, せ.める, わずらわ.しい", "number, strength, fate, law, figures"),
("枢", "スウ, シュ", "とぼそ, からくり", "hinge, pivot, door, center of things"),
("趨", "スウ, ソク", "しゅ, おもむ.く, はし.る", "run, go, quick, tend towards"),
("雛", "スウ, ス, ジュ", "ひな, ひよこ", "chick, squab, duckling, doll"),
("据", "キョ", "す.える, す.わる", "set, lay a foundation, install, equip, squat down, sit down"),
("杉", "サン", "すぎ", "cedar, cryptomeria"),
("椙", "", "すぎ", "Japanese cedar, cryptomeria, (kokuji)"),
("菅", "カン, ケン", "すげ", "sedge"),
("頗", "ハ", "すこぶ.る, かたよ.る", "prejudiced, exceedingly"),
("雀", "ジャク, ジャン, サク, シャク", "すずめ", "sparrow"),
("裾", "キョ, コ", "すそ", "cuff, hem, foot of mountain"),
("澄", "チョウ", "す.む, す.ます, -す.ます", "lucidity, be clear, clear, clarify, settle, strain, look grave"),
("摺", "ショウ, シュウ, ロウ", "す.る, ひだ", "rub, fold, print (on cloth)"),
("寸", "スン", "", "measurement, tenth of a shaku, a little, small"),
("世", "セイ, セ, ソウ", "よ", "generation, world, society, public"),
("瀬", "ライ", "せ", "rapids, current, torrent, shallows, shoal"),
("畝", "ボウ, ホ, モ, ム", "せ, うね", "furrow, thirty tsubo, ridge, rib"),
("是", "ゼ, シ", "これ, この, ここ", "just so, this, right, justice"),
("凄", "セイ, サイ", "さむ.い, すご.い, すさ.まじい", "uncanny, weird, threatening, horrible"),
("制", "セイ", "", "system, law, rule"),
("勢", "セイ, ゼイ", "いきお.い, はずみ", "forces, energy, military strength"),
("姓", "セイ, ショウ", "", "surname"),
("征", "セイ", "", "subjugate, attack the rebellious, collect taxes"),
("性", "セイ, ショウ", "さが", "sex, gender, nature"),
("成", "セイ, ジョウ", "な.る, な.す, -な.す", "turn into, become, get, grow, elapse, reach"),
("政", "セイ, ショウ", "まつりごと, まん", "politics, government"),
("整", "セイ", "ととの.える, ととの.う", "organize, arranging, tune, tone, meter, key (music)"),
("星", "セイ, ショウ", "ほし, -ぼし", "star, spot, dot, mark"),
("晴", "セイ", "は.れる, は.れ, は.れ-, -ば.れ, は.らす", "clear up"),
("棲", "セイ", "す.む", "live, dwell"),
("栖", "セイ", "す.む", "nest, rookery, hive, cobweb, den"),
("正", "セイ, ショウ", "ただ.しい, ただ.す, まさ, まさ.に", "correct, justice, righteous, 10**40"),
("清", "セイ, ショウ, シン", "きよ.い, きよ.まる, きよ.める", "pure, purify, cleanse, exorcise, Manchu dynasty"),
("牲", "セイ", "", "animal sacrifice, offering"),
("生", "セイ, ショウ", "い.きる, い.かす, い.ける, う.まれる, うま.れる, う.まれ, うまれ, う.む, お.う, は.える, は.やす, き, なま, なま-, な.る, な.す, む.す, -う", "life, genuine, birth"),
("盛", "セイ, ジョウ", "も.る, さか.る, さか.ん", "boom, prosper, copulate"),
("精", "セイ, ショウ", "しら.げる, くわ.しい", "refined, ghost, fairy, energy, vitality, semen, excellence, purity, skill"),
("聖", "セイ, ショウ", "ひじり", "holy, saint, sage, master, priest"),
("声", "セイ, ショウ", "こえ, こわ-", "voice"),
("製", "セイ", "", "made in..., manufacture"),
("西", "セイ, サイ, ス", "にし", "west, Spain"),
("誠", "セイ", "まこと", "sincerity, admonish, warn, prohibit, truth, fidelity"),
("誓", "セイ", "ちか.う", "vow, swear, pledge"),
("請", "セイ, シン, ショウ", "こ.う, う.ける", "solicit, invite, ask"),
("逝", "セイ", "ゆ.く, い.く", "departed, die"),
("醒", "セイ", "さ.ます, さ.める", "awake, be disillusioned, sober up"),
("青", "セイ, ショウ", "あお, あお-, あお.い", "blue, green"),
("静", "セイ, ジョウ", "しず-, しず.か, しず.まる, しず.める", "quiet"),
("斉", "セイ, サイ", "そろ.う, ひと.しい, ひと.しく, あたる, はやい", "adjusted, alike, equal, similar variety of"),
("税", "ゼイ", "", "tax, duty"),
("脆", "ゼイ, セイ, セツ", "もろ.い, よわい", "brittle, fragile, easy to beat, sentimental, susceptible"),
("隻", "セキ", "", "vessels, counter for ships, fish, birds, arrows, one of a pair"),
("席", "セキ", "むしろ", "seat, mat, occasion, place"),
("惜", "セキ", "お.しい, お.しむ", "pity, be sparing of, frugal, stingy, regret"),
("戚", "ソク, セキ", "いた.む, うれ.える, みうち", "grieve, relatives"),
...
("積", "セキ", "つ.む, -づ.み, つ.もる, つ.もり", "volume, product (x*y), acreage, contents, pile up, stack, load, amass"),
("籍", "セキ", "", "enroll, domiciliary register, membership"),
("績", "セキ", "", "exploits, achievements, unreeling cocoons"),
("脊", "セキ", "せ, せい", "stature, height"),
("責", "セキ", "せ.める", "blame, condemn, censure"),
("赤", "セキ, シャク", "あか, あか-, あか.い, あか.らむ, あか.らめる", "red"),
("跡", "セキ", "あと", "tracks, mark, print, impression"),
("蹟", "セキ, シャク", "あと", "remains, traces, footprint"),
("碩", "セキ", "おお.きい", "large, great, eminent"),
("切", "セツ, サイ", "き.る, -き.る, き.り, -き.り, -ぎ.り, き.れる, -き.れる, き.れ, -き.れ, -ぎ.れ", "cut, cutoff, be sharp"),
("拙", "セツ", "つたな.い", "bungling, clumsy, unskillful"),
("接", "セツ, ショウ", "つ.ぐ", "touch, contact, adjoin, piece together"),
("摂", "セツ, ショウ", "おさ.める, かね.る, と.る", "vicarious, surrogate, act in addition to, take in, absorb"),
("折", "セツ, シャク", "お.る, おり, お.り, -お.り, お.れる", "fold, break, fracture, bend, yield, submit"),
("設", "セツ", "もう.ける", "establishment, provision, prepare"),
("窃", "セツ", "ぬす.む, ひそ.か", "stealth, steal, secret, private, hushed"),
("節", "セツ, セチ", "ふし, -ぶし, のっと", "node, season, period, occasion, verse, clause, stanza, honor, joint, knuckle, knob, knot, tune, melody"),
("説", "セツ, ゼイ", "と.く", "opinion, theory, explanation, rumor"),
("雪", "セツ", "ゆき", "snow"),
("絶", "ゼツ", "た.える, た.やす, た.つ", "discontinue, sever, cut off, abstain, interrupt, suppress, be beyond, without match, peerless, unparalleled"),
("舌", "ゼツ", "した", "tongue, reed, clapper"),
("蝉", "セン, ゼン", "せみ", "cicada"),
("仙", "セン, セント", "", "hermit, wizard, cent"),
("先", "セン", "さき, ま.ず", "before, ahead, previous, future, precedence"),
("千", "セン", "ち", "thousand"),
("占", "セン", "し.める, うらな.う", "fortune-telling, divining, forecasting, occupy, hold, have, get, take"),
("宣", "セン", "のたま.う", "proclaim, say, announce"),
("専", "セン", "もっぱ.ら", "specialty, exclusive, mainly, solely"),
("尖", "セン", "とが.る, さき, するど.い", "be pointed, sharp, taper, displeased, angry, edgy"),
("川", "セン", "かわ", "stream, river, river or three-stroke river radical (no. 47)"),
("戦", "セン", "いくさ, たたか.う, おのの.く, そよ.ぐ, わなな.く", "war, battle, match"),
("扇", "セン", "おうぎ", "fan, folding fan"),
("撰", "サン, セン", "せん.する, えら.む, えら.ぶ", "composing, editing, compiling, selecting"),
...
("洗", "セン", "あら.う", "wash, inquire into, probe"),
("染", "セン", "そ.める, そ.まる, し.みる, し.み", "dye, color, paint, stain, print"),
("潜", "セン", "ひそ.む, もぐ.る, かく.れる, くぐ.る, ひそ.める", "submerge, conceal, hide, lower (voice), hush"),
("煎", "セン", "せん.じる, い.る, に.る", "broil, parch, roast, boil"),
("煽", "セン", "あお.る, おだ.てる, おこ.る", "fan, flap, instigate, agitate, bolster up, gulp down"),
("旋", "セン", "め.ぐる, いばり", "rotation, go around"),
("穿", "セン", "うが.つ, は.く", "put on (to the feet), dig, pierce, drill"),
("箭", "セン", "や", "arrow"),
("線", "セン", "すじ", "line, track"),
("繊", "セン", "", "slender, fine, thin kimono"),
("羨", "セン, エン", "うらや.む, あまり", "envious, be jealous, covet"),
("腺", "セン", "", "gland, (kokuji)"),
("舛", "ブ, セン", "まい, そむ.く", "dancing radical (no. 136)"),
("船", "セン", "ふね, ふな-", "ship, boat"),
("薦", "セン", "すす.める", "recommend, mat, advise, encourage, offer"),
("詮", "セン", "せん.ずる, かい, あき.らか", "discussion, methods called for, selection, result"),
("賎", "セン, ゼン", "いや.しい, いや.しむ, いや.しめる, しず, やす.い", "despise, low-life, poverty"),
("践", "セン", "ふ.む", "tread, step on, trample, practice, carry through"),
("選", "セン", "えら.ぶ, え.る, よ.る", "elect, select, choose, prefer"),
("遷", "セン", "うつ.る, うつ.す, みやこがえ", "transition, move, change"),
("銭", "セン, ゼン", "ぜに, すき", "coin, .01 yen, money"),
("銑", "セン", "", "pig iron"),
("閃", "セン", "ひらめ.く, ひらめ.き, うかが.う", "flash, brandish"),
("鮮", "セン", "あざ.やか", "fresh, vivid, clear, brilliant, Korea"),
("前", "ゼン", "まえ, -まえ", "in front, before"),
("善", "ゼン", "よ.い, い.い, よ.く, よし.とする", "virtuous, good, goodness"),
("漸", "ゼン", "ようや.く, やや, ようよ.う, すす.む", "steadily, gradually advancing, finally, barely"),
("然", "ゼン, ネン", "しか, しか.り, しか.し, さ", "sort of thing, so, if so, in that case, well"),
("全", "ゼン", "まった.く, すべ.て", "whole, entire, all, complete, fulfill"),
("禅", "ゼン, セン", "しずか, ゆず.る", "Zen, silent meditation"),
("繕", "ゼン", "つくろ.う", "darning, repair, mend, trim, tidy up, adjust"),
("膳", "ゼン, セン", "かしわ, すす.める, そな.える", "small low table, tray"),
("糎", "", "センチ, センチメートル", "centimeter, (kokuji)"),
("噌", "ソウ, ショウ, ソ", "かまびす.しい", "boisterous"),
("塑", "ソ", "でく", "model, molding"),
("岨", "ソ, ショ", "いしやま, そば", "a rocky mountain"),
("措", "ソ", "お.く", "set aside, give up, suspend, discontinue, lay aside, except"),
("曾", "ソウ, ソ, ゾウ", "かつ.て, か.って, すなわち", "once, before, formerly, ever, never, ex-"),
("曽", "ソウ, ソ, ゾウ", "かつ, かつて, すなわち", "formerly, once, before, ever, never, ex-"),
("楚", "ソ, ショ", "いばら, しもと, すわえ", "whip, cane"),
("狙", "ソ, ショ", "ねら.う, ねら.い", "aim at, sight, shadow, stalk"),
("疏", "ソ, ショ", "あら.い, うと.い, うと.む, とお.る, とお.す, まばら", "pass through, note, commentary, estrangement, sparseness, neglect, penetrate"),
("疎", "ソ, ショ", "うと.い, うと.む, まば.ら", "alienate, rough, neglect, shun, sparse, penetrate"),
("礎", "ソ", "いしずえ", "cornerstone, foundation stone"),
("祖", "ソ", "", "ancestor, pioneer, founder"),
("租", "ソ", "", "tariff, crop tax, borrowing"),
("粗", "ソ", "あら.い, あら-", "coarse, rough, rugged"),
...
("蘇", "ソ, ス", "よみがえ.る", "be resuscitated, revived, perilla, shiso"),
("訴", "ソ", "うった.える", "accusation, sue, complain of pain, appeal to"),
("阻", "ソ", "はば.む", "thwart, separate from, prevent, obstruct, deter, impede"),
("遡", "ソ, サク", "さかのぼ.る", "go upstream, retrace the past"),
("鼠", "ソ, ショ", "ねずみ, ねず", "rat, mouse, dark gray"),
("僧", "ソウ", "", "Buddhist priest, monk"),
("創", "ソウ, ショウ", "つく.る, はじ.める, きず, けず.しける", "genesis, wound, injury, hurt, start, originate"),
("双", "ソウ", "ふた, たぐい, ならぶ, ふたつ", "pair, set, comparison, counter for pairs"),
("叢", "ソウ, ス", "くさむら, むら.がる, むら", "plexus, clump of bushes, thicket"),
("倉", "ソウ", "くら", "godown, warehouse, storehouse, cellar, treasury"),
("喪", "ソウ", "も", "miss, mourning"),
("壮", "ソウ", "さかん", "robust, manhood, prosperity"),
("奏", "ソウ", "かな.でる", "play music, speak to a ruler, complete"),
("爽", "ソウ", "あき.らか, さわ.やか, たがう", "refreshing, bracing, resonant, sweet, clear"),
("宋", "ソウ", "", "dwell, Sung dynasty"),
("層", "ソウ", "", "stratum, social class, layer, story, floor"),
("匝", "キョウ, ソウ", "めぐ.る", "go around"),
("惣", "ソウ", "すべ.て", "all"),
("想", "ソウ, ソ", "おも.う", "concept, think, idea, thought"),
("捜", "ソウ, シュ, シュウ", "さが.す", "search, look for, locate"),
("掃", "ソウ, シュ", "は.く", "sweep, brush"),
("挿", "ソウ", "さ.す, はさ.む", "insert, put in, graft, wear (sword)"),
("掻", "ソウ", "か.く", "scratch, rake, comb, paddle, behead"),
("操", "ソウ, サン", "みさお, あやつ.る", "maneuver, manipulate, operate, steer, chastity, virginity, fidelity"),
("早", "ソウ, サッ", "はや.い, はや, はや-, はや.まる, はや.める, さ-", "early, fast"),
("曹", "ソウ, ゾウ", "", "office, official, comrade, fellow"),
("巣", "ソウ", "す, す.くう", "nest, rookery, hive, cobweb, den"),
("槍", "ソウ, ショウ", "やり", "spear, lance, javelin"),
("槽", "ソウ", "ふね", "vat, tub, tank"),
("漕", "ソウ", "こ.ぐ, はこ.ぶ", "rowing, scull, paddle"),
("燥", "ソウ", "はしゃ.ぐ", "parch, dry up"),
("争", "ソウ", "あらそ.う, いか.でか", "contend, dispute, argue"),
("痩", "ソウ, チュウ, シュウ, シュ", "や.せる", "get thin"),
("相", "ソウ, ショウ", "あい-", "inter-, mutual, together, each other, minister of state, councillor, aspect, phase, physiognomy"),
("窓", "ソウ, ス", "まど, てんまど, けむだし", "window, pane"),
("糟", "コウ, ソウ", "ぬか", "dregs, sediment, grounds"),
("総", "ソウ", "す.べて, すべ.て, ふさ", "general, whole, all, full, total"),
("綜", "ソウ", "おさ.める, す.べる", "rule, synthesize"),
("聡", "ソウ", "さと.い, みみざと.い", "wise, fast learner"),
("草", "ソウ", "くさ, くさ-, -ぐさ", "grass, weeds, herbs, pasture, write, draft"),
("荘", "ソウ, ショウ, チャン", "ほうき, おごそ.か", "villa, inn, cottage, feudal manor, solemn, dignified"),
...
("増", "ゾウ", "ま.す, ま.し, ふ.える, ふ.やす", "increase, add, augment, gain, promote"),
("憎", "ゾウ", "にく.む, にく.い, にく.らしい, にく.しみ", "hate, detest"),
("臓", "ゾウ", "はらわた", "entrails, viscera, bowels"),
("蔵", "ゾウ, ソウ", "くら, おさ.める, かく.れる", "storehouse, hide, own, have, possess"),
("贈", "ゾウ, ソウ", "おく.る", "presents, send, give to, award to, confer on, presenting something"),
("造", "ゾウ", "つく.る, つく.り, -づく.り", "create, make, structure, physique"),
("促", "ソク", "うなが.す", "stimulate, urge, press, demand, incite"),
("側", "ソク", "かわ, がわ, そば", "side, lean, oppose, regret"),
("則", "ソク", "のっと.る, のり, すなわち", "rule, law, follow, based on, model after"),
("即", "ソク", "つ.く, つ.ける, すなわ.ち", "instant, namely, as is, conform, agree, adapt"),
("息", "ソク", "いき", "breath, respiration, son, interest (on money), nuture, rest, coming to an end"),
("捉", "ソク, サク", "とら.える", "catch, capture"),
("束", "ソク", "たば, たば.ねる, つか, つか.ねる", "bundle, sheaf, ream, tie in bundles, govern, manage, control"),
("測", "ソク", "はか.る", "fathom, plan, scheme, measure"),
("足", "ソク", "あし, た.りる, た.る, た.す", "leg, foot, be sufficient, counter for pairs of footwear"),
("速", "ソク", "はや.い, はや-, はや.める, すみ.やか", "quick, fast"),
("俗", "ゾク", "", "vulgar, customs, manners, worldliness, mundane things"),
("属", "ゾク, ショク", "さかん, つく, やから", "belong, genus, subordinate official, affiliated"),
("賊", "ゾク", "", "burglar, rebel, traitor, robber"),
("族", "ゾク", "", "tribe, family"),
("続", "ゾク, ショク, コウ, キョウ", "つづ.く, つづ.ける, つぐ.ない", "continue, series, sequel"),
("卒", "ソツ, シュツ", "そっ.する, お.える, お.わる, ついに, にわか", "graduate, soldier, private, die"),
("袖", "シュウ", "そで", "sleeve, wing (building), extension, give cold shoulder"),
("其", "キ, ギ, ゴ", "それ, その", "that"),
("揃", "セン", "そろ.える, そろ.う, そろ.い, き.る", "be complete, uniform, all present"),
("存", "ソン, ゾン", "ながら.える, あ.る, たも.つ, と.う", "exist, suppose, be aware of, believe, feel"),
...
("遜", "ソン", "したが.う, へりくだ.る, ゆず.る", "humble, modest"),
("他", "タ", "ほか", "other, another, the others"),
("多", "タ", "おお.い, まさ.に, まさ.る", "many, frequent, much"),
("太", "タイ, タ", "ふと.い, ふと.る", "plump, thick, big around"),
("汰", "タ, タイ", "おご.る, にご.る, よな.げる", "washing, sieving, filtering, weeding out, luxury"),
("詑", "イ, タ, ダ", "わ.びる, わ.び, あざむ.く", "deceive, delude"),
("唾", "ダ, タ", "つば, つばき", "saliva, sputum"),
("堕", "ダ", "お.ちる, くず.す, くず.れる", "degenerate, descend to, lapse into"),
("妥", "ダ", "", "gentle, peace, depravity"),
("惰", "ダ", "", "lazy, laziness"),
("打", "ダ, ダース", "う.つ, う.ち-, ぶ.つ", "strike, hit, knock, pound, dozen"),
("柁", "ダ, タ", "かじ", "rudder, helm, wheel"),
("舵", "ダ, タ", "かじ", "rudder, helm, wheel"),
("楕", "ダ, タ", "", "ellipse"),
("陀", "タ, ダ, イ, チ, ジ", "けわ.しい, ななめ", "steep"),
("駄", "ダ, タ", "", "burdensome, pack horse, horse load, send by horse, trivial, worthless"),
("騨", "タン, ダン, タ, ダ, テン", "", "dappled grey horse"),
("体", "タイ, テイ", "からだ, かたち", "body, substance, object, reality, counter for images"),
("堆", "タイ, ツイ", "うずたか.い", "piled high"),
("対", "タイ, ツイ", "あいて, こた.える, そろ.い, つれあ.い, なら.ぶ, むか.う", "vis-a-vis, opposite, even, equal, versus, anti-, compare"),
("耐", "タイ", "た.える", "-proof, enduring"),
("岱", "タイ", "", "old name for a Chinese mountain, Taishan"),
("帯", "タイ", "お.びる, おび", "sash, belt, obi, zone, region"),
("待", "タイ", "ま.つ, -ま.ち", "wait, depend on"),
("怠", "タイ", "おこた.る, なま.ける", "neglect, laziness"),
("態", "タイ", "わざ.と", "attitude, condition, figure, appearance, voice (of verbs)"),
("戴", "タイ", "いただ.く", "be crowned with, live under (a ruler), receive"),
("替", "タイ", "か.える, か.え-, か.わる", "exchange, spare, substitute, per-"),
("泰", "タイ", "", "peaceful, calm, peace, easy, Thailand, extreme, excessive, great"),
("滞", "タイ, テイ", "とどこお.る", "stagnate, be delayed, overdue, arrears"),
("胎", "タイ", "", "womb, uterus"),
("腿", "タイ", "もも", "thigh, femur"),
("苔", "タイ", "こけ, こけら", "moss, lichen"),
("袋", "タイ, ダイ", "ふくろ", "sack, bag, pouch"),
("貸", "タイ", "か.す, か.し-, かし-", "lend"),
("退", "タイ", "しりぞ.く, しりぞ.ける, ひ.く, の.く, の.ける, ど.く", "retreat, withdraw, retire, resign, repel, expel, reject"),
("逮", "タイ", "", "apprehend, chase"),
("隊", "タイ", "", "regiment, party, company, squad"),
("黛", "タイ", "まゆずみ", "blackened eyebrows"),
("鯛", "チョウ", "たい", "sea bream, red snapper"),
("代", "ダイ, タイ", "か.わる, かわ.る, かわ.り, か.わり, -がわ.り, -が.わり, か.える, よ, しろ", "substitute, change, convert, replace, period, age, counter for decades of ages, eras, etc., generation, charge, rate, fee"),
("台", "ダイ, タイ", "うてな, われ, つかさ", "pedestal, a stand, counter for machines and vehicles"),
("大", "ダイ, タイ", "おお-, おお.きい, -おお.いに", "large, big"),
("第", "ダイ, テイ", "", "No., residence"),
("醍", "ダイ, タイ, テイ", "", "whey, good Buddhist teaching"),
("題", "ダイ", "", "topic, subject"),
("鷹", "ヨウ, オウ", "たか", "hawk"),
("滝", "ロウ, ソウ", "たき", "waterfall, rapids, cascade"),
("瀧", "ロウ, ソウ", "たき", "waterfall, rapids, cascade"),
("卓", "タク", "", "eminent, table, desk, high"),
("啄", "タク, ツク, トク", "ついば.む, つつ.く", "peck, pick up"),
("宅", "タク", "", "home, house, residence, our house, my husband"),
("托", "タク", "たく.する, たの.む", "requesting, entrusting with, pretend, hint"),
("択", "タク", "えら.ぶ", "choose, select, elect, prefer"),
("拓", "タク", "ひら.く", "clear (the land), open, break up (land)"),
("沢", "タク", "さわ, うるお.い, うるお.す, つや", "swamp, marsh, brilliance, grace"),
...
("濁", "ダク, ジョク", "にご.る, にご.す", "voiced, uncleanness, wrong, nigori, impurity"),
("諾", "ダク", "", "consent, assent, agreement"),
("茸", "ジョウ, ニュ", "きのこ, たけ, しげ.る", "mushroom"),
("凧", "", "いかのぼり, たこ", "kite, (kokuji)"),
("蛸", "ソウ, ショウ", "たこ", "octopus"),
("只", "シ", "ただ", "only, free, in addition"),
("叩", "コウ", "たた.く, はた.く, すぎ", "strike, beat, kow tow, hit, thrash, criticize"),
("但", "タン", "ただ.し", "however, but"),
("達", "タツ, ダ", "-たち", "accomplished, reach, arrive, attain"),
("辰", "シン, ジン", "たつ", "sign of the dragon, 7-9AM, fifth sign of Chinese zodiac, shin dragon radical (no. 161)"),
...
("巽", "ソン", "たつみ", "southeast"),
("竪", "ジュ", "たて, た.てる, こども", "length, height, warp"),
("辿", "テン", "たど.る, たどり", "follow (road), pursue"),
("棚", "ホウ", "たな, -だな", "shelf, ledge, rack, mount, mantle, trellis"),
("谷", "コク", "たに, きわ.まる", "valley"),
("狸", "リ, ライ", "たぬき", "tanuki, raccoon"),
("鱈", "セツ", "たら", "codfish, (kokuji)"),
("樽", "ソン", "たる", "barrel, cask, keg"),
("誰", "スイ", "だれ, たれ, た", "who, someone, somebody"),
("丹", "タン", "に", "rust-colored, red, red lead, pills, sincerity"),
("単", "タン", "ひとえ", "simple, one, single, merely"),
("嘆", "タン", "なげ.く, なげ.かわしい", "sigh, lament, moan, grieve, sigh of admiration"),
("坦", "タン", "たいら", "level, wide"),
("担", "タン", "かつ.ぐ, にな.う", "shouldering, carry, raise, bear"),
("探", "タン", "さぐ.る, さが.す", "grope, search, look for"),
("旦", "タン, ダン", "あき.らか, あきら, ただし, あさ, あした", "daybreak, dawn, morning"),
("歎", "タン", "なげ.く, なげ.き", "grief, lamentation"),
("淡", "タン", "あわ.い", "thin, faint, pale, fleeting"),
("湛", "タン, チン, ジン, セン", "しず.む, たた.える", "fill, wear (a smile), clear, pure, dense, deep"),
("炭", "タン", "すみ", "charcoal, coal"),
("短", "タン", "みじか.い", "short, brevity, fault, defect, weak point"),
("端", "タン", "はし, は, はた, -ばた, はな", "edge, origin, end, point, border, verge, cape"),
("箪", "タン", "はこ", "bamboo rice basket"),
("綻", "タン", "ほころ.びる", "be rent, ripped, unravel, run, begin to open, smile"),
("耽", "タン", "ふけ.る", "addicted, absorbed in"),
("胆", "タン", "きも", "gall bladder, courage, pluck, nerve"),
("蛋", "タン", "", "barbarian, egg"),
("誕", "タン", "", "nativity, be born, declension, lie, be arbitrary"),
("鍛", "タン", "きた.える", "forge, discipline, train"),
...
("断", "ダン", "た.つ, ことわ.る, さだ.める", "severance, decline, refuse, apologize, warn, dismiss, prohibit, decision, judgement, cutting"),
("暖", "ダン, ノン", "あたた.か, あたた.かい, あたた.まる, あたた.める", "warmth"),
("檀", "ダン, タン", "まゆみ", "cedar, sandlewood, spindle tree"),
("段", "ダン, タン", "", "grade, steps, stairs"),
("男", "ダン, ナン", "おとこ, お", "male"),
("談", "ダン", "", "discuss, talk"),
("値", "チ", "ね, あたい", "price, cost, value"),
("知", "チ", "し.る, し.らせる", "know, wisdom"),
("地", "チ, ジ", "", "ground, earth"),
("弛", "チ, シ", "たる.む, たる.める, たゆ.む, ゆる.む, ゆる.み", "slacken, relax"),
("恥", "チ", "は.じる, はじ, は.じらう, は.ずかしい", "shame, dishonor"),
("智", "チ", "", "wisdom, intellect, reason"),
("池", "チ", "いけ", "pond, cistern, pool, reservoir"),
("痴", "チ", "し.れる, おろか", "stupid, foolish"),
("稚", "チ, ジ", "いとけない, おさない, おくて, おでる", "immature, young"),
...
("蜘", "チ", "くも", "spider"),
("遅", "チ", "おく.れる, おく.らす, おそ.い", "slow, late, back, later"),
("馳", "チ, ジ", "は.せる", "run, gallop, sail, drive (a wagon), win (fame), despatch"),
("築", "チク", "きず.く", "fabricate, build, construct"),
("畜", "チク", "", "livestock, domestic fowl and animals"),
("竹", "チク", "たけ", "bamboo"),
("筑", "チク", "", "an ancient musical instrument"),
("蓄", "チク", "たくわ.える", "amass, raise, hoard, store"),
("逐", "チク", "", "pursue, drive away, chase, accomplish, attain, commit"),
("秩", "チツ", "", "regularity, salary, order"),
("窒", "チツ", "", "plug up, obstruct"),
("茶", "チャ, サ", "", "tea"),
("嫡", "チャク, テキ", "", "legitimate wife, direct descent (non-bastard)"),
("着", "チャク, ジャク", "き.る, き.せる, つ.く, つ.ける", "don, arrive, wear, counter for suits of clothing"),
("中", "チュウ", "なか, うち, あた.る", "in, inside, middle, mean, center"),
("仲", "チュウ", "なか", "go-between, relationship"),
("宙", "チュウ", "", "mid-air, air, space, sky, memorization, interval of time"),
("忠", "チュウ", "", "loyalty, fidelity, faithfulness"),
("抽", "チュウ", "ひき-", "pluck, pull, extract, excel"),
("昼", "チュウ", "ひる", "daytime, noon"),
("柱", "チュウ", "はしら", "pillar, post, cylinder, support"),
("注", "チュウ", "そそ.ぐ, さ.す, つ.ぐ", "pour, irrigate, shed (tears), flow into, concentrate on, notes, comment, annotate"),
("虫", "チュウ, キ", "むし", "insect, bug, temper"),
("衷", "チュウ", "", "inmost, heart, mind, inside"),
("註", "チュウ", "", "notes, comment, annotate"),
("酎", "チュウ, チュ", "かも.す", "sake"),
("鋳", "チュウ, イ, シュ, シュウ", "い.る", "casting, mint"),
("駐", "チュウ", "", "stop-over, reside in, resident"),
("樗", "チョ", "おおち, おうち", "Japanese bead tree"),
("瀦", "チョ", "", "pool, puddle"),
("猪", "チョ", "い, いのしし", "boar"),
...
("丁", "チョウ, テイ, チン, トウ, チ", "ひのと", "street, ward, town, counter for guns, tools, leaves or cakes of something, even number, 4th calendar sign"),
("兆", "チョウ", "きざ.す, きざ.し", "portent, 10**12, trillion, sign, omen, symptoms"),
("凋", "チョウ", "しぼ.む", "wither, droop, lame"),
("喋", "チョウ, トウ", "しゃべ.る, ついば.む", "talk, chat, chatter"),
("寵", "チョウ", "めぐ.み, めぐ.む", "affection, love, patronage"),
("帖", "チョウ, ジョウ", "かきもの", "quire (of paper), bundle of seaweed, counter for screens, notebook"),
("帳", "チョウ", "とばり", "notebook, account book, album, curtain, veil, net, tent"),
("庁", "チョウ, テイ", "やくしょ", "government office"),
("弔", "チョウ", "とむら.う, とぶら.う", "condolences, mourning, funeral"),
...
("潮", "チョウ", "しお, うしお", "tide, salt water, opportunity"),
("牒", "チョウ, ジョウ", "ふだ", "label, genealogy, circular"),
("町", "チョウ", "まち", "town, village, block, street"),
("眺", "チョウ", "なが.める", "stare, watch, look at, see, scrutinize"),
("聴", "チョウ, テイ", "き.く, ゆる.す", "listen, headstrong, naughty, careful inquiry"),
("脹", "チョウ", "は.れる, ふく.らむ, ふく.れる", "dilate, distend, bulge, fill out, swell"),
("腸", "チョウ", "はらわた, わた", "intestines, guts, bowels, viscera"),
("蝶", "チョウ", "", "butterfly"),
("調", "チョウ", "しら.べる, しら.べ, ととの.う, ととの.える", "tune, tone, meter, key (music), writing style, prepare, exorcise, investigate, harmonize, mediate"),
("諜", "チョウ", "ちょう.ずる, うかが.う, しめ.す", "spy out, reconnoiter"),
("超", "チョウ", "こ.える, こ.す", "transcend, super-, ultra-"),
("跳", "チョウ", "は.ねる, と.ぶ, -と.び", "hop, leap up, spring, jerk, prance, buck, splash, sputter, snap"),
("銚", "チョウ, ヨウ", "なべ", "sake bottle"),
("長", "チョウ", "なが.い, おさ", "long, leader, superior, senior"),
("頂", "チョウ", "いただ.く, いただき", "place on the head, receive, top of head, top, summit, peak"),
("鳥", "チョウ", "とり", "bird, chicken"),
("勅", "チョク", "いまし.める, みことのり", "imperial order"),
("捗", "チョク, ホ", "はかど.る", "make progress"),
("直", "チョク, ジキ, ジカ", "ただ.ちに, なお.す, -なお.す, なお.る, なお.き, す.ぐ", "straightaway, honesty, frankness, fix, repair"),
...
("賃", "チン", "", "fare, fee, hire, rent, wages, charge"),
("鎮", "チン", "しず.める, しず.まる, おさえ", "tranquilize, ancient peace-preservation centers"),
("陳", "チン", "ひ.ねる", "exhibit, state, relate, explain"),
("津", "シン", "つ", "haven, port, harbor, ferry"),
("墜", "ツイ", "お.ちる, お.つ", "crash, fall (down)"),
("椎", "ツイ, スイ", "つち, う.つ", "chinquapin, mallet, spine"),
("槌", "ツイ", "つち", "hammer, mallet"),
("追", "ツイ", "お.う", "chase, drive away, follow, pursue, meanwhile"),
("鎚", "ツイ, タイ", "つち", "hammer, mallet"),
("痛", "ツウ", "いた.い, いた.む, いた.ましい, いた.める", "pain, hurt, damage, bruise"),
("通", "ツウ, ツ", "とお.る, とお.り, -とお.り, -どお.り, とお.す, とお.し, -どお.し, かよ.う", "traffic, pass through, avenue, commute, counter for letters, notes, documents, etc."),
("塚", "チョウ", "つか, -づか", "hillock, mound"),
("栂", "", "つが, とが", "hemlock, (kokuji)"),
("掴", "カク", "つか.む, つか.まえる, つか.まる", "catch, seize, grasp, hold, arrest, capture"),
("槻", "キ", "つき", "Zelkova tree"),
("佃", "テン, デン", "つくだ", "cultivated rice field"),
("漬", "シ", "つ.ける, つ.かる, -づ.け, -づけ", "pickling, soak, moisten, steep"),
("柘", "シャ, ジャク", "そ, つげ, やまぐわ", "wild mulberry"),
("辻", "", "つじ", "crossing, crossroad, street corners, (kokuji)"),
("蔦", "チョウ", "つた", "vine, ivy"),
("綴", "テイ, テツ, テチ, ゲツ", "と.じる, つづ.る, つづり, すみ.やか", "compose, spell, write, bind (books)"),
("鍔", "ガク", "つば", "sword guard, kettle brim"),
("椿", "チン, チュン", "つばき", "camellia"),
("潰", "カイ, エ", "つぶ.す, つぶ.れる, つい.える", "crush, smash, break, dissipate"),
("坪", "ヘイ", "つぼ", "two-mat area, approx. thirty-six sq ft"),
("壷", "コ", "つぼ", "jar, pot, hinge knuckle, one's aim"),
("嬬", "ジュ", "よわ.い", "mistress, weak"),
("紬", "チュウ", "つむぎ, つむ.ぐ", "pongee (a knotted silk cloth)"),
("爪", "ソウ", "つめ, つま-", "claw, nail, talon"),
("吊", "チョウ", "つ.る, つる.す", "suspend, hang, wear (sword)"),
("釣", "チョウ", "つ.る, つ.り, つ.り-", "angling, fish, catch, allure, ensnare"),
("鶴", "カク", "つる", "crane, stork"),
("亭", "テイ, チン", "", "pavilion, restaurant, mansion, arbor, cottage, vaudeville, music hall, stage name"),
("低", "テイ", "ひく.い, ひく.める, ひく.まる", "lower, short, humble"),
("停", "テイ", "と.める, と.まる", "halt, stopping"),
("偵", "テイ", "", "spy"),
("剃", "テイ", "まい, そ.る, す.る", "shave"),
("貞", "テイ, ジョウ", "ただし.い, さだ", "upright, chastity, constancy, righteousness"),
("呈", "テイ", "", "display, offer, present, send, exhibit"),
("堤", "テイ", "つつみ", "dike, bank, embankment"),
("定", "テイ, ジョウ", "さだ.める, さだ.まる, さだ.か", "determine, fix, establish, decide"),
("帝", "テイ", "みかど", "sovereign, the emperor, god, creator"),
("底", "テイ", "そこ", "bottom, sole, depth, bottom price, base, kind, sort"),
("庭", "テイ", "にわ", "courtyard, garden, yard"),
("廷", "テイ", "", "courts, imperial court, government office"),
("弟", "テイ, ダイ, デ", "おとうと", "younger brother, faithful service to elders"),
("悌", "テイ, ダイ", "", "serving our elders"),
("抵", "テイ", "", "resist, reach, touch"),
("挺", "チョウ, テイ", "ぬ.く", "bravely volunteer, counter for guns, inksticks, palanquins, rickshaws"),
("提", "テイ, チョウ, ダイ", "さ.げる", "propose, take along, carry in hand"),
("梯", "テイ, タイ", "はしご", "ladder, stairs, insatiable drinking"),
("汀", "テイ", "みぎわ, なぎさ", "water's edge, shore, bank"),
("碇", "テイ", "いかり", "anchor, grapnel"),
("禎", "テイ", "さいわ.い", "happiness, blessed, good fortune, auspicious"),
("程", "テイ", "ほど, -ほど", "extent, degree, law, formula, distance, limits, amount"),
("締", "テイ", "し.まる, し.まり, し.める, -し.め, -じ.め", "tighten, tie, shut, lock, fasten"),
("艇", "テイ", "", "rowboat, small boat"),
("訂", "テイ", "ただ.す", "revise, correct, decide"),
("諦", "テイ, タイ", "あきら.める, つまびらか, まこと", "truth, clarity, abandon, give up"),
("蹄", "テイ", "ひづめ", "hoof"),
("逓", "テイ", "かわ.る, たがいに", "relay, in turn, sending"),
("邸", "テイ", "やしき", "residence, mansion"),
("鄭", "テイ, ジョウ", "", "an ancient Chinese province"),
("釘", "テイ, チョウ", "くぎ", "nail, tack, peg"),
("鼎", "テイ", "かなえ", "three legged kettle"),
("泥", "デイ, ナイ, デ, ニ", "どろ, なず.む", "mud, mire, adhere to, be attached to"),
("摘", "テキ", "つ.む", "pinch, pick, pluck, trim, clip, summarize"),
("擢", "テキ, タク", "ぬ.く, ぬき.んでる", "excel in, surpass, pull out, select"),
("敵", "テキ", "かたき, あだ, かな.う", "enemy, foe, opponent"),
("滴", "テキ", "しずく, したた.る", "drip, drop"),
("的", "テキ", "まと", "bull's eye, mark, target, object, adjective ending"),
("笛", "テキ", "ふえ", "flute, clarinet, pipe, whistle, bagpipe, piccolo"),
("適", "テキ", "かな.う", "suitable, occasional, rare, qualified, capable"),
("鏑", "テキ", "かぶら, かぶらや, やじり", "arrowhead"),
("溺", "デキ, ジョウ, ニョウ", "いばり, おぼ.れる", "drown, indulge"),
("哲", "テツ", "さとい, あきらか", "philosophy, clear"),
("徹", "テツ", "", "penetrate, clear, pierce, strike home, sit up (all night)"),
("撤", "テツ", "", "remove, withdraw, disarm, dismantle, reject, exclude"),
("轍", "テツ", "わだちい, わだち", "rut, wheel track"),
("迭", "テツ", "", "transfer, alternation"),
("鉄", "テツ", "くろがね", "iron"),
("典", "テン, デン", "ふみ, のり", "code, ceremony, law, rule"),
("填", "テン, チン", "は.まる, は.める, うず.める, しず.める, ふさ.ぐ", "fill in"),
("天", "テン", "あまつ, あめ, あま-", "heavens, sky, imperial"),
("展", "テン", "", "unfold, expand"),
("店", "テン", "みせ, たな", "store, shop"),
("添", "テン", "そ.える, そ.う", "annexed, accompany, marry, suit, meet, satisfy, attach, append, garnish, imitate"),
("纏", "テン, デン", "まつ.わる, まと.う, まと.める, まと.まる, まと.い", "wear, wrap, tie, follow around, collect"),
("甜", "テン", "うま.い, あま.い", "sweet"),
("貼", "テン, チョウ", "は.る, つ.く", "stick, paste, apply"),
("転", "テン", "ころ.がる, ころ.げる, ころ.がす, ころ.ぶ, まろ.ぶ, うたた, うつ.る, くる.めく", "revolve, turn around, change"),
("顛", "テン", "いただき, たお.れる", "overturn, summit, origin"),
("点", "テン", "つ.ける, つ.く, た.てる, さ.す, とぼ.す, とも.す, ぼち", "spot, point, mark, speck, decimal point"),
("伝", "デン, テン", "つた.わる, つた.える, つた.う, つだ.う, -づた.い, つて", "transmit, go along, walk along, follow, report, communicate, legend, tradition"),
("殿", "デン, テン", "との, -どの", "Mr., hall, mansion, palace, temple, lord"),
("澱", "デン, テン", "おり, ど.ろ, よど.み, よど.む", "sediment, grounds, dregs, stagnant"),
("田", "デン", "た", "rice field, rice paddy"),
("電", "デン", "", "electricity"),
("兎", "ト, ツ", "うさぎ", "rabbit, hare"),
("吐", "ト", "は.く, つ.く", "spit, vomit, belch, confess, tell (lies)"),
("堵", "ト", "かき", "fence, railing, enclosure"),
("塗", "ト", "ぬ.る, ぬ.り, まみ.れる", "paint, plaster, daub, smear, coating"),
("妬", "ト, ツ", "ねた.む, そね.む, つも.る, ふさ.ぐ", "jealous, envy"),
("屠", "ト, チョ", "ほふ.る", "slaughter, butcher, slay"),
("徒", "ト", "いたずら, あだ", "on foot, junior, emptiness, vanity, futility, uselessness, ephemeral thing, gang, set, party, people"),
("斗", "ト, トウ", "", "Big Dipper, ten sho (vol), sake dipper, dots and cross radical (no. 68)"),
("杜", "ト, トウ, ズ", "もり, ふさ.ぐ, やまなし", "woods, grove"),
("渡", "ト", "わた.る, -わた.る, わた.す", "transit, ford, ferry, cross, import, deliver, diameter, migrate"),
("登", "トウ, ト, ドウ, ショウ, チョウ", "のぼ.る, あ.がる", "ascend, climb up"),
("菟", "ト, ツ", "うさぎ", "dodder (plant)"),
("賭", "ト", "か.ける, かけ", "gamble, wager, bet"),
("途", "ト", "みち", "route, way, road"),
("都", "ト, ツ", "みやこ", "metropolis, capital, all, everything"),
("鍍", "ト", "めっき", "plating, gilding"),
("砥", "シ, テイ, キイ, チ", "と, といし, と.ぐ, みが.く", "whetstone, grindstone"),
("砺", "レイ", "あらと, みが.く", "whetstone, polish"),
("努", "ド", "つと.める", "toil, diligent, as much as possible"),
("度", "ド, ト, タク", "たび, -た.い", "degrees, occurrence, time, counter for occurrences, consider, attitude"),
("土", "ド, ト", "つち", "soil, earth, ground, Turkey"),
("奴", "ド", "やつ, やっこ", "guy, slave, manservant, fellow"),
("怒", "ド, ヌ", "いか.る, おこ.る", "angry, be offended"),
("倒", "トウ", "たお.れる, -だお.れ, たお.す, さかさま, さかさ, さかしま", "overthrow, fall, collapse, drop, break down"),
("党", "トウ", "なかま, むら", "party, faction, clique"),
("冬", "トウ", "ふゆ", "winter"),
("凍", "トウ", "こお.る, こご.える, こご.る, い.てる, し.みる", "frozen, congeal, refrigerate"),
("刀", "トウ", "かたな, そり", "sword, saber, knife"),
("唐", "トウ", "から", "T'ang, China, foreign"),
("塔", "トウ", "", "pagoda, tower, steeple"),
("塘", "トウ", "つつみ", "dike, embankment"),
("套", "トウ", "かさ.ねる", "accumulate, big and long, hackneyed"),
("宕", "トウ", "すぎる", "cave"),
("島", "トウ", "しま", "island"),
("嶋", "トウ", "しま", "island"),
("悼", "トウ", "いた.む", "lament, grieve over"),
("投", "トウ", "な.げる, -な.げ", "throw, discard, abandon, launch into, join, invest in, hurl, give up, sell at a loss"),
("搭", "トウ", "", "board, load (a vehicle), ride"),
("東", "トウ", "ひがし", "east"),
("桃", "トウ", "もも", "peach"),
("梼", "トウ", "", "block of wood, blockhead, stupid"),
("棟", "トウ", "むね, むな-", "ridgepole, ridge"),
("盗", "トウ", "ぬす.む, ぬす.み", "steal, rob, pilfer"),
("淘", "トウ", "よな.げる", "select"),
("湯", "トウ", "ゆ", "hot water, bath, hot spring"),
("涛", "トウ", "なみ", "waves, billows"),
("灯", "トウ", "ひ, ほ-, ともしび, とも.す, あかり", "lamp, a light, light, counter for lights"),
("燈", "トウ", "ひ, ほ-, ともしび, とも.す, あかり", "lamp, light, counter for lights"),
("当", "トウ", "あ.たる, あ.たり, あ.てる, あ.て, まさ.に, まさ.にべし", "hit, right, appropriate, himself"),
("痘", "トウ", "", "pox, smallpox"),
("祷", "トウ", "いの.る, いの.り, まつ.る", "pray"),
("等", "トウ", "ひと.しい, など, -ら", "etc., and so forth, class (first), quality, equal, similar"),
("答", "トウ", "こた.える, こた.え", "solution, answer"),
("筒", "トウ", "つつ", "cylinder, pipe, tube, gun barrel, sleeve"),
("糖", "トウ", "", "sugar"),
("統", "トウ", "す.べる, ほび.る", "overall, relationship, ruling, governing"),
("到", "トウ", "いた.る", "arrival, proceed, reach, attain, result in"),
("董", "トウ", "ただ.す", "correct"),
("蕩", "トウ", "とろ.かす, とろ.ける, うご.く", "melt, be charmed, captivated"),
("藤", "トウ, ドウ", "ふじ", "wisteria"),
...
("逃", "トウ", "に.げる, に.がす, のが.す, のが.れる", "escape, flee, shirk, evade, set free"),
("透", "トウ", "す.く, す.かす, す.ける, とう.る, とう.す", "transparent, permeate, filter, penetrate"),
("鐙", "トウ", "あぶみ, たかつき, ひともし", "stirrup"),
("陶", "トウ", "すえ", "pottery, porcelain"),
("頭", "トウ, ズ, ト", "あたま, かしら, -がしら, かぶり", "head, counter for large animals"),
("騰", "トウ", "あが.る, のぼ.る", "leaping up, jumping up, rising, advancing, going"),
("闘", "トウ", "たたか.う, あらそ.う", "fight, war"),
("働", "ドウ", "はたら.く", "work, (kokuji)"),
("動", "ドウ", "うご.く, うご.かす", "move, motion, change, confusion, shift, shake"),
("同", "ドウ", "おな.じ", "same, agree, equal"),
("堂", "ドウ", "", "public chamber, hall"),
("導", "ドウ", "みちび.く", "guidance, leading, conduct, usher"),
("憧", "ショウ, トウ, ドウ", "あこが.れる", "yearn after, long for, aspire to, admire, adore"),
("撞", "ドウ, トウ, シュ", "つ.く", "thrust, pierce, stab, prick"),
("洞", "ドウ", "ほら", "den, cave, excavation"),
("瞳", "ドウ, トウ", "ひとみ", "pupil (of eye)"),
("童", "ドウ", "わらべ", "juvenile, child"),
("胴", "ドウ", "", "trunk, torso, hull (ship), hub of wheel"),
("萄", "ドウ, トウ", "", "grape vine, wild grape"),
("道", "ドウ, トウ", "みち, いう", "road-way, street, district, journey, course, moral, teachings"),
("銅", "ドウ", "あかがね", "copper"),
("峠", "", "とうげ", "mountain peak, mountain pass, climax, crest, (kokuji)"),
("鴇", "ホウ", "とき, のがん", "wild goose, madam of a brothel, crested ibis"),
("匿", "トク", "かくま.う", "hide, shelter, shield"),
("得", "トク", "え.る, う.る", "gain, get, find, earn, acquire, can, may, able to, profit, advantage, benefit"),
("徳", "トク", "", "benevolence, virtue, goodness, commanding respect"),
("涜", "トク, トウ", "けが.す, けが.れ, みぞ", "defile, blaspheme, ditch"),
("特", "トク", "", "special"),
("督", "トク", "", "coach, command, urge, lead, supervise"),
("禿", "トク", "ちび.る, かむろ, は.げる, はげ", "become bald, bare, wear out, waste away, little girl employed at a brothel"),
...
("栃", "", "とち", "horse chestnut, (kokuji)"),
("橡", "ショウ, ゾウ", "とち, くぬぎ", "horse chestnut"),
("凸", "トツ", "でこ", "convex, beetle brow, uneven"),
("突", "トツ, カ", "つ.く", "stab, protruding, thrust, pierce, prick, collision, sudden"),
("椴", "タン, ダン, トド", "むくげ", "fir"),
("届", "カイ", "とど.ける, -とど.け, とど.く", "deliver, reach, arrive, report, notify, forward"),
("鳶", "エン", "とび, とんび", "black kite, fireman, hook"),
("苫", "セン", "とま", "rush matting"),
("寅", "イン", "とら", "sign of the tiger, 3-5AM, third sign of Chinese zodiac"),
("酉", "ユウ", "とり", "west, bird, sign of the bird, 5-7PM, tenth sign of Chinese zodiac, sake radical (no. 164)"),
("瀞", "セイ, ショウ, ジュウ", "とろ, きよ.い", "pure water, clear water, pool in a river"),
("噸", "トン", "", "tonnage, (kokuji)"),
("屯", "トン", "たむろ", "barracks, police station, camp, ton"),
("惇", "シュン, ジュン, トン", "あつ.い", "sincere, kind, considerate"),
("敦", "トン, タイ, ダン, チョウ", "あつ.い", "industry, kindliness"),
("沌", "トン", "くら.い", "primeval chaos"),
("豚", "トン", "ぶた", "pork, pig"),
("遁", "トン, シュン", "のが.れる", "flee, escape, shirk, evade, set free"),
...
("那", "ナ, ダ", "なに, なんぞ, いかん", "what?"),
("内", "ナイ, ダイ", "うち", "inside, within, between, among, house, home"),
("乍", "サ, サク", "-なが.ら, たちま.ち", "though, notwithstanding, while, during, both, all"),
("凪", "", "なぎ, な.ぐ", "lull, calm, (kokuji)"),
("薙", "テイ, チ", "な.ぐ, なぎ, か.る", "mow down (the enemy)"),
("謎", "メイ, ベイ", "なぞ", "riddle, puzzle, enigma, hint, tip"),
("灘", "タン, ダン", "なだ, せ", "open sea"),
("捺", "ナツ, ダツ", "さ.す, お.す", "press, print, affix a seal, stamp"),
("鍋", "カ", "なべ", "pot, pan, kettle"),
("楢", "シュウ, ユウ", "なら", "oak"),
("馴", "ジュン, シュン, クン", "な.れる, な.らす, したが.う", "get used to, experienced, tamed"),
("縄", "ジョウ", "なわ, ただ.す", "straw rope, cord"),
("畷", "テツ, テイ, セイ", "なわて", "rice field ridge path"),
("南", "ナン, ナ", "みなみ", "south"),
("楠", "ナン, ダン, ゼン, ネン", "くす, くすのき", "camphor tree"),
("軟", "ナン", "やわ.らか, やわ.らかい", "soft"),
("難", "ナン", "かた.い, -がた.い, むずか.しい, むづか.しい, むつか.しい, -にく.い", "difficult, impossible, trouble, accident, defect"),
("汝", "ジョ", "なんじ, なれ, い, うぬ, いまし, し, しゃ, な, なむち, まし, みまし", "you, thou"),
("二", "ニ, ジ", "ふた, ふた.つ, ふたたび", "two, two radical (no. 7)"),
("尼", "ニ", "あま", "nun"),
("弐", "ニ, ジ", "ふた.つ, そえ", "II, two, second"),
("迩", "ジ, ニ", "ちか.い", "approach, near, close"),
("匂", "", "にお.う, にお.い, にお.わせる", "fragrant, stink, glow, insinuate, (kokuji)"),
("賑", "シン", "にぎ.わい, にぎ.やか, にぎ.わす, にぎ.わう", "flourish, be bustling, prosperity"),
("肉", "ニク", "しし", "meat"),
("虹", "コウ", "にじ", "rainbow"),
("廿", "ジュウ, ニュウ", "にじゅう", "twenty"),
("日", "ニチ, ジツ", "ひ, -び, -か", "day, sun, Japan, counter for days"),
("乳", "ニュウ", "ちち, ち", "milk, breasts"),
("入", "ニュウ, ジュ", "い.る, -い.る, -い.り, い.れる, -い.れ, はい.る", "enter, insert"),
("如", "ジョ, ニョ", "ごと.し", "likeness, like, such as, as if, better, best, equal"),
("尿", "ニョウ", "ゆばり, いばり, しと", "urine"),
("韮", "キュウ, ク", "にら", "leek"),
("任", "ニン", "まか.せる, まか.す", "responsibility, duty, term, entrust to, appoint"),
("妊", "ニン, ジン", "はら.む, みごも.る", "pregnancy"),
("忍", "ニン", "しの.ぶ, しの.ばせる", "endure, bear, put up with, conceal, secrete, spy, sneak"),
("認", "ニン", "みと.める, したた.める", "acknowledge, witness, discern, recognize, appreciate, believe"),
("濡", "ジュ, ニュ", "ぬれ.る, ぬら.す, ぬ.れる, ぬ.らす, うるお.い, うるお.う, うるお.す", "get wet, damp, make love"),
("禰", "ネ, デイ, ナイ", "", "ancestral shrine"),
("祢", "ネ, デイ, ナイ", "", "ancestral shrine"),
("寧", "ネイ", "むし.ろ", "rather, preferably, peaceful, quiet, tranquility"),
("葱", "ソウ", "ねぎ", "stone leek, Welsh onion"),
("猫", "ビョウ", "ねこ", "cat"),
("熱", "ネツ", "あつ.い", "heat, temperature, fever, mania, passion"),
("年", "ネン", "とし", "year, counter for years"),
("念", "ネン", "", "wish, sense, idea, thought, feeling, desire, attention"),
("捻", "ネン, ジョウ", "ね.じる, ねじ.る, ひね.くる, ひね.る", "twirl, twist, play with"),
("撚", "ネン", "よ.る, よ.れる, より, ひね.る", "twist, twine, kinky"),
("燃", "ネン", "も.える, も.やす, も.す", "burn, blaze, glow"),
("粘", "ネン", "ねば.る", "sticky, glutinous, greasy, persevere"),
("乃", "ナイ, ダイ, ノ, アイ", "の, すなわ.ち, なんじ", "from, possessive particle, whereupon, accordingly"),
("廼", "ナイ, ダイ, ノ, アイ", "すなわ.ち, なんじ", "in other words, thou, you, possessive particle"),
("之", "シ", "の, これ, ゆく, この", "of, this"),
("埜", "ヤ, ショ", "の", "open country, field, wilderness"),
("嚢", "ノウ, ドウ", "ふくろ", "pouch, purse, bag"),
("悩", "ノウ", "なや.む, なや.ます, なや.ましい, なやみ", "trouble, worry, in pain, distress, illness"),
("濃", "ノウ", "こ.い", "concentrated, thick, dark, undiluted"),
("納", "ノウ, ナッ, ナ, ナン, トウ", "おさ.める, -おさ.める, おさ.まる", "settlement, obtain, reap, pay, supply, store"),
("能", "ノウ", "よ.く, あた.う", "ability, talent, skill, capacity"),
("脳", "ノウ, ドウ", "のうずる", "brain, memory"),
("膿", "ノウ, ドウ", "う.む, うみ", "pus, fester, discharge"),
("農", "ノウ", "", "agriculture, farmers"),
("覗", "シ", "のぞ.く, うかが.う", "peep, peek, come in sight"),
("蚤", "ソウ", "のみ, はやい", "flea"),
("巴", "ハ", "ともえ, うずまき", "comma-design"),
("把", "ハ, ワ", "", "grasp, faggot, bunch, counter for bundles"),
("播", "ハ, バン, ハン", "ま.く", "plant, sow"),
("覇", "ハ, ハク", "はたがしら", "hegemony, supremacy, leadership, champion"),
("杷", "ハ", "つか", "kind of rake, loquat"),
("波", "ハ", "なみ", "waves, billows, Poland"),
("派", "ハ", "", "faction, group, party, clique, sect, school"),
("琶", "ハ, ベ, ワ", "", "lute"),
("破", "ハ", "やぶ.る, やぶ.れる, わ.れる", "rend, rip, tear, break, destroy, defeat, frustrate"),
("婆", "バ", "ばば, ばあ", "old woman, grandma, wet nurse"),
("罵", "バ", "ののし.る", "abuse, insult"),
("芭", "バ, ハ", "", "banana"),
("馬", "バ", "うま, うま-, ま", "horse"),
("俳", "ハイ", "", "haiku, actor"),
("廃", "ハイ", "すた.れる, すた.る", "abolish, obsolete, cessation, discarding, abandon"),
("拝", "ハイ", "おが.む, おろが.む", "worship, adore, pray to"),
("排", "ハイ", "", "repudiate, exclude, expel, reject, line up, arrange"),
("敗", "ハイ", "やぶ.れる", "failure, defeat, reversal"),
("杯", "ハイ", "さかずき", "counter for cupfuls, wine glass, glass, toast"),
("盃", "ハイ", "さかずき", "glass, cup"),
("牌", "ハイ", "ぱい, ふだ", "label, signboard, medal, mahjong tiles"),
("背", "ハイ", "せ, せい, そむ.く, そむ.ける", "stature, height, back, behind, disobey, defy, go back on, rebel"),
("肺", "ハイ", "", "lungs"),
("輩", "ハイ", "-ばら, やから, やかい, ともがら", "comrade, fellow, people, companions"),
("配", "ハイ", "くば.る", "distribute, spouse, exile, rationing"),
("倍", "バイ", "", "double, twice, times, fold"),
("培", "バイ", "つちか.う", "cultivate, foster"),
("媒", "バイ", "なこうど", "mediator, go-between"),
("梅", "バイ", "うめ", "plum"),
("楳", "バイ", "うめ", "plum"),
("煤", "バイ, マイ", "すす", "soot, smoke dried"),
("狽", "ケン, バイ, ハイ", "", "wolf, be flurried"),
("買", "バイ", "か.う", "buy"),
("売", "バイ", "う.る, う.れる", "sell"),
("賠", "バイ", "", "compensation, indemnify"),
("陪", "バイ", "", "obeisance, follow, accompany, attend on"),
("這", "シャ, ゲン", "は.う, は.い, むか.える, この", "crawl, creep, grovel, trail (vines)"),
("蝿", "ヨウ", "はえ, はい", "fly"),
("秤", "ショウ, ヒン, ビン", "はかり", "balances, scales, steelyard"),
("矧", "シン", "は.ぐ, いわ.んや, はぐき, はぎ", "feather (arrow)"),
("萩", "シュウ", "はぎ", "bush clover"),
("伯", "ハク", "", "chief, count, earl, uncle, Brazil"),
("剥", "ハク, ホク", "へ.ぐ, へず.る, む.く, む.ける, は.がれる, は.ぐ, は.げる, は.がす", "come off, peel, fade, discolor"),
("博", "ハク, バク", "", "Dr., command, esteem, win acclaim, Ph.D., exposition, fair"),
("拍", "ハク, ヒョウ", "", "clap, beat (music)"),
("柏", "ハク, ヒャク, ビャク", "かしわ", "oak, cypress"),
...
("迫", "ハク", "せま.る", "urge, force, imminent, spur on"),
("曝", "バク, ホク, ボク", "さら.す", "bleach, refine, expose, air"),
("漠", "バク", "", "vague, obscure, desert, wide"),
("爆", "バク", "は.ぜる", "bomb, burst open, pop, split"),
("縛", "バク", "しば.る", "truss, arrest, bind, tie, restrain"),
("莫", "バク, ボ, マク, モ, ナイ", "くれ, なか.れ, なし", "must not, do not, be not"),
("駁", "ハク, バク", "ぶち, まじ.る, まだら", "refutation, contradiction"),
("麦", "バク", "むぎ", "barley, wheat"),
("函", "カン", "はこ, い.れる", "box (archaic)"),
("箱", "ソウ", "はこ", "box, chest, case, bin, railway car"),
("硲", "", "はざま", "ravine, gorge, gap, (kokuji)"),
("箸", "チョ, チャク", "はし", "chopsticks"),
("肇", "チョウ, ジョウ, トウ", "はじ.める, はじめ", "beginning"),
("筈", "カツ", "はず, やはず", "notch of an arrow, ought, must, should be, expected"),
("櫨", "ロ", "はぜ", "wax tree, sumac"),
("幡", "マン, ハン, バン, ホン", "はた", "flag"),
...
("発", "ハツ, ホツ", "た.つ, あば.く, おこ.る, つか.わす, はな.つ", "departure, discharge, publish, emit, start from, disclose, counter for gunshots"),
("醗", "ハツ", "かも.す", "fermentation, brewing"),
("髪", "ハツ", "かみ", "hair of the head"),
("伐", "バツ, ハツ, カ, ボチ", "き.る, そむ.く, う.つ", "fell, strike, attack, punish"),
("罰", "バツ, バチ, ハツ", "ばっ.する", "penalty, punishment"),
("抜", "バツ, ハツ, ハイ", "ぬ.く, -ぬ.く, ぬ.き, ぬ.ける, ぬ.かす, ぬ.かる", "slip out, extract, pull out, pilfer, quote, remove, omit"),
("筏", "バツ, ハツ, ボチ", "いかだ", "raft"),
("閥", "バツ", "", "clique, lineage, pedigree, faction, clan"),
("鳩", "キュウ, ク", "はと, あつ.める", "pigeon, dove"),
("噺", "", "はなし", "talk, (kokuji)"),
("塙", "カク, コウ", "はなわ, かた.い", "projecting tableland or mountain"),
("蛤", "コウ", "はまぐり", "clam"),
("隼", "シュン, ジュン", "はやぶさ", "falcon"),
("伴", "ハン, バン", "ともな.う", "consort, accompany, bring with, companion"),
("判", "ハン, バン", "わか.る", "judgement, signature, stamp, seal"),
("半", "ハン", "なか.ば", "half, middle, odd number, semi-, part-"),
("反", "ハン, ホン, タン, ホ", "そ.る, そ.らす, かえ.す, かえ.る, -かえ.る", "anti-"),
("叛", "ハン, ホン", "そむ.く", "disobey, defy, go back on, rebel, rebellion"),
("帆", "ハン", "ほ", "sail"),
("搬", "ハン", "", "conveyor, carry, transport"),
("斑", "ハン", "ふ, まだら", "spot, blemish, speck, patches"),
("板", "ハン, バン", "いた", "plank, board, plate, stage"),
("氾", "ハン", "ひろ.がる", "spread out, wide"),
("汎", "ハン, ブ, フウ, ホウ, ホン", "ただよ.う, ひろ.い", "pan-"),
("版", "ハン", "", "printing block, printing plate, edition, impression, label"),
("犯", "ハン, ボン", "おか.す", "crime, sin, offense"),
("班", "ハン", "", "squad, corps, unit, group"),
("畔", "ハン", "あぜ, くろ, ほとり", "paddy ridge, levee"),
("繁", "ハン", "しげ.る, しげ.く", "luxuriant, thick, overgrown, frequency, complexity, trouble"),
("般", "ハン", "", "carrier, carry, all, general, sort, kind"),
("藩", "ハン", "", "clan, enclosure"),
("販", "ハン", "", "marketing, sell, trade"),
("範", "ハン", "", "pattern, example, model"),
("釆", "ハン, ベン, サイ", "と.る, いろどり, のごめ", "separate, divide, topped rice radical (no. 165)"),
("煩", "ハン, ボン", "わずら.う, わずら.わす, うるさ.がる, うるさ.い", "anxiety, trouble, worry, pain, ill, annoy, nuisance, irksome"),
("頒", "ハン", "わ.かつ, わ.ける", "distribute, disseminate, partition, understand"),
("飯", "ハン", "めし", "meal, boiled rice"),
("挽", "バン", "ひ.く", "saw, turn (lathe), grind"),
("晩", "バン", "", "nightfall, night"),
("番", "バン", "つが.い", "turn, number in a series"),
("盤", "バン", "", "tray, shallow bowl, platter, tub, board, phonograph record"),
("磐", "バン, ハン", "いわ", "rock, crag, cliff, wall (in a mine)"),
("蕃", "バン, ハン", "", "grow luxuriously"),
("蛮", "バン", "えびす", "barbarian"),
("匪", "ヒ", "あら.ず, かたみ", "negation, wicked person"),
("卑", "ヒ", "いや.しい, いや.しむ, いや.しめる", "lowly, base, vile, vulgar"),
("否", "ヒ", "いな, いや", "negate, no, noes, refuse, decline, deny"),
("妃", "ヒ", "きさき", "queen, princess"),
("庇", "ヒ", "ひさし, おお.う, かば.う", "protect, shield, defend, eaves, canopy, penthouse, visor"),
("彼", "ヒ", "かれ, かの, か.の", "he, that, the"),
("悲", "ヒ", "かな.しい, かな.しむ", "grieve, sad, deplore, regret"),
("扉", "ヒ", "とびら", "front door, title page, front page"),
("批", "ヒ", "", "criticism, strike"),
("披", "ヒ", "", "expose, open"),
("斐", "ヒ, イ", "", "beautiful, patterned"),
("比", "ヒ", "くら.べる", "compare, race, ratio, Philippines"),
("泌", "ヒツ, ヒ", "", "ooze, flow, soak in, penetrate, secrete"),
...
("肥", "ヒ", "こ.える, こえ, こ.やす, こ.やし, ふと.る", "fertilizer, get fat, fertile, manure, pamper"),
("被", "ヒ", "こうむ.る, おお.う, かぶ.る, かぶ.せる", "incur, cover, veil, brood over, shelter, wear, put on, be exposed (film), receiving"),
("誹", "ヒ, ハイ", "そし.る", "ridicule, slander"),
("費", "ヒ", "つい.やす, つい.える", "expense, cost, spend, consume, waste"),
("避", "ヒ", "さ.ける, よ.ける", "evade, avoid, avert, ward off, shirk, shun"),
("非", "ヒ", "あら.ず", "un-, mistake, negative, injustice, non-"),
("飛", "ヒ", "と.ぶ, と.ばす, -と.ばす", "fly, skip (pages), scatter"),
("樋", "トウ", "ひ, とい", "water pipe, gutter, downspout, conduit"),
("簸", "ハ", "ひ.る", "winnow, fan"),
("備", "ビ", "そな.える, そな.わる, つぶさ.に", "equip, provision, preparation"),
("尾", "ビ", "お", "tail, end, counter for fish, lower slope of mountain"),
("微", "ビ", "かす.か", "delicate, minuteness, insignificance"),
("枇", "ビ, ヒ", "", "loquat, spoon"),
("毘", "ヒ, ビ", "たす.ける", "help, assist"),
("琵", "ビ, ヒ", "", "glissando on strings, lute"),
("眉", "ビ, ミ", "まゆ", "eyebrow"),
("美", "ビ, ミ", "うつく.しい", "beauty, beautiful"),
("鼻", "ビ", "はな", "nose, snout"),
("柊", "シュ, シュウ", "ひいらぎ", "holly"),
("稗", "ハイ, ヒ", "ひえ", "humble, deccan grass"),
("匹", "ヒツ", "ひき", "equal, head, counter for small animals, roll of cloth"),
("疋", "ヒキ, ショ, ソ, ヒツ", "あし", "head, counter for animals"),
("髭", "シ", "ひげ, くちひげ", "beard, mustache"),
("彦", "ゲン", "ひこ", "lad, boy (ancient)"),
("膝", "シツ", "ひざ", "knee, lap"),
("菱", "リョウ", "ひし", "diamond (shape), water chestnut, rhombus"),
("肘", "チュウ", "ひじ", "elbow, arm"),
("弼", "ヒツ", "たす.ける, ゆだめ", "help"),
("必", "ヒツ", "かなら.ず", "invariably, certain, inevitable"),
("畢", "ヒツ", "おわ.る, あみ, おわ.り, ことごとく", "the end, finish"),
("筆", "ヒツ", "ふで", "writing brush, writing, painting brush, handwriting"),
("逼", "フク, ヒツ, ヒョク, ヒキ", "せま.る, むかばき", "urge, force, imminent, spur on"),
("桧", "カイ", "ひのき, ひ", "Japanese cypress"),
("姫", "キ", "ひめ, ひめ-", "princess"),
("媛", "エン", "ひめ", "beautiful woman, princess"),
("紐", "チュウ, ジュウ", "ひも", "string, cord, braid, lace, tape, strap, ribbon"),
("百", "ヒャク, ビャク", "もも", "hundred"),
("謬", "ビュウ, ビョウ, ミュウ", "あやま.る", "mistake"),
("俵", "ヒョウ", "たわら", "bag, bale, sack, counter for bags"),
("彪", "ヒョウ, ヒュウ", "あや", "spotted, mottled, patterned, small tiger"),
("標", "ヒョウ", "しるべ, しるし", "signpost, seal, mark, stamp, imprint, symbol, emblem, trademark, evidence, souvenir, target"),
("氷", "ヒョウ", "こおり, ひ, こお.る", "icicle, ice, hail, freeze, congeal"),
("漂", "ヒョウ", "ただよ.う", "drift, float (on liquid)"),
("瓢", "ヒョウ", "ひさご, ふくべ", "gourd"),
("票", "ヒョウ", "", "ballot, label, ticket, sign"),
("表", "ヒョウ", "おもて, -おもて, あらわ.す, あらわ.れる, あら.わす", "surface, table, chart, diagram"),
("評", "ヒョウ", "", "evaluate, criticism, comment"),
("豹", "ヒョウ, ホウ", "", "leopard, panther"),
("廟", "ビョウ, ミョウ", "たまや, みたまや, やしろ", "mausoleum, shrine, palace"),
("描", "ビョウ", "えが.く, か.く", "sketch, compose, write, draw, paint"),
("病", "ビョウ, ヘイ", "や.む, -や.み, やまい", "ill, sick"),
("秒", "ビョウ", "", "second (1/60 minute)"),
("苗", "ビョウ, ミョウ", "なえ, なわ-", "seedling, sapling, shoot"),
("錨", "ビョウ, ミョウ", "いかり", "anchor, grapnel"),
("鋲", "", "びょう", "rivet, tack, thumbtack, (kokuji)"),
("蒜", "サン", "にんにく, ひる, のびる", "garlic"),
("蛭", "シツ, チツ", "ひる", "leech"),
("鰭", "キ, ギ", "ひれ", "fin"),
("品", "ヒン, ホン", "しな", "goods, refinement, dignity, article, counter for meal courses"),
("彬", "ヒン, フン", "うるわ.しい, あき.らか", "refined, gentle"),
("斌", "ヒン, フン", "うるわ.しい, あき.らか", "beautiful, harmony of appearance"),
("浜", "ヒン", "はま", "seacoast, beach, seashore"),
("瀕", "ヒン", "ほとり", "shore, brink, verge"),
("貧", "ヒン, ビン", "まず.しい", "poverty, poor"),
("賓", "ヒン", "", "V.I.P., guest"),
("頻", "ヒン", "しき.りに", "repeatedly, recur"),
("敏", "ビン", "さとい", "cleverness, agile, alert"),
("瓶", "ビン", "かめ, へい", "bottle, vial, jar, jug, vat, urn"),
("不", "フ, ブ", "", "negative, non-, bad, ugly, clumsy"),
("付", "フ", "つ.ける, -つ.ける, -づ.ける, つ.け, つ.け-, -つ.け, -づ.け, -づけ, つ.く, -づ.く, つ.き, -つ.き, -つき, -づ.き, -づき", "adhere, attach, refer to, append"),
("埠", "フ, ホ", "つか, はとば", "wharf"),
("夫", "フ, フウ, ブ", "おっと, それ", "husband, man"),
("婦", "フ", "よめ", "lady, woman, wife, bride"),
("富", "フ, フウ", "と.む, とみ", "wealth, enrich, abundant"),
("冨", "フ, フウ", "と.む, とみ", "enrich, wealthy, abundant"),
("布", "フ, ホ", "ぬの, し.く, きれ", "linen, cloth, spread, distribute"),
("府", "フ", "", "borough, urban prefecture, govt office, representative body, storehouse"),
("怖", "フ, ホ", "こわ.い, こわ.がる, お.じる, おそ.れる", "dreadful, be frightened, fearful"),
("扶", "フ", "たす.ける", "aid, help, assist"),
("敷", "フ", "し.く, -し.き", "spread, pave, sit, promulgate"),
("斧", "フ", "おの", "ax, hatchet"),
("普", "フ", "あまね.く, あまねし", "universal, wide(ly), generally, Prussia"),
("浮", "フ", "う.く, う.かれる, う.かぶ, う.かべる", "floating, float, rise to surface"),
("父", "フ", "ちち", "father"),
...
("負", "フ", "ま.ける, ま.かす, お.う", "defeat, negative, -, minus, bear, owe, assume a responsibility"),
("賦", "フ, ブ", "", "levy, ode, prose, poem, tribute, installment"),
("赴", "フ", "おもむ.く", "proceed, get, become, tend"),
("阜", "フ, フウ", "", "hill, mound, left village radical (no. 170)"),
("附", "フ", "つ.ける, つ.く", "affixed, attach, refer to, append"),
("侮", "ブ", "あなど.る, あなず.る", "scorn, despise, make light of, contempt"),
("撫", "ブ, フ", "な.でる", "stroke, pat, smooth down"),
("武", "ブ, ム", "たけ, たけ.し", "warrior, military, chivalry, arms"),
("舞", "ブ", "ま.う, -ま.う, まい", "dance, flit, circle, wheel"),
("葡", "ブ, ホ", "", "wild grape, Portugal"),
("蕪", "ブ, ム", "かぶ, かぶら, あれる", "turnip"),
("部", "ブ", "-べ", "section, bureau, dept, class, copy, part, portion, counter for copies of a newspaper or magazine"),
("封", "フウ, ホウ", "", "seal, closing"),
("楓", "フウ", "かえで", "maple"),
("風", "フウ, フ", "かぜ, かざ-", "wind, air, style, manner"),
("葺", "シュウ", "あし, ふ.く, ふき", "thatch, cover, shingle, tile"),
("蕗", "ロ, ル", "ふき", "butterbur, bog rhubarb"),
("伏", "フク", "ふ.せる, ふ.す", "prostrated, bend down, bow, cover, lay (pipes)"),
("副", "フク", "", "vice-, assistant, aide, duplicate, copy"),
...
("腹", "フク", "はら", "abdomen, belly, stomach"),
("複", "フク", "", "duplicate, double, compound, multiple"),
("覆", "フク", "おお.う, くつがえ.す, くつがえ.る", "capsize, cover, shade, mantle, be ruined"),
("淵", "エン, カク, コウ", "ふち, かた.い, はなわ", "abyss, edge, deep pool, the depths"),
("弗", "フツ, ホチ", "どる, ず", "dollar"),
("払", "フツ, ヒツ, ホツ", "はら.う, -はら.い, -ばら.い", "pay, clear out, prune, banish, dispose of"),
("沸", "フツ", "わ.く, わ.かす", "seethe, boil, ferment, uproar, breed"),
("仏", "ブツ, フツ", "ほとけ", "Buddha, the dead, France"),
("物", "ブツ, モツ", "もの, もの-", "thing, object, matter"),
("鮒", "ホ, フ, ブ", "ふな", "carp"),
("分", "ブン, フン, ブ", "わ.ける, わ.け, わ.かれる, わ.かる, わ.かつ", "part, minute of time, segment, share, degree, one's lot, duty, understand, know, rate, 1%, chances, shaku/100"),
("吻", "フン, ブン", "くちわき, くちさき", "proboscis"),
("噴", "フン", "ふ.く", "erupt, spout, emit, flush out"),
("墳", "フン", "", "tomb, mound"),
("憤", "フン", "いきどお.る", "aroused, resent, be indignant, anger"),
("扮", "フン, ハン, ヘン", "ふん.する, やつ.す, よそお.う", "impersonate, dress up, disguise, thin shingles"),
("焚", "フン, ホン, ハン", "た.く, や.く, やきがり", "burn, kindle, build a fire, boil, cook"),
("奮", "フン", "ふる.う", "stirred up, be invigorated, flourish"),
("粉", "フン", "デシメートル, こ, こな", "flour, powder, dust"),
("糞", "フン", "くそ", "shit, feces, excrement"),
("紛", "フン", "まぎ.れる, -まぎ.れ, まぎ.らす, まぎ.らわす, まぎ.らわしい", "distract, be mistaken for, go astray, divert"),
("雰", "フン", "", "atmosphere, fog"),
("文", "ブン, モン", "ふみ, あや", "sentence, literature, style, art, decoration, figures, plan, literary radical (no. 67)"),
("聞", "ブン, モン", "き.く, き.こえる", "hear, ask, listen"),
("丙", "ヘイ", "ひのえ", "third class, 3rd, 3rd calendar sign"),
("併", "ヘイ", "あわ.せる", "join, get together, unite, collective"),
("兵", "ヘイ, ヒョウ", "つわもの", "soldier, private, troops, army, warfare, strategy, tactics"),
("塀", "ヘイ, ベイ", "", "fence, wall, (kokuji)"),
("幣", "ヘイ", "ぬさ", "cash, bad habit, humble prefix, gift, Shinto offerings of cloth, rope, cut paper"),
("平", "ヘイ, ビョウ, ヒョウ", "たい.ら, たい.らげる, ひら", "even, flat, peace"),
("弊", "ヘイ", "", "abuse, evil, vice, breakage"),
("柄", "ヘイ", "がら, え, つか", "design, pattern, build, nature, character, handle, crank, grip, knob, shaft"),
("並", "ヘイ, ホウ", "な.み, なみ, なら.べる, なら.ぶ, なら.びに", "row, and, besides, as well as, line up, rank with, rival, equal"),
("蔽", "ヘイ, ヘツ, フツ", "おお.う, おお.い", "cover, shade, mantle, capsize, be ruined"),
("閉", "ヘイ", "と.じる, と.ざす, し.める, し.まる, た.てる", "closed, shut"),
("陛", "ヘイ", "", "highness, steps (of throne)"),
("米", "ベイ, マイ, メエトル", "こめ, よね", "rice, USA, metre"),
("頁", "ケツ", "ぺえじ, おおがい, かしら", "page, leaf"),
("僻", "ヘキ, ヒ, ヘイ", "へき.する, ひが.む", "prejudice, bias, rural area"),
("壁", "ヘキ", "かべ", "wall, lining (stomach), fence"),
("癖", "ヘキ", "くせ, くせ.に", "mannerism, habit, vice, trait, fault, kink"),
("碧", "ヘキ, ヒャク", "", "blue, green"),
("別", "ベツ", "わか.れる, わ.ける", "separate, branch off, diverge, fork, another, extra, specially"),
("瞥", "ベツ, ヘツ", "", "glance at"),
("蔑", "ベツ", "ないがしろ, なみ.する, くらい, さげす.む", "ignore, despise, neglect, ridicule"),
("箆", "ヘイ, ハイ", "へら, の, くし", "spatula, arrow shaft"),
("偏", "ヘン", "かたよ.る", "partial, side, left-side radical, inclining, biased"),
("変", "ヘン", "か.わる, か.わり, か.える", "unusual, change, strange"),
("片", "ヘン", "かた-, かた", "one-sided, leaf, sheet, right-side kata radical (no. 91)"),
("篇", "ヘン", "", "volume, chapter, book, editing, compilation"),
("編", "ヘン", "あ.む, -あ.み", "compilation, knit, plait, braid, twist, editing, completed poem, part of a book"),
("辺", "ヘン", "あた.り, ほと.り, -べ", "environs, boundary, border, vicinity"),
("返", "ヘン", "かえ.す, -かえ.す, かえ.る, -かえ.る", "return, answer, fade, repay"),
("遍", "ヘン", "あまね.く", "everywhere, times, widely, generally"),
("便", "ベン, ビン", "たよ.り", "convenience, facility, excrement, feces, letter, chance"),
("勉", "ベン", "つと.める", "exertion, endeavour, encourage, strive, make effort, diligent"),
("娩", "ベン", "", "bear (children)"),
("弁", "ベン, ヘン", "かんむり, わきま.える, わ.ける, はなびら, あらそ.う", "valve, petal, braid, speech, dialect, discrimination, dispose of, distinguish, conical cap"),
("鞭", "ベン, ヘン", "むち, むちうつ", "whip, rod, counter for whippings"),
("保", "ホ, ホウ", "たも.つ", "protect, guarantee, keep, preserve, sustain, support"),
("舗", "ホ", "", "shop, store, pave"),
("鋪", "ホ, フ", "しく, みせ", "shop, store"),
("圃", "ホ, フ", "はたけ, にわ", "garden, field"),
("捕", "ホ", "と.らえる, と.らわれる, と.る, とら.える, とら.われる, つか.まえる, つか.まる", "catch, capture"),
("歩", "ホ, ブ, フ", "ある.く, あゆ.む", "walk, counter for steps"),
("甫", "ホ, フ", "はじ.めて", "for the first time, not until"),
("補", "ホ", "おぎな.う", "supplement, supply, make good, offset, compensate, assistant, learner"),
("輔", "ホ, フ", "たす.ける", "help"),
("穂", "スイ", "ほ", "ear, ear (grain), head, crest (wave)"),
...
("暮", "ボ", "く.れる, く.らす", "evening, twilight, season's end, livelihood, make a living, spend time"),
("母", "ボ", "はは, も", "mother"),
("簿", "ボ", "", "register, record book"),
("菩", "ボ", "", "kind of grass, sacred tree"),
("倣", "ホウ", "なら.う", "emulate, imitate"),
("俸", "ホウ", "", "stipend, salary"),
("包", "ホウ", "つつ.む, くる.む", "wrap, pack up, cover, conceal"),
("呆", "ホウ", "ほけ.る, ぼ.ける, あき.れる, おろか", "be amazed, disgusted, shocked"),
("報", "ホウ", "むく.いる", "report, news, reward, retribution"),
("奉", "ホウ, ブ", "たてまつ.る, まつ.る, ほう.ずる", "observance, offer, present, dedicate"),
("宝", "ホウ", "たから", "treasure, wealth, valuables"),
("峰", "ホウ", "みね, ね", "summit, peak"),
("峯", "ホウ", "みね, ね", "peak, summit"),
("崩", "ホウ", "くず.れる, -くず.れ, くず.す", "crumble, die, demolish, level"),
("庖", "ホウ", "くりや", "kitchen"),
("抱", "ホウ", "だ.く, いだ.く, かか.える", "embrace, hug, hold in arms"),
("捧", "ホウ", "ささ.げる", "lift up, give, offer, consecrate, sacrifice, dedicate"),
("放", "ホウ", "はな.す, -っぱな.し, はな.つ, はな.れる, こ.く, ほう.る", "set free, release, fire, shoot, emit, banish, liberate"),
("方", "ホウ", "かた, -かた, -がた", "direction, person, alternative"),
("朋", "ホウ", "とも", "companion, friend"),
("法", "ホウ, ハッ, ホッ, フラン", "のり", "method, law, rule, principle, model, system"),
("泡", "ホウ", "あわ", "bubbles, foam, suds, froth"),
("烹", "ホウ", "に.る", "boil, cook"),
("砲", "ホウ", "", "cannon, gun"),
("縫", "ホウ", "ぬ.う", "sew, stitch, embroider"),
("胞", "ホウ", "", "placenta, sac, sheath"),
("芳", "ホウ", "かんば.しい", "perfume, balmy, favorable, fragrant"),
("萌", "ホウ", "も.える, きざ.す, めばえ, きざ.し", "show symptoms of, sprout, bud, malt"),
("蓬", "ホウ, ブ", "よもぎ", "sagebrush, wormwood, mugwort"),
("蜂", "ホウ", "はち", "bee, wasp, hornet"),
("褒", "ホウ", "ほ.める", "praise, extol"),
("訪", "ホウ", "おとず.れる, たず.ねる, と.う", "call on, visit, look up, offer sympathy"),
("豊", "ホウ, ブ", "ゆた.か, とよ", "bountiful, excellent, rich"),
("邦", "ホウ", "くに", "home country, country, Japan"),
("鋒", "ホウ", "きっさき, とかり, ほこさき", "dagger, sword's point, festival car, float"),
("飽", "ホウ", "あ.きる, あ.かす, あ.く", "sated, tired of, bored, satiate"),
("鳳", "ホウ, フウ", "", "male mythical bird"),
("鵬", "ホウ", "おおとり", "phoenix"),
("乏", "ボウ", "とぼ.しい, とも.しい", "destitution, scarce, limited"),
("亡", "ボウ, モウ", "な.い, な.き-, ほろ.びる, ほろ.ぶ, ほろ.ぼす", "deceased, the late, dying, perish"),
("傍", "ボウ", "かたわ.ら, わき, おか-, はた, そば", "bystander, side, besides, while, nearby, third person"),
("剖", "ボウ", "", "divide"),
("坊", "ボウ, ボッ", "", "boy, priest's residence, priest"),
("妨", "ボウ", "さまた.げる", "disturb, prevent, hamper, obstruct"),
("帽", "ボウ, モウ", "ずきん, おお.う", "cap, headgear"),
("忘", "ボウ", "わす.れる", "forget"),
("忙", "ボウ, モウ", "いそが.しい, せわ.しい, おそ.れる, うれえるさま", "busy, occupied, restless"),
("房", "ボウ", "ふさ", "tassel, tuft, fringe, bunch, lock (hair), segment (orange), house, room"),
("暴", "ボウ, バク", "あば.く, あば.れる", "outburst, rave, fret, force, violence, cruelty, outrage"),
("望", "ボウ, モウ", "のぞ.む, もち", "ambition, full moon, hope, desire, aspire to, expect"),
("某", "ボウ", "それがし, なにがし", "so-and-so, one, a certain, that person"),
...
("貌", "ボウ, バク", "かたち, かたどる", "form, appearance, countenance"),
("貿", "ボウ", "", "trade, exchange"),
("鉾", "ボウ, ム", "ほこ", "halberd, arms, festival float"),
("防", "ボウ", "ふせ.ぐ", "ward off, defend, protect, resist"),
("吠", "ハイ, ベイ", "ほえ.る, ほ.える", "bark, howl, cry"),
("頬", "キョウ", "ほお, ほほ", "cheeks, jaw"),
("北", "ホク", "きた", "north"),
("僕", "ボク", "しもべ", "me, I (male), servant, manservant"),
("卜", "ボク", "うらな.う, うらない", "divining, fortune-telling, divination or katakana to radical (no. 25)"),
("墨", "ボク", "すみ", "black ink, India ink, ink stick, Mexico"),
("撲", "ボク", "", "slap, strike, hit, beat, tell, speak"),
("朴", "ボク", "ほう, ほお, えのき", "crude, simple, plain, docile"),
("牧", "ボク", "まき", "breed, care for, shepherd, feed, pasture"),
("睦", "ボク, モク", "むつ.まじい, むつ.む, むつ.ぶ", "intimate, friendly, harmonious"),
("穆", "ボク, モク", "やわ.らぐ", "respectful, mild, beautiful"),
("釦", "コウ, ク", "ぼたん", "button"),
("勃", "ボツ, ホツ", "おこ.る, にわかに", "suddenness, rise"),
("没", "ボツ, モツ", "おぼ.れる, しず.む, ない", "drown, sink, hide, fall into, disappear, die"),
("殆", "タイ, サイ", "ほとほと, ほとん.ど, あやうい", "almost, quite, really"),
("堀", "クツ", "ほり", "ditch, moat, canal"),
("幌", "コウ", "ほろ, とばり", "canopy, awning, hood, curtain"),
("奔", "ホン", "はし.る", "run, bustle"),
("本", "ホン", "もと", "book, present, main, origin, true, real, counter for long cylindrical things"),
("翻", "ホン, ハン", "ひるがえ.る, ひるがえ.す", "flip, turn over, wave, flutter, change (mind)"),
("凡", "ボン, ハン", "およ.そ, おうよ.そ, すべ.て", "commonplace, ordinary, mediocre"),
("盆", "ボン", "", "basin, lantern festival, tray"),
("摩", "マ", "ま.する, さす.る, す.る", "chafe, rub, polish, grind, scrape"),
("磨", "マ", "みが.く, す.る", "grind, polish, scour, improve, brush (teeth)"),
("魔", "マ", "", "witch, demon, evil spirit"),
("麻", "マ, マア", "あさ", "hemp, flax, numb"),
("埋", "マイ", "う.める, う.まる, う.もれる, うず.める, うず.まる, い.ける", "bury, be filled up, embedded"),
("妹", "マイ", "いもうと", "younger sister"),
("昧", "マイ, バイ", "くら.い, むさぼ.る", "dark, foolish"),
("枚", "マイ, バイ", "", "sheet of..., counter for flat thin objects or sheets"),
("毎", "マイ", "ごと, -ごと.に", "every"),
("哩", "リ", "まいる", "mile"),
("槙", "テン, シン", "まき, こずえ", "twig, ornamental evergreen"),
("幕", "マク, バク", "とばり", "curtain, bunting, act of play"),
("膜", "マク", "", "membrane"),
("枕", "チン, シン", "まくら", "pillow"),
("鮪", "キ, ユウ, イ", "まぐろ, しび", "tuna"),
("柾", "", "まさ, まさめ, まさき", "straight grain, spindle tree, (kokuji)"),
("鱒", "ソン, セン, ザン", "ます", "salmon trout"),
("桝", "", "ます", "measuring box, (kokuji)"),
("亦", "エキ, ヤク", "また", "also, again"),
("俣", "", "また", "crotch, thigh, groin, fork, junction, (kokuji)"),
("又", "ユウ", "また, また-, また.の-", "or again, furthermore, on the other hand"),
("抹", "マツ", "", "rub, paint, erase"),
("末", "マツ, バツ", "すえ, うら, うれ", "end, close, tip, powder, posterity"),
("沫", "マツ, バツ", "あわ, しぶき, つばき", "splash, suds"),
("迄", "キツ", "まで, およ.ぶ", "until, up to, as far as, to the extent"),
("侭", "ジン", "まま, ことごとく", "as it is, because"),
("繭", "ケン", "まゆ, きぬ", "cocoon"),
("麿", "", "まろ", "I, you, (kokuji)"),
("万", "マン, バン", "よろず", "ten thousand, 10,000"),
("慢", "マン", "", "ridicule, laziness"),
("満", "マン, バン", "み.ちる, み.つ, み.たす", "full, fullness, enough, satisfy"),
("漫", "マン", "みだり.に, そぞ.ろ", "cartoon, involuntarily, unrestrained, in spite of oneself, corrupt"),
("蔓", "マン, バン", "はびこ.る, つる", "vine, tendril, influence, connections, good offices, spread, sprawl, thrive, rampant, powerful"),
("味", "ミ", "あじ, あじ.わう", "flavor, taste"),
("未", "ミ, ビ", "いま.だ, ま.だ, ひつじ", "un-, not yet, hitherto, still, even now, sign of the ram, 1-3PM, eighth sign of Chinese zodiac"),
("魅", "ミ", "", "fascination, charm, bewitch"),
("巳", "シ", "み", "sign of the snake or serpent, 9-11AM, sixth sign of Chinese zodiac"),
("箕", "キ", "み", "winnowing"),
("岬", "コウ", "みさき", "headland, cape, spit, promontory"),
("密", "ミツ", "ひそ.か", "secrecy, density (pop), minuteness, carefulness"),
("蜜", "ミツ, ビツ", "", "honey, nectar, molasses"),
("湊", "ソウ", "みなと, あつ.まる", "port, harbor"),
("蓑", "サ, サイ", "みの", "straw raincoat"),
("稔", "ネン, ジン, ニン", "みの.る, みのり", "harvest, ripen"),
("脈", "ミャク", "すじ", "vein, pulse, hope"),
("妙", "ミョウ, ビョウ", "たえ", "exquisite, strange, queer, mystery, miracle, excellent, delicate, charming"),
("粍", "", "ミリ, ミリメートル", "millimeter, (kokuji)"),
("民", "ミン", "たみ", "people, nation, subjects"),
("眠", "ミン", "ねむ.る, ねむ.い", "sleep, die, sleepy"),
("務", "ム", "つと.める", "task, duties"),
("夢", "ム, ボウ", "ゆめ, ゆめ.みる, くら.い", "dream, vision, illusion"),
("無", "ム, ブ", "な.い", "nothingness, none, ain't, nothing, nil, not"),
("牟", "ボウ, ム", "", "pupil (eye), moo (cow sound)"),
("矛", "ム, ボウ", "ほこ", "halberd, arms, festival float"),
("霧", "ム, ボウ, ブ", "きり", "fog, mist"),
("鵡", "ブ, ム", "", "cockatoo"),
("椋", "リョウ", "むく", "type of deciduous tree, grey starling"),
("婿", "セイ", "むこ", "bridegroom, son-in-law"),
("娘", "ジョウ", "むすめ, こ", "daughter, girl"),
("冥", "メイ, ミョウ", "くら.い", "dark"),
("名", "メイ, ミョウ", "な, -な", "name, noted, distinguished, reputation"),
("命", "メイ, ミョウ", "いのち", "fate, command, decree, destiny, life, appoint"),
("明", "メイ, ミョウ, ミン", "あ.かり, あか.るい, あか.るむ, あか.らむ, あき.らか, あ.ける, -あ.け, あ.く, あ.くる, あ.かす", "bright, light"),
("盟", "メイ", "", "alliance, oath"),
("迷", "メイ", "まよ.う", "astray, be perplexed, in doubt, lost, err, illusion"),
("銘", "メイ", "", "inscription, signature (of artisan)"),
("鳴", "メイ", "な.く, な.る, な.らす", "chirp, cry, bark, sound, ring, echo, honk"),
("姪", "テツ, チツ, ジチ, イツ, イチ", "めい, おい", "niece"),
("牝", "ヒン", "めす, め-, めん", "female"),
("滅", "メツ", "ほろ.びる, ほろ.ぶ, ほろ.ぼす", "destroy, ruin, overthrow, perish"),
("免", "メン", "まぬか.れる, まぬが.れる", "excuse, dismissal"),
("棉", "メン", "わた", "cotton"),
("綿", "メン", "わた", "cotton"),
("緬", "メン, ベン", "", "fine thread, Burma"),
("面", "メン, ベン", "おも, おもて, つら", "mask, face, features, surface"),
("麺", "メン, ベン", "むぎこ", "noodles, wheat flour"),
("摸", "モ, モウ, バク, ボ, マク", "", "search, imitate, copy"),
("模", "モ, ボ", "", "imitation, copy, mock"),
("茂", "モ", "しげ.る", "overgrown, grow thick, be luxuriant"),
("妄", "モウ, ボウ", "みだ.りに", "delusion, unnecessarily, without authority, reckless"),
("孟", "モウ, ボウ, ミョウ", "かしら", "chief, beginning"),
("毛", "モウ", "け", "fur, hair, feather, down"),
("猛", "モウ", "", "fierce, rave, rush, become furious, wildness, strength"),
("盲", "モウ", "めくら", "blind, blind man, ignoramus"),
("網", "モウ", "あみ", "netting, network"),
("耗", "モウ, コウ", "", "decrease"),
("蒙", "モウ, ボウ", "こうむ.る, おお.う, くら.い", "ignorance, darkness, get, receive, be subjected to, sustain, Mongolia"),
("儲", "チョ", "もう.ける, もう.かる, もうけ, たくわ.える", "be profitable, yield profit"),
...
("勿", "モチ, ブツ, ボツ", "なか.れ, なし", "not, must not, do not, be not"),
("餅", "ヘイ, ヒョウ", "もち, もちい", "mochi rice cake"),
("尤", "ユウ", "もっと.も, とが.める", "reasonable, just, natural, superb, outstanding, plausible"),
("戻", "レイ", "もど.す, もど.る", "re-, return, revert, resume, restore, go backwards"),
("籾", "", "もみ", "unhulled rice, (kokuji)"),
("貰", "セイ, シャ", "もら.う", "get, have, obtain"),
("問", "モン", "と.う, と.い, とん", "question, ask, problem"),
("悶", "モン", "もだ.える, もだえ.る", "be in agony, worry"),
("紋", "モン", "", "family crest, figures"),
("門", "モン", "かど, と", "gate, counter for cannons"),
("匁", "", "もんめ, め", "monme, 3.75 grams, (kokuji)"),
("也", "ヤ, エ", "なり, か, また", "to be (classical)"),
("冶", "ヤ", "い.る", "melting, smelting"),
("夜", "ヤ", "よ, よる", "night, evening"),
("爺", "ヤ", "じい, じじい, おやじ, じじ, ちち", "old man, grampa"),
("耶", "ヤ, ジャ", "か", "question mark"),
("野", "ヤ, ショ", "の, の-", "plains, field, rustic, civilian life"),
("弥", "ミ, ビ", "や, いや, いよ.いよ, わた.る", "all the more, increasingly"),
("矢", "シ", "や", "dart, arrow"),
("厄", "ヤク", "", "unlucky, misfortune, bad luck, disaster"),
("役", "ヤク, エキ", "", "duty, war, campaign, drafted labor, office, service, role"),
("約", "ヤク", "つづ.まる, つづ.める, つづま.やか", "promise, approximately, shrink"),
("薬", "ヤク", "くすり", "medicine, chemical, enamel, gunpowder, benefit"),
("訳", "ヤク", "わけ", "translate, reason, circumstance, case"),
("躍", "ヤク", "おど.る", "leap, dance, skip"),
("靖", "セイ, ジョウ", "やす.んじる", "peaceful"),
("柳", "リュウ", "やなぎ", "willow"),
("薮", "ソウ", "やぶ", "thicket, bush, underbrush, grove"),
("鑓", "", "やり", "spear, javelin, (kokuji)"),
("愉", "ユ", "たの.しい, たの.しむ", "pleasure, happy, rejoice"),
("愈", "ユ", "いよいよ, まさ.る", "be superior, heal, more and more, increasingly, finally, beyond doubt"),
("油", "ユ, ユウ", "あぶら", "oil, fat"),
("癒", "ユ", "い.える, いや.す, い.やす", "healing, cure, quench (thirst), wreak"),
("諭", "ユ", "さと.す", "rebuke, admonish, charge, warn, persuade"),
("輸", "ユ, シュ", "", "transport, send, be inferior"),
("唯", "ユイ, イ", "ただ", "solely, only, merely, simply"),
("佑", "ユウ, ウ", "たす.ける", "help, assist"),
("優", "ユウ, ウ", "やさ.しい, すぐ.れる, まさ.る", "tenderness, excel, surpass, actor, superiority, gentleness"),
("勇", "ユウ", "いさ.む", "courage, cheer up, be in high spirits, bravery, heroism"),
("友", "ユウ", "とも", "friend"),
("宥", "ユウ", "なだ.める, ゆる.す", "soothe, calm, pacify"),
("幽", "ユウ", "ふか.い, かす.か, くら.い, しろ.い", "seclude, confine to a room, deep, profound, secluded, faint, dark, tranquil, calm"),
("悠", "ユウ", "", "permanence, distant, long time, leisure"),
("憂", "ユウ", "うれ.える, うれ.い, う.い, う.き", "melancholy, grieve, lament, be anxious, sad, unhappy"),
("揖", "イツ, ユ, シュウ, ユウ", "", "bow with arms folded, come together, assemble"),
("有", "ユウ, ウ", "あ.る", "possess, have, exist, happen, occur, approx"),
("柚", "ユ, ユウ, ジク", "ゆず", "citron"),
("湧", "ユウ, ヨウ, ユ", "わ.く", "boil, ferment, seethe, uproar, breed"),
("涌", "ユウ, ヨウ, ユ", "わ.く", "boil, ferment, seethe, uproar, breed"),
("猶", "ユウ, ユ", "なお", "furthermore, still, yet"),
("猷", "ユウ, ヨウ", "はかりごと, はか.る", "plan, scheme, plot, way"),
("由", "ユ, ユウ, ユイ", "よし, よ.る", "wherefore, a reason"),
("祐", "ユウ, ウ", "たす.ける", "help"),
("裕", "ユウ", "", "abundant, rich, fertile"),
("誘", "ユウ", "さそ.う, いざな.う", "entice, lead, tempt, invite, ask, call for, seduce, allure"),
("遊", "ユウ, ユ", "あそ.ぶ, あそ.ばす", "play"),
("邑", "ユウ", "むら", "village, rural community, right village radical (no. 163)"),
("郵", "ユウ", "", "mail, stagecoach stop"),
("雄", "ユウ", "お-, おす, おん", "masculine, male, hero, leader, superiority, excellence"),
("融", "ユウ", "と.ける, と.かす", "dissolve, melt"),
("夕", "セキ", "ゆう", "evening"),
("予", "ヨ, シャ", "あらかじ.め", "beforehand, previous, myself, I"),
("余", "ヨ", "あま.る, あま.り, あま.す, あんま.り", "too much, myself, surplus, other, remainder"),
("与", "ヨ", "あた.える, あずか.る, くみ.する, ともに", "bestow, participate in, give, award, impart, provide, cause, gift, godsend"),
("誉", "ヨ", "ほま.れ, ほ.める", "reputation, praise, honor, glory"),
("輿", "ヨ", "かご, こし", "palanquin, bier, public opinion, the earth"),
("預", "ヨ", "あず.ける, あず.かる", "deposit, custody, leave with, entrust to"),
("傭", "ヨウ, チョウ", "やと.う, あた.い, ひと.しい", "employ, hire"),
("幼", "ヨウ", "おさな.い", "infancy, childhood"),
("妖", "ヨウ", "あや.しい, なま.めく, わざわ.い", "attractive, bewitching, calamity"),
("容", "ヨウ", "い.れる", "contain, form, looks"),
("庸", "ヨウ", "", "commonplace, ordinary, employment"),
("揚", "ヨウ", "あ.げる, -あ.げ, あ.がる", "raise, elevate, hoist, praise, extol, fry in deep fat"),
...
("洋", "ヨウ", "", "ocean, sea, foreign, Western style"),
("溶", "ヨウ", "と.ける, と.かす, と.く", "melt, dissolve, thaw"),
("熔", "ヨウ", "と.ける, と.かす, いがた", "fuse, melt"),
("用", "ヨウ", "もち.いる", "utilize, business, service, use, employ"),
("窯", "ヨウ", "かま", "kiln, oven, furnace"),
("羊", "ヨウ", "ひつじ", "sheep"),
("耀", "ヨウ", "かがや.く, ひかり", "shine, sparkle, gleam, twinkle"),
("葉", "ヨウ", "は", "leaf, plane, lobe, needle, blade, spear, counter for flat things, fragment, piece"),
("蓉", "ヨウ", "", "lotus"),
("要", "ヨウ", "い.る, かなめ", "need, main point, essence, pivot, key to"),
("謡", "ヨウ", "うた.い, うた.う", "song, sing, ballad, noh chanting"),
("踊", "ヨウ", "おど.る", "jump, dance, leap, skip"),
("遥", "ヨウ", "はる.か", "far off, distant, long ago"),
("陽", "ヨウ", "ひ", "sunshine, yang principle, positive, male, heaven, daytime"),
("養", "ヨウ, リョウ", "やしな.う", "foster, bring up, rear, develop, nurture"),
("慾", "ヨク", "", "covetousness, greed, passion, desire, craving"),
("抑", "ヨク", "おさ.える", "repress, well, now, in the first place, push, shove, press, seal, do in spite of"),
("欲", "ヨク", "ほっ.する, ほ.しい", "longing, covetousness, greed, passion, desire, craving"),
("沃", "ヨウ, ヨク, オク", "そそ.ぐ", "fertility"),
("浴", "ヨク", "あ.びる, あ.びせる", "bathe, be favored with, bask in"),
("翌", "ヨク", "", "the following, next"),
("翼", "ヨク", "つばさ", "wing, plane, flank"),
("淀", "テン, デン", "よど.む", "pool, eddy"),
("羅", "ラ", "うすもの", "gauze, thin silk, Rome, arrange, spread out"),
("螺", "ラ", "にし, にな", "small, edible, helical fresh-water mollusk"),
("裸", "ラ", "はだか", "naked, nude, uncovered, partially clothed"),
("来", "ライ, タイ", "く.る, きた.る, きた.す, き.たす, き.たる, き, こ", "come, due, next, cause, become"),
("莱", "ライ, リ", "あかざ, あわち, こうがい", "goosefoot, pigweed"),
("頼", "ライ", "たの.む, たの.もしい, たよ.る", "trust, request"),
("雷", "ライ", "かみなり, いかずち, いかづち", "thunder, lightning bolt"),
("洛", "ラク", "", "Kyoto, the capital"),
("絡", "ラク", "から.む, から.まる", "entwine, coil around, get caught in"),
("落", "ラク", "お.ちる, お.ち, お.とす", "fall, drop, come down, village, hamlet"),
("酪", "ラク", "", "dairy products, whey, broth, fruit juice"),
("乱", "ラン, ロン", "みだ.れる, みだ.る, みだ.す, みだ, おさ.める, わた.る", "riot, war, disorder, disturb"),
("卵", "ラン", "たまご", "egg, ovum, spawn, roe"),
("嵐", "ラン", "あらし", "storm, tempest"),
("欄", "ラン", "てすり", "column, handrail, blank, space"),
("濫", "ラン", "みだ.りに, みだ.りがましい", "excessive, overflow, spread out"),
("藍", "ラン", "あい", "indigo"),
("蘭", "ラン, ラ", "", "orchid, Holland"),
("覧", "ラン", "み.る", "perusal, see"),
("利", "リ", "き.く", "profit, advantage, benefit"),
("吏", "リ", "", "officer, an official"),
("履", "リ", "は.く", "perform, complete, footgear, shoes, boots, put on (the feet)"),
("李", "リ", "すもも", "plum"),
("梨", "リ", "なし", "pear tree"),
("理", "リ", "ことわり", "logic, arrangement, reason, justice, truth"),
("璃", "リ", "", "glassy, lapis lazuli"),
("痢", "リ", "", "diarrhea"),
("裏", "リ", "うら", "back, amidst, in, reverse, inside, palm, sole, rear, lining, wrong side"),
("裡", "リ", "うち, うら", "reverse, inside, palm, sole, rear, lining, wrong side"),
("里", "リ", "さと", "ri, village, parent's home, league"),
("離", "リ", "はな.れる, はな.す", "detach, separation, disjoin, digress"),
("陸", "リク, ロク", "おか", "land, six"),
("律", "リツ, リチ, レツ", "", "rhythm, law, regulation, gauge, control"),
("率", "ソツ, リツ, シュツ", "ひき.いる", "ratio, rate, proportion, %, factor, lead, spearhead, command"),
("立", "リツ, リュウ, リットル", "た.つ, -た.つ, た.ち-, た.てる, -た.てる, た.て-, たて-, -た.て, -だ.て, -だ.てる", "stand up, rise, set up, erect"),
("葎", "リツ", "むぐら", "creepers, trailing plants, vines"),
("掠", "リャク, リョウ", "かす.める, かす.る, かす.れる", "pillage, rob, graze, skim, sweep over, cheat, hint"),
("略", "リャク", "ほぼ, はぶ.く, おか.す, おさ.める, はかりごと, はか.る", "abbreviation, omission, outline, shorten, capture, plunder"),
("劉", "リュウ, ル", "ころ.す", "weapon of war, logging axe, kill en masse, peeling (paint off a wall, etc), sparse, faded"),
("流", "リュウ, ル", "なが.れる, なが.れ, なが.す, -なが.す", "current, a sink, flow, forfeit"),
("溜", "リュウ", "た.まる, たま.る, た.める, したた.る, たまり, ため", "collect, gather, be in arrears"),
("琉", "リュウ, ル", "", "precious stone, gem, lapis lazuli"),
("留", "リュウ, ル", "と.める, と.まる, とど.める, とど.まる, るうぶる", "detain, fasten, halt, stop"),
("硫", "リュウ", "", "sulphur"),
("粒", "リュウ", "つぶ", "grains, drop, counter for tiny particles"),
("隆", "リュウ", "", "hump, high, noble, prosperity"),
("竜", "リュウ, リョウ, ロウ", "たつ, いせ", "dragon, imperial"),
("龍", "リュウ, リョウ, ロウ", "たつ", "dragon, imperial"),
("侶", "リョ, ロ", "とも", "companion, follower"),
("慮", "リョ", "おもんぱく.る, おもんぱか.る", "prudence, thought, concern, consider, deliberate, fear"),
("旅", "リョ", "たび", "trip, travel"),
("虜", "リョ, ロ", "とりこ, とりく", "captive, barbarian, low epithet for the enemy"),
("了", "リョウ", "", "complete, finish"),
("亮", "リョウ", "あきらか", "clear, help"),
("僚", "リョウ", "", "colleague, official, companion"),
("両", "リョウ", "てる, ふたつ", "both, old Japanese coin, counter for carriages (e.g., in a train), two"),
("凌", "リョウ", "しの.ぐ", "endure, keep (rain)out, stave off, tide over, defy, slight, surpass"),
("寮", "リョウ", "", "dormitory, hostel, villa, tea pavillion"),
("料", "リョウ", "", "fee, materials"),
("梁", "リョウ", "はり, うつばり, うちばり, やな, はし", "weir, fish trap, beam, girder"),
("涼", "リョウ", "すず.しい, すず.む, すず.やか, うす.い, ひや.す, まことに", "refreshing, nice and cool"),
("猟", "リョウ", "かり, か.る", "game-hunting, shooting, game, bag"),
("療", "リョウ", "", "heal, cure"),
("瞭", "リョウ", "あきらか", "clear"),
("稜", "リョウ, ロウ", "いつ, かど", "angle, edge, corner, power, majesty"),
("糧", "リョウ, ロウ", "かて", "provisions, food, bread"),
("良", "リョウ", "よ.い, -よ.い, い.い, -い.い", "good, pleasing, skilled"),
("諒", "リョウ", "あきら.か, まことに", "fact, reality, understand, appreciate"),
("遼", "リョウ", "", "distant"),
("量", "リョウ", "はか.る", "quantity, measure, weight, amount, consider, estimate, surmise"),
("陵", "リョウ", "みささぎ", "mausoleum, imperial tomb, mound, hill"),
("領", "リョウ", "えり", "jurisdiction, dominion, territory, fief, reign"),
("力", "リョク, リキ, リイ", "ちから", "power, strength, strong, strain, bear up, exert"),
("緑", "リョク, ロク", "みどり", "green"),
("倫", "リン", "", "ethics, companion"),
("厘", "リン", "", "rin, 1/10 sen, 1/10 bu"),
("林", "リン", "はやし", "grove, forest"),
("淋", "リン", "さび.しい, さみ.しい", "lonely, deserted"),
("燐", "リン", "", "phosphorus"),
("琳", "リン", "", "jewel, tinkling of jewelry"),
("臨", "リン", "のぞ.む", "look to, face, meet, confront, attend, call on"),
("輪", "リン", "わ", "wheel, ring, circle, link, loop, counter for wheels and flowers"),
("隣", "リン", "とな.る, となり", "neighboring"),
("鱗", "リン", "うろこ, こけ, こけら", "scales (fish)"),
("麟", "リン", "", "Chinese unicorn, genius, giraffe, bright, shining"),
("瑠", "ル, リュウ", "", "lapis lazuli"),
("塁", "ルイ, ライ, スイ", "とりで", "bases, fort, rampart, walls, base(ball)"),
("涙", "ルイ, レイ", "なみだ", "tears, sympathy"),
("累", "ルイ", "", "accumulate, involvement, trouble, tie up, continually"),
("類", "ルイ", "たぐ.い", "sort, kind, variety, class, genus"),
("令", "レイ", "", "orders, laws, command, decree, good"),
("伶", "レイ, リョウ", "わざおぎ", "actor"),
("例", "レイ", "たと.える", "example, custom, usage, precedent"),
("冷", "レイ", "つめ.たい, ひ.える, ひ.や, ひ.ややか, ひ.やす, ひ.やかす, さ.める, さ.ます", "cool, cold (beer, person), chill"),
("励", "レイ", "はげ.む, はげ.ます", "encourage, be diligent, inspire"),
("嶺", "レイ, リョウ", "みね", "peak, summit"),
("怜", "レイ, レン, リョウ", "あわ.れむ, さと.い", "wise"),
("玲", "レイ", "", "sound of jewels"),
("礼", "レイ, ライ", "", "salute, bow, ceremony, thanks, remuneration"),
("苓", "レイ, リョウ", "みみなぐさ", "plant, herb, mushroom"),
("鈴", "レイ, リン", "すず", "small bell, buzzer"),
("隷", "レイ", "したが.う, しもべ", "slave, servant, prisoner, criminal, follower"),
("零", "レイ", "ぜろ, こぼ.す, こぼ.れる", "zero, spill, overflow, nothing, cipher"),
("霊", "レイ, リョウ", "たま", "spirits, soul"),
("麗", "レイ", "うるわ.しい, うら.らか", "lovely, beautiful, graceful, resplendent"),
("齢", "レイ", "よわい, とし", "age"),
("暦", "レキ, リャク", "こよみ", "calendar, almanac"),
("歴", "レキ, レッキ", "", "curriculum, continuation, passage of time"),
("列", "レツ, レ", "", "file, row, rank, tier, column"),
("劣", "レツ", "おと.る", "inferiority, be inferior to, be worse"),
("烈", "レツ", "はげ.しい", "ardent, violent, vehement, furious, severe, extreme"),
("裂", "レツ", "さ.く, さ.ける, -ぎ.れ", "split, rend, tear"),
("廉", "レン", "", "bargain, reason, charge, suspicion, point, account, purity, honest, low price, cheap, rested, contented, peaceful"),
("恋", "レン", "こ.う, こい, こい.しい", "romance, in love, yearn for, miss, darling"),
("憐", "レン", "あわ.れむ, あわ.れ", "pity, have mercy, sympathise, compassion"),
("漣", "レン, ラン", "さざなみ", "ripples"),
("煉", "レン", "ね.る", "refine metals, kneading over fire"),
("簾", "レン", "すだれ, す", "bamboo screen, rattan blind"),
("練", "レン", "ね.る, ね.り", "practice, gloss, train, drill, polish, refine"),
("聯", "レン", "つら.なる, つら.ねる", "party, gang, clique"),
("蓮", "レン", "はす, はちす", "lotus"),
("連", "レン", "つら.なる, つら.ねる, つ.れる, -づ.れ", "take along, lead, join, connect, party, gang, clique"),
("錬", "レン", "ね.る", "tempering, refine, drill, train, polish"),
("呂", "ロ, リョ", "せぼね", "spine, backbone"),
("魯", "ロ", "おろか", "foolish, Russia"),
("櫓", "ロ", "やぐら, おおだて", "oar, tower"),
("炉", "ロ", "いろり", "hearth, furnace, kiln, reactor"),
("賂", "ロ", "まいな.い, まいな.う", "bribe"),
("路", "ロ, ル", "-じ, みち", "path, route, road, distance"),
("露", "ロ, ロウ", "つゆ", "dew, tears, expose, Russia"),
("労", "ロウ", "ろう.する, いたわ.る, いた.ずき, ねぎら, つか.れる, ねぎら.う", "labor, thank for, reward for, toil, trouble"),
("婁", "ル, ロウ", "つな.ぐ, ひ.く", "frequently, tie"),
("廊", "ロウ", "", "corridor, hall, tower"),
("弄", "ロウ, ル", "いじく.る, ろう.する, いじ.る, ひねく.る, たわむ.れる, もてあそ.ぶ", "play with, tamper, trifle with"),
("朗", "ロウ", "ほが.らか, あき.らか", "melodious, clear, bright, serene, cheerful"),
("楼", "ロウ", "たかどの", "watchtower, lookout, high building"),
("榔", "ロウ", "", "betel palm tree"),
("浪", "ロウ", "", "wandering, waves, billows, reckless, unrestrained"),
("漏", "ロウ", "も.る, も.れる, も.らす", "leak, escape, time"),
("牢", "ロウ", "かた.い, ひとや", "prison, jail, hardness"),
("狼", "ロウ", "おおかみ", "wolf"),
("篭", "ロウ, ル", "かご, こ.める, こも.る, こ.む", "seclude oneself, cage, coop, implied"),
("老", "ロウ", "お.いる, ふ.ける", "old man, old age, grow old"),
("聾", "ロウ", "ろう.する, つんぼ, みみしい", "deafness, deaf person, deafen"),
("蝋", "ロウ", "みつろう, ろうそく", "wax"),
("郎", "ロウ, リョウ", "おとこ", "son, counter for sons"),
("六", "ロク, リク", "む, む.つ, むっ.つ, むい", "six"),
("麓", "ロク", "ふもと", "foot of a mountain"),
("禄", "ロク", "さいわ.い, ふち", "fief, allowance, pension, grant, happiness"),
("肋", "ロク", "あばら", "rib"),
("録", "ロク", "しる.す, と.る", "record"),
("論", "ロン", "あげつら.う", "argument, discourse"),
("倭", "ワ, イ", "やまと, したが.う", "Yamato, ancient Japan"),
("和", "ワ, オ, カ", "やわ.らぐ, やわ.らげる, なご.む, なご.やか, あ.える", "harmony, Japanese style, peace, soften, Japan"),
("話", "ワ", "はな.す, はなし", "tale, talk"),
("歪", "ワイ, エ", "いが.む, いびつ, ひず.む, ゆが.む", "warp, bend, strained, distort"),
("賄", "ワイ", "まかな.う", "bribe, board, supply, finance"),
("脇", "キョウ", "わき, わけ", "armpit, the other way, another place, flank, supporting role"),
...
("亘", "コウ, カン, セン", "わた.る, もと.める", "span, range, extend over"),
("鰐", "ガク", "わに", "alligator, crocodile"),
("詫", "タ", "わび, わび.しい, かこつ, わ.びる, わび.る", "apologize"),
("藁", "コウ", "わら", "straw"),
("蕨", "ケツ", "わらび", "bracken, fernbrake"),
("椀", "ワン", "はち", "wooden or lacquered bowl"),
("湾", "ワン", "いりえ", "gulf, bay, inlet"),
("碗", "ワン", "こばち", "porcelain bowl, tea cup"),
...
("仄", "ソク", "ほの.か, ほの-, ほの.めかす, ほの.めく, かたむ.く", "be seen dimly, suggest, intimate, faint, stupid, hint"),
...
("侑", "ユウ, ウ", "すす.める, たす.ける", "urge to eat"),
...
("匐", "ホク, フク", "", "crawl"),
("匏", "ホ, ホウ", "ひさご", "gourd"),
("匕", "ヒ", "さじ", "spoon, spoon or katakana hi radical (no. 21)"),
...
("咎", "キュウ, コウ", "とが.める, とが", "blame, censure, reprimand"),
...
("嘲", "チョウ, トウ", "あざけ.る", "ridicule, insult"),
...
("嚼", "シャク", "か.む", "bite"),
("囁", "ショウ", "ささや.く", "whisper, murmur"),
("囃", "サツ, ソウ", "はや.す, はやし", "play (music), accompany, beat time, banter, jeer, applaud"),
...
("毀", "キ", "こぼ.つ, こわ.す, こぼ.れる, こわ.れる, そし.る, やぶ.る", "break, destroy, censure, be chipped, be scratched, be broken, be ruined"),
...
("壥", "テン", "", "fine residence, shop, store, (phantom kanji)"),
...
("壽", "ジュ, ス, シュウ", "ことぶき, ことぶ.く, ことほ.ぐ", "longevity, congratulations"),
...
("夥", "カ, ワ", "おびただ.しい", "immense, tremendous"),
...
("岔", "タ", "", "fork in a road"),
("妛", "シ", "あなど.る, おろか, みにく.い, みだる", "despise, contempt, ugly, same as, (phantom kanji)"),
...
("崑", "コン", "", "place name"),
("崔", "ガイ, サイ, スイ", "がけ", "cliff, bluff, precipice"),
("崢", "ソウ", "", "high, steep"),
("崚", "リョウ", "", "mountains towering in a row"),
("崙", "ロン", "", "place name"),
("崘", "ロン", "", "Kunlun mountains in Jiangsu"),
("嵌", "カン", "は.める, は.まる, あな", "go into, plunge, inlay"),
("嵒", "ガン", "いわ, けわ.しい", "rock"),
...
("已", "イ", "や.む, すで.に, のみ, はなはだ", "stop, halt, previously, already, long ago"),
...
("廖", "リョウ", "", "empty, name"),
("廣", "コウ", "ひろ.い, ひろ.まる, ひろ.める, ひろ.がる, ひろ.げる", "broad, wide, spacious"),
("廝", "シ", "こもの", "servant"),
...
("彖", "タン", "", "divination"),
("彗", "スイ, エ, ケイ, セイ", "ほうき", "comet"),
("彙", "イ", "はりねずみ", "same kind, collect, classify, category, hedgehog"),
("彡", "サン, セン", "", "three, hair ornament, short hair or fur radical (no. 59)"),
("彭", "ホウ", "", "swelling, sound of drum"),
...
("惧", "ク, グ", "おそ.れる", "fear, be afraid of, dread"),
("悃", "コン", "まごころ", "sincerity"),
("悚", "ショウ", "おそ.れる", "fear"),
("悄", "ショウ", "うれ.える", "anxiety"),
("悛", "シュン, セン", "あらた.める", "amend"),
...
("憬", "ケイ", "あこが.れる", "yearn for, aspire to, admire"),
("憔", "ショウ, セウ, ソウ", "やつ.れる, やせ.る", "get thin"),
("憚", "タン, タ", "はばか.る", "hesitate, shrink, awe"),
("憊", "ハイ, ヘイ", "つか.れる", "fatigue"),
("憑", "ヒョウ", "つ.く, つか.れる, よ.る, たの.む", "depend, rely, evidence, proof, according to, possess, haunt"),
...
("懺", "ザン, サン", "くい.る", "regret, repent, confess sins"),
...
("抂", "キョウ, ゴウ", "", "disorder"),
("抉", "ケツ", "えぐ.る, こじ.る, くじ.る", "gouge, hollow out, bore, pry"),
("找", "ソウ", "", "look for, seek, make change"),
("抒", "ジョ, ショ", "く.む, の.べる", "tell, 10**24"),
...
("拇", "ボ", "おやゆび", "thumb"),
("抛", "ホウ", "なげう.つ", "hurl"),
("拉", "ラツ, ラ, ロウ", "らっ.する, ひし.ぐ, くだ.く", "Latin, kidnap, crush"),
("挌", "カク", "う.つ", "strike, hit, fight"),
("拮", "カツ, ケツ, キツ", "はたら.く", "be imminent"),
("拱", "キョウ, コウ", "こまぬ.く, こまね.く", "arch, fold arms"),
("挧", "ウ", "とち", "Japanese horse chestnut, (phantom kanji)"),
("挂", "ケイ, カイ, ケ", "か.ける", "hang"),
...
("搜", "ソウ, シュ, シュウ", "さが.す", "search, seek, investigate"),
("捏", "ネツ, テツ, ネチ", "こ.ねる, ね.る, つく.ねる", "knead, mix"),
...
("晰", "シャク, セキ", "あきらか", "clear"),
("暃", "ヒ", "", "be separated, (phantom kanji)"),
("暈", "ウン", "ぼか.す, ぼけ.る, かさ, くま, ぼかし, めまい", "halo, corona, fade"),
("暎", "エイ, ヨウ", "うつ.す, うつ.る, は.える", "sun beginning decline, reflect"),
("暉", "キ", "かが.やく", "shine, light"),
...
("曰", "エツ", "いわ.く, のたま.う, のたま.わく, ここに", "say, reason, pretext, history, past, flat sun radical (no. 73)"),
...
("梵", "ボン, フウ", "", "Sanskrit, purity, Buddhist"),
...
("椈", "キク", "", "oak"),
("棘", "キョク", "いばら, とげ", "thorn, splinter, spine, biting words, briers"),
("椢", "カイ", "そこ, はこ, くぬぎ", "bottom, box, type of oak tree"),
("椦", "ケン", "まげもの", "wickerwork, (phantom kanji)"),
("棡", "コウ", "", "mast crossbeam"),
...
("樒", "ミツ", "しきみ, じんこう", "tree whose branches are placed on Buddhist graves"),
...
("橸", "", "まさ", "straight grain"),
("橇", "キョウ, ゼイ, セイ", "そり, かんじき", "sled, sleigh, snowshoes"),
("橢", "ダ", "", "ellipse"),
...
("檄", "ケキ", "げき.する, ふれぶみ", "written appeal, manifesto"),
...
("鬱", "ウツ", "うっ.する, ふさ.ぐ, しげ.る", "gloom, depression, melancholy, luxuriant"),
...
("汪", "オウ", "", "flowing full, expanse of water, wide, deep"),
...
("滉", "コウ", "ひろ.い", "deep and broad (water)"),
...
("漿", "ショウ", "こんず", "a drink"),
("滲", "シン", "し.みる, にじ.む", "imbued with"),
("漱", "ソウ, シュウ, ス", "くちすす.ぐ, くちそそ.ぐ, うがい, すす.ぐ", "gargle, rinse mouth"),
...
("炒", "ソウ, ショウ", "い.る, いた.める", "broil, parch, roast, fry"),
("炯", "ケイ, キョウ", "あきらか", "light, clear"),
("烱", "ケイ, キョウ", "あきらか", "light, clear"),
("炬", "コ, キョ", "", "torch, signal fire"),
...
("烙", "ラク, カク", "や.く", "burn"),
("焉", "エン", "いずく.んぞ, ここに, これ", "how, why, then"),
("烽", "ホウ", "のろし, とぶひ", "signal fire"),
("焜", "コン", "かがや.く", "shine"),
("焙", "ホウ, ハイ", "ほう.じる, あぶ.る", "fire, roast"),
("煥", "カン", "あきらか", "shine"),
("煕", "キ", "たのし.む, ひか.る, ひろ.い, よろこ.ぶ, かわ.く, あきらか, ひろ.める, ひろ.まる", "shine"),
...
("狡", "コウ, キョウ", "ずる.い, こす.い, わるがしこ.い", "cunning, sly, crafty, miserly, mean, stingy"),
...
("猩", "ショウ, セイ, ソウ", "しょうじょう", "orangutan"),
("猥", "ワイ", "みだ.ら, みだり.に", "obscene"),
("猾", "カツ", "わるがしこ.い", "crafty"),
...
("珸", "ゴ", "", "jewel"),
("琲", "ハイ", "つらぬく", "string of many pearls"),
("琺", "ホウ", "", "enamel"),
...
("痰", "タン", "", "sputum, phlegm"),
("痺", "ヒ", "しび.れる", "palsy, become numb, paralysed"),
("痲", "マ, バ", "しび.れる", "measles, paralysis"),
("痳", "リン", "", "gonorrhea"),
("瘋", "フウ", "", "insanity, headache"),
("瘍", "ヨウ", "かさ", "swelling, boil, tumor"),
...
("眩", "ゲン, カン", "げん.す, くるめ.く, まぶ.しい, くら.む, まど.う, めま.い, まばゆ.い, くれ.る, ま.う", "faint, dizzy"),
("眤", "ケイ, ダイ", "てい, い", "glance at, gaze at"),
("眞", "シン", "ま, まこと", "truth, reality, Buddhist sect"),
...
("瞑", "メイ, ベン, ミョウ, ミン, メン", "めい.する, つぶ.る, つむ.る, くら.い", "sleep, dark, close eyes"),
...
("笏", "コツ", "しゃく", "mace, baton, scepter"),
("笊", "ソウ", "ざる, す", "bamboo basket"),
("笆", "ハ", "", "thorny bamboo, bamboo fence"),
("笳", "カ", "あしぶえ", "reed flute"),
("笘", "セン, チョウ", "", "whip, cane, wooden writing slate"),
("笙", "ショウ, ソウ", "ふえ", "a reed instrument"),
...
("箋", "セン", "ふだ", "paper, label, letter, composition"),
("箒", "ソウ, シュウ", "ほうき", "broom"),
("箏", "ソウ, ショウ", "こと", "a koto"),
("筝", "ソウ, ショウ", "こと", "koto"),
("箙", "フク", "えびら", "quiver"),
...
("紿", "タイ", "あざむ.く", "deceive"),
("紵", "チョ", "", "flax, linen"),
("絆", "ハン", "きずな, ほだ.す, つな.ぐ", "bonds, fetters"),
("絳", "コウ", "あか", "red"),
...
("羔", "コウ", "こひつじ", "lamb"),
("羞", "シュウ", "はじ.る, すすめ.る, は.ずかしい", "feel ashamed"),
...
("膀", "ボウ, ホウ", "", "bladder"),
("膂", "リョ, ロ", "せぼね", "backbone"),
("膠", "コウ, キョウ", "にかわ, にべ", "glue, isinglass"),
...
("芻", "スウ, シュウ, ス", "まぐさ", "grass cutting, hay"),
...
("萬", "マン, バン", "よろず", "ten thousand, 10,000"),
...
("蒡", "ボウ, ホウ", "", "burdock"),
("蔡", "サイ", "", "type of tortoise used for divination"),
("蓿", "シュク", "", "clover, medic"),
...
("蓼", "シン, リク, リョウ", "たで", "luxurious grass, a smartweed"),
("蕀", "キョク", "", "milwort"),
...
("薔", "バ, ショウ, ショク, ソウ", "みずたで", "water pepper"),
...
("蟐", "ジョウ", "もみ", "toad, mantis, (phantom kanji), (kokuji)"),
("雖", "スイ", "いえど.も, これ", "although, however"),
("螫", "セキ, カク", "さ.す", "bee sting"),
("蟄", "チツ, チュウ", "ちっ.する, かく.れる", "hibernation of insects"),
("螳", "トウ", "", "mantis"),
("蟇", "バ, マ", "ひき", "toad"),
("蟆", "バ, マ", "ひき", "toad"),
...
("袮", "デイ, ネ, チ", "", "ancestral shrine, embroidery, (phantom kanji)"),
...
("詢", "ジュン, シュン", "はか.る, まこと", "consult with"),
...
("諄", "シュン", "ひちくど.い, くど.い, くどくど, ねんご.ろ", "tedious"),
...
("謳", "オウ, ウ", "うた.う", "extol, declare, express"),
...
("貪", "タン, ドン, トン", "むさぼ.る", "covet, indulge in"),
...
("赳", "キュウ", "", "strong and brave"),
("趁", "チン", "お.う", "go to, follow"),
("趙", "チョウ, ジョウ, キョウ", "", "nimble, late-going"),
...
("踪", "ソウ, ショウ", "あと", "remains, clue, footprint"),
...
("辣", "ラツ", "から.い", "pungent, spicy, harsh, cruel, severe"),
...
("迪", "テキ", "みち, みちび.く, すす.む, いた.る", "edify, way, path"),
...
("逍", "ショウ", "", "saunter, loaf"),
("逞", "テイ", "たくま.しい", "sturdy, brawny, bold"),
("逖", "テキ", "とお.い", "far"),
("逋", "ホ, フ", "のが.れる", "flee"),
...
("鉈", "シャ", "なた, ほこ", "hatchet"),
("銕", "テツ", "くろがね", "iron, strong, solid, firm"),
...
("閠", "ケイ, ギョク, ジュン", "うるう", "intercalation, illegitimate throne, (phantom kanji)"),
("閨", "ケイ, ケ", "ねや", "bedroom"),
("閧", "コウ", "とき", "war cry"),
...
("頌", "ショウ, ジュ, ヨウ", "かたち, たた.える, ほめ.る", "eulogy"),
("頸", "ケイ", "くび", "neck, head"),
...
("颯", "サツ, ソウ", "さっ.と", "sudden, quick, sound of the wind"),
("颱", "タイ", "", "typhoon"),
("颶", "グ, ク", "", "storm"),
...
("駲", "シュウ, ジュン", "", "horse's buttocks, horse's tail, (phantom kanji)"),
("駻", "カン", "", "rage, run wild"),
...
("魏", "ギ", "たか.い", "high, large, Kingdom of Wei"),
...
("麒", "キ", "", "Chinese unicorn, genius, giraffe, bright, shining"),
("麕", "キン, クン", "のろ", "roe deer"),
...
("鼈", "ベツ, ヘツ", "すっぽん", "snapping turtle, fresh-water turtle"),
...
("齟", "ソ, サ, ショ", "かむ", "uneven, bite, disagree"),
...
("熙", "キ", "たのし.む, ひか.る, ひろ.い, よろこ.ぶ, かわ.く, あきらか, ひろ.める, ひろ.まる", "bright, sunny, prosperous, merry"),
...
("仢", "ハク, シャク, チャク, テキ", "まるきばし", ""),
("仨", "サ", "", ""),
("仯", "ソウ, ショウ, ビョウ, ミョウ", "ちい.さい", ""),
("仱", "ケン, キョウ, キン, ゴン", "ほ.こる, つつし.む", ""),
...
("侞", "ジョ, ニョ", "ひと.しい, したがえな.らす", ""),
("侟", "セン", "", ""),
("侲", "シン", "わらべ, よいわらべ, うまかい, はした.め", ""),
("侷", "キョク, ゴク", "たけがひく.い, せま.る", "narrow, cramped, confined"),
("侹", "テイ, ジョウ, チョウ", "おとこぎ, なおい, つつし.む", ""),
("侻", "タツ, タチ, タイ, テ", "かなう, よい, てがる, たやす.い, かる.い", ""),
("侼", "ホツ, ボチ", "つよ.い, うら.む", ""),
("侽", "ダン, ナン", "おとこ, お", ""),
("侾", "コウ, キョウ", "おお.きい", ""),
("俀", "タイ, テ", "よわ.い", ""),
...
("倁", "チ, ジ", "ゆ.く", ""),
("倄", "コウ, ギョウ, カイ, エ", "もと.る, そこ.なう", ""),
("倇", "エン, オン", "たの.しむ, よろこ.ぶ, すす.める", ""),
("倊", "ソウ, ス", "くる.しむ", ""),
("倌", "カン", "とねり", "assistant in wine shop, groom"),
("倎", "テン", "あつ.い", ""),
("倐", "シュク", "", "hastily, suddenly"),
("倓", "タン", "やす.い, しず.か", ""),
("倗", "ホウ", "たす.ける, ゆだ.ねる, よ.せる", ""),
...
("傖", "ショウ, ソウ", "いや.しい, いやしいもの, いなかもの", "vulgar person, country man"),
("傛", "ヨウ, ユ", "かが.む", ""),
("傜", "ヨウ", "えだち, ふぞろ.い, つか.い", "minority tribe"),
("傞", "サ", "", "unsteady"),
("傟", "オウ", "もと.る", ""),
("傠", "ハツ, カ, ボチ", "き.る, そむ.く, う.つ", ""),
("傡", "ヘイ, ホウ", "な.み, なら.べる, なら.ぶ, なら.びに", ""),
("傢", "カ", "かぐ", "stubborn, obstinate, intransigent"),
("傪", "サン", "よい", ""),
("傯", "ソウ", "くる.しむ", "urgent"),
("傰", "ホウ", "とも, ともがら, おもねりくみ.する", ""),
("傹", "ケイ, キョウ, リョウ, オウ, ゴウ, コウ", "つよ.い, あき.らか, とお.い, もと.める, きそ.う", ""),
...
("僐", "セン", "おつくり.する", ""),
("僓", "タイ, カイ, エ, テ", "なら.う, みや.びやか, したが.う", ""),
("僔", "ソン", "あつ.まる, おお.い, うやうや.しい", ""),
("僘", "ショウ", "たか.い, ほが.らか, ひろ.い", ""),
("僜", "トウ, ト, ショウ, チョウ", "のぼ.る, あ.がる", ""),
("僝", "サン, ゼン", "そな.える, ののし.る, あらわ.す", "to revile, to abuse"),
("僟", "キ, ゲ", "よくつつし.む, ちか.い", ""),
("僢", "セン, シュン", "そむ.く, むかいあ.う, ま.じる", ""),
...
("儃", "セン, タン", "たたず.む, よう.す, ほしいまま", ""),
("儆", "ケイ, ショウ", "いまし.める", "warn, warning"),
("儇", "ケン", "かしこ.い, あざむ.く, さとい, まと.う", ""),
...
("剅", "ロウ, ル, トウ, ツ", "さ.く, さ.ける", ""),
("剉", "サ", "くじく, かどをと.る", "cut, file, trim"),
("剕", "ヒ", "あしき.る", ""),
...
("呮", "キ", "こしか.ける", "to sit"),
("呴", "ク, コウ", "いきをかけてあたた.める", "breathe on, yawn, roar"),
("呿", "カ, キョ, コ, キョウ, コウ", "ひら.く, あくび.する", "to yawn"),
("咁", "カン", "ふく.む", "so"),
("咃", "タ", "", ""),
("咅", "トウ", "つばをはいていな.む", "to spit out"),
...
("唅", "カン, コン", "ふく.む, ふくませもの", "sound, to put in the mouth"),
...
("唫", "ゴン, キン", "ども.る, くちをと.じる, うたうた.う", "to hum, to intone, to close, to shut"),
...
("噡", "トウ, セン, タン", "うわごと, たわごと, うるさくしゃべ.る", ""),
("噢", "ユウ, イク, ウ, ク", "うめ.く", "moan, interjection for pain, sad"),
("噣", "チュ, チュウ, トウ, ツ, ショク, ソク", "くちばし, ついば.む", ""),
...
("塟", "ソウ", "ほうむ.る", ""),
("塡", "テン, チン", "はま.る, うず.める, は.める, ふさ.ぐ", "fill in, fill up, make good"),
...
("妌", "セイ, ジョウ", "しず.か, いさぎよ.い", ""),
("妎", "カイ, ケイ", "ねた.む, わずら.わしい, おお.う, き.る", ""),
...
("庽", "グウ, グ, ドウ", "かこつ.ける, よ.せる, よ.る", ""),
("庾", "ユ", "くら", "granary, storehouse"),
("庿", "ビョウ, ミョウ", "たまや, みたまや, やしろ", ""),
...
("弙", "オ, ウ, コ, ク", "ゆみをはってねら.う, も.つ", ""),
("弜", "キョウ, ゴウ, キ", "つよ.い, つよいゆみ", ""),
("弝", "ハ, ヘ", "ゆづか, つか", "the part of a bow grasped when shooting"),
("弡", "クツ, グチ, チョウ", "つよくいさましい", ""),
...
("恖", "シ, サイ", "おも.う, おもえら.く, おぼ.す", ""),
("恗", "コ, ク, カ, ケ", "おそ.れる, うれ.える, ほこ.る", ""),
...
("懡", "バ, マ", "", ""),
("懢", "ラン, カン, ゲン", "むさぼ.る, すこ.やか", ""),
("懧", "ダ, ジュ, ゼン", "よわ.い", ""),
("懩", "ヨウ", "ねが.う", ""),
("懥", "チ", "", "angry, enraged, resentful, hate"),
("懬", "コウ", "ひろ.い, おお.きい, むな.しい, つよ.い", ""),
("懭", "コウ", "うら.む", ""),
("懯", "フ", "おも.う", ""),
...
("抍", "ショウ", "あ.げる, ぬ.く, すく.う, と.る", ""),
("抎", "ウン, イン", "うしな.う, お.ちる", ""),
("抏", "ガン", "くじく", ""),
("抐", "ドツ, ナチ, ドン, ソン, ドウ", "そ.める, う.つ, い.れる, つか.む", ""),
("抦", "ヘイ, ヒョウ", "も.つ", ""),
...
("拚", "ヘン, フン", "てをう.つ", "risk, disregard, go all out for"),
("拪", "セン, イ", "うつ.る", ""),
("拲", "キョウ, ク, キョク, コク, キク", "てかせ", ""),
("拴", "セン", "えら.ぶ", "bind with rope, fasten"),
("拼", "ホウ, ヘイ, ヒョウ", "したが.う", "join together, link, incorporate"),
("拽", "エイ, エツ, エチ, セイ", "ひ.く", "drag, tow, throw, twist"),
("挃", "チツ, ジチ, テツ, デチ", "さ.す", ""),
("挄", "カク, コウ", "ひろ.がる, ひろ.げる, ひろ.める", ""),
("挊", "ロウ, ル", "いじく.る, いじ.る, ひねく.る, たわむ.れる, もてあそ.ぶ", ""),
("挋", "シン, キン, コン", "たす.ける", ""),
...
("捒", "ショウ, シュ, ソ, ス, ショク, ソク", "つつし.む, あ.げる", ""),
...
("撨", "ショウ, ソウ, ス", "えら.ぶ, と.る, ぬぐ.う, お.す", ""),
("撬", "キョウ", "あ.げる", "lift, raise, open"),
("撳", "キン", "おさ.える", "press, push"),
("撽", "コウ, キョウ, ケキ, キャク", "たた.く", ""),
...
("擑", "セツ, ショウ", "つ.ぐ", ""),
("擕", "ケイ", "たずさ.える, たずさ.わる", ""),
("擗", "ヘキ, ヒャク, ハク", "むねをう.つ", "to beat the breast"),
...
("殸", "ケイ, キョウ, コウ, セイ, ショウ", "てき, こえ", ""),
("殹", "エイ", "うちあたるこえ, みにくいすがた", ""),
...
("燌", "フン, ホン, ハン", "た.く, や.く, やきがり", ""),
("燓", "フン, ホン, ハン", "た.く, や.く, やきがり", ""),
...
("眵", "シ", "まなじりをいた.める", "eyes diseased and dim"),
...
("矙", "カン", "み.る", "view"),
("矞", "イツ, イチ, シュツ, ジュチ", "あなをあ.ける", "bore with awl, bright, charming"),
("矟", "サク", "ほこ", "8 ft lance"),
("矠", "サク, シャク", "ほこ", ""),
("矤", "シン", "いわ.んや, は.ぐ, はぎ", ""),
("矦", "コウ", "", ""),
...
("蕿", "ケン", "かや, かんぞう", ""),
("薁", "イク, オウ", "にわうめ", "vine"),
("薅", "コウ", "くきをと.る", "to weed, to eradicate"),
...
("觹", "ケイ, エ, スイ, キ", "くじり, つのぎり", ""),
("觽", "ケイ, エ, スイ, キ", "くじり, つのぎり", ""),
...
("詇", "ヨウ, オウウ, エイ", "さとい, つ.げる, とう, こえ", ""),
("詉", "ドウ, ヒョウ, ダ, ナ, ド, ヌ", "かまびす.しい, わるくい.う", ""),
("詍", "エイ, セツ, セチ", "しゃべ.る, たの.しむ", ""),
...
("諊", "キク, コク", "しらべ.る", "to male a judicial investigation"),
...
("趻", "チン, シン, タン, テン", "ふらふら.する", ""),
("跀", "ゲツ, グワチ, ゴツ, ゴチ", "あしきる, ゆが.む, いびつ", ""),
...
("遦", "カン", "ゆ.く, なれ.る, けが.す", ""),
("遧", "ショウ", "あき.らか", ""),
("遬", "チョク, ソク", "すみ.やか, か.わる, ちぢ.む, こまかい, つつし.む", ""),
...
("釥", "ショウ", "よいかね, よい, みめよ.い, するど.い, こま.かい, かすか", ""),
...
("銎", "キョウ, ク", "", ""),
("銒", "ケイ, ギョウ, コウ, ケン", "さけいれ, さけつぼ, あつものなべ", ""),
("銗", "コウ, グ", "くびかせ", ""),
("銙", "カ, カイ, ケ", "", ""),
("銟", "サ, シャ", "", ""),
...
("銶", "キュウ, グ", "のみ", "chisel"),
("銸", "チョウ, ショウ, ノウ", "はさみ, かなばさみ, けぬき, こばこ", ""),
("銺", "ソウ", "", ""),
...
("鏆", "カン", "うがつ, うでわ", ""),
("鏇", "セン", "ろくろ", "lathe"),
("鏉", "シュウ, シュ, ソウ, ソク", "するど.い, さび, え.る, ほ.る", ""),
("鏊", "ギョウ, ゴウ", "やきなべ", ""),
("鏋", "バン, マン", "こがね", ""),
("鏌", "バク, マク", "", "sword"),
("鏍", "ラ", "", ""),
("鏓", "ソウ, ス, ボウ, ム", "おおのみ, おおのめ", ""),
("鏙", "サイ, スイ", "ま.じる", ""),
("鏜", "トウ", "", "boring tool"),
...
("鞹", "カク", "", "skin"),
("鞺", "トウ", "", "sound of drums"),
("鞼", "キ, カイ, ケ, エ, ワイ", "たづな, つよ.い, くじく, くじける, ぬいとりをしたなめしがわ", ""),
("鞾", "カ", "くつ", "boots"),
("鞿", "キ, ケ", "くつばみ", ""),
("韁", "キョウ, コウ", "たづな", "reins, halter, bridle"),
("韄", "アク, ヤク, カク, ギャク", "かたのさげお", ""),
("韅", "ケン", "", "harness"),
("韇", "トク", "やづつ", ""),
...
("頍", "キ, ケン", "あたまをあ.げる", "to raise one's head"),
...
("鮇", "ビ, ミ", "いわな", ""),
("鮉", "チョウ", "たい", "bream"),
("鮊", "ハク, ビャク, ハ, ベ", "みごい, しろうお, がんき, かすべ", ""),
("鮋", "ユウ, ユ, シュウ, ジュ", "はや", ""),
("鮍", "ヒ", "かわはぎ", ""),
("鮏", "セイ, ショウ, ソウ", "なまぐさ.い, なまぐさ, さけ", ""),
...
("鮩", "ホウ, ビョウ, ヘイ, ヒツ, ビチ", "にごい, あみ", ""),
("鮬", "ホ, ブ, コ, ク, ヒ, カ, ケ", "たなご, せいご, からすみ", ""),
("鮰", "カイ", "", "small kind of sturgeon, found in the Yangtze"),
("鮱", "", "おおぼら, ぼら", ""),
("鮲", "モテ", "まて, こち", ""),
("鮷", "イ, テイ, ダイ, シ", "なまず, すけそう", ""),
("鮸", "ベン, メン, バン, マン", "にべ, いしもち", ""),
("鮻", "サ, シャ, ショウ", "さめ, ちちぶ", ""),
("鮼", "シン", "", ""),
("鮾", "ダイ, ナイ", "くさ.る", ""),
...
("齱", "サク, ソク, セク, シュク, シュウ", "せま.る", ""),
("齳", "グン", "", "toothless"),
("齵", "ゴウ, グ", "", "uneven (teeth)"),
("齺", "シュウ, シュ, サク, ザク", "", ""),
("齽", "キン, コン", "まがりば", ""),
("龏", "キョウ, ク, アク", "つつし.む, のぼ.る, ともしびおおい", ""),
...
("㙊", "", "", "an area of level ground, an open space, a threshing floor, arena for drill_ etc., a place to pile a sand-hill"),
("㚑", "", "", ""),
...
("㳃", "", "", "to temper iron or steel for making swords_ etc. (also used figuratively), to dip into water, to soak, to dye"),
("㳒", "", "", "statutes, laws, regulations, a rule, legal standard, plan or methods_ etc."),
...
("䐈", "", "", "a piece of one foot two inches dried seasoned meat, to paste up, to attach to, to stick up, to glue, rotten fat, grease_ lard_ etc., bowels"),
...
("䚯", "", "", "to quell (uprising_ rebellion_ etc.) to punish (another nation_ etc.) by force of arms, sound, voice, tone"),
...
("剝", "ハク, ホク", "へ.ぐ, へず.る, む.く, む.ける, は.がれる, は.ぐ, は.げる, は.がす", "come off, peel, fade, discolor"),
("剬", "タン, セン, セイ", "たつ, さばく", ""),
...
("埻", "シュン, タ, ダ, タイ, テ, コウ, ジュク", "まと, のり, あずち", ""),
("墋", "シン", "つち, すなじ, にごる", ""),
...
("渴", "カツ", "かわく, かわき", "thirsty, parched, yearn, pine"),
("湌", "", "", ""),
...
("朗", "", "", "clear, bright, distinct"),
("虜", "", "", "capture, imprison, seize, prison"),
